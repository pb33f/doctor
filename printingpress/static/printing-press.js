 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const _i=(t,e)=>(t==null?void 0:t._$litType$)!==void 0,Pi=t=>t.strings===void 0;var At=Symbol(),ao=Symbol(),Go,Xo=new Map,ee=class extends q{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var o;let r;if(e!=null&&e.spriteSheet)return this.svg=c`<svg part="svg">
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $s=Symbol.for(""),Ci=t=>{if((t==null?void 0:t.r)===$s)return t==null?void 0:t._$litStatic$},io=(t,...e)=>({_$litStatic$:e.reduce((o,r,s)=>o+(a=>{if(a._$litStatic$!==void 0)return a._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${a}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(r)+t[s+1],t[0]),r:$s}),xs=new Map,Ai=t=>(e,...o)=>{const r=o.length;let s,a;const i=[],n=[];let l,d=0,u=!1;for(;d<r;){for(l=e[d];d<r&&(a=o[d],(s=Ci(a))!==void 0);)l+=s+e[++d],u=!0;d!==r&&n.push(a),i.push(l),d++}if(d===r&&i.push(e[r]),u){const b=i.join("$$lit$$");(e=xs.get(b))===void 0&&(i.raw=i,xs.set(b,e=i)),o=n}return t(e,...o)},no=Ai(c);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Lt=globalThis,xo=Lt.trustedTypes,na=xo?xo.createPolicy("lit-html",{createHTML:t=>t}):void 0,la="$lit$",Ne=`lit$${Math.random().toFixed(9).slice(2)}$`,ca="?"+Ne,Zn=`<${ca}>`,Xe=document,Mt=()=>Xe.createComment(""),Dt=t=>t===null||typeof t!="object"&&typeof t!="function",_r=Array.isArray,Qn=t=>_r(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",Pr=`[ 	
\f\r]`,zt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,da=/-->/g,pa=/>/g,Ze=RegExp(`>|${Pr}(?:([^\\s"'>=/]+)(${Pr}*=${Pr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ha=/'/g,ua=/"/g,ma=/^(?:script|style|textarea|title)$/i,el=t=>(e,...o)=>({_$litType$:t,strings:e,values:o}),Qe=el(1),et=Symbol.for("lit-noChange"),H=Symbol.for("lit-nothing"),fa=new WeakMap,tt=Xe.createTreeWalker(Xe,129);function ga(t,e){if(!_r(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return na!==void 0?na.createHTML(e):e}const tl=(t,e)=>{const o=t.length-1,r=[];let s,a=e===2?"<svg>":e===3?"<math>":"",i=zt;for(let n=0;n<o;n++){const l=t[n];let d,u,b=-1,k=0;for(;k<l.length&&(i.lastIndex=k,u=i.exec(l),u!==null);)k=i.lastIndex,i===zt?u[1]==="!--"?i=da:u[1]!==void 0?i=pa:u[2]!==void 0?(ma.test(u[2])&&(s=RegExp("</"+u[2],"g")),i=Ze):u[3]!==void 0&&(i=Ze):i===Ze?u[0]===">"?(i=s??zt,b=-1):u[1]===void 0?b=-2:(b=i.lastIndex-u[2].length,d=u[1],i=u[3]===void 0?Ze:u[3]==='"'?ua:ha):i===ua||i===ha?i=Ze:i===da||i===pa?i=zt:(i=Ze,s=void 0);const w=i===Ze&&t[n+1].startsWith("/>")?" ":"";a+=i===zt?l+Zn:b>=0?(r.push(d),l.slice(0,b)+la+l.slice(b)+Ne+w):l+Ne+(b===-2?n:w)}return[ga(t,a+(t[o]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),r]};class Nt{constructor({strings:e,_$litType$:o},r){let s;this.parts=[];let a=0,i=0;const n=e.length-1,l=this.parts,[d,u]=tl(e,o);if(this.el=Nt.createElement(d,r),tt.currentNode=this.el.content,o===2||o===3){const b=this.el.content.firstChild;b.replaceWith(...b.childNodes)}for(;(s=tt.nextNode())!==null&&l.length<n;){if(s.nodeType===1){if(s.hasAttributes())for(const b of s.getAttributeNames())if(b.endsWith(la)){const k=u[i++],w=s.getAttribute(b).split(Ne),_=/([.?@])?(.*)/.exec(k);l.push({type:1,index:a,name:_[2],strings:w,ctor:_[1]==="."?rl:_[1]==="?"?sl:_[1]==="@"?al:ko}),s.removeAttribute(b)}else b.startsWith(Ne)&&(l.push({type:6,index:a}),s.removeAttribute(b));if(ma.test(s.tagName)){const b=s.textContent.split(Ne),k=b.length-1;if(k>0){s.textContent=xo?xo.emptyScript:"";for(let w=0;w<k;w++)s.append(b[w],Mt()),tt.nextNode(),l.push({type:2,index:++a});s.append(b[k],Mt())}}}else if(s.nodeType===8)if(s.data===ca)l.push({type:2,index:a});else{let b=-1;for(;(b=s.data.indexOf(Ne,b+1))!==-1;)l.push({type:7,index:a}),b+=Ne.length-1}a++}}static createElement(e,o){const r=Xe.createElement("template");return r.innerHTML=e,r}}function bt(t,e,o=t,r){var i,n;if(e===et)return e;let s=r!==void 0?(i=o._$Co)==null?void 0:i[r]:o._$Cl;const a=Dt(e)?void 0:e._$litDirective$;return(s==null?void 0:s.constructor)!==a&&((n=s==null?void 0:s._$AO)==null||n.call(s,!1),a===void 0?s=void 0:(s=new a(t),s._$AT(t,o,r)),r!==void 0?(o._$Co??(o._$Co=[]))[r]=s:o._$Cl=s),s!==void 0&&(e=bt(t,s._$AS(t,e.values),s,r)),e}class ol{constructor(e,o){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=o}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:o},parts:r}=this._$AD,s=((e==null?void 0:e.creationScope)??Xe).importNode(o,!0);tt.currentNode=s;let a=tt.nextNode(),i=0,n=0,l=r[0];for(;l!==void 0;){if(i===l.index){let d;l.type===2?d=new It(a,a.nextSibling,this,e):l.type===1?d=new l.ctor(a,l.name,l.strings,this,e):l.type===6&&(d=new il(a,this,e)),this._$AV.push(d),l=r[++n]}i!==(l==null?void 0:l.index)&&(a=tt.nextNode(),i++)}return tt.currentNode=Xe,s}p(e){let o=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,o),o+=r.strings.length-2):r._$AI(e[o])),o++}}class It{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,o,r,s){this.type=2,this._$AH=H,this._$AN=void 0,this._$AA=e,this._$AB=o,this._$AM=r,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const o=this._$AM;return o!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=o.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,o=this){e=bt(this,e,o),Dt(e)?e===H||e==null||e===""?(this._$AH!==H&&this._$AR(),this._$AH=H):e!==this._$AH&&e!==et&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Qn(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==H&&Dt(this._$AH)?this._$AA.nextSibling.data=e:this.T(Xe.createTextNode(e)),this._$AH=e}$(e){var a;const{values:o,_$litType$:r}=e,s=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Nt.createElement(ga(r.h,r.h[0]),this.options)),r);if(((a=this._$AH)==null?void 0:a._$AD)===s)this._$AH.p(o);else{const i=new ol(s,this),n=i.u(this.options);i.p(o),this.T(n),this._$AH=i}}_$AC(e){let o=fa.get(e.strings);return o===void 0&&fa.set(e.strings,o=new Nt(e)),o}k(e){_r(this._$AH)||(this._$AH=[],this._$AR());const o=this._$AH;let r,s=0;for(const a of e)s===o.length?o.push(r=new It(this.O(Mt()),this.O(Mt()),this,this.options)):r=o[s],r._$AI(a),s++;s<o.length&&(this._$AR(r&&r._$AB.nextSibling,s),o.length=s)}_$AR(e=this._$AA.nextSibling,o){var r;for((r=this._$AP)==null?void 0:r.call(this,!1,!0,o);e!==this._$AB;){const s=e.nextSibling;e.remove(),e=s}}setConnected(e){var o;this._$AM===void 0&&(this._$Cv=e,(o=this._$AP)==null||o.call(this,e))}}class ko{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,o,r,s,a){this.type=1,this._$AH=H,this._$AN=void 0,this.element=e,this.name=o,this._$AM=s,this.options=a,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=H}_$AI(e,o=this,r,s){const a=this.strings;let i=!1;if(a===void 0)e=bt(this,e,o,0),i=!Dt(e)||e!==this._$AH&&e!==et,i&&(this._$AH=e);else{const n=e;let l,d;for(e=a[0],l=0;l<a.length-1;l++)d=bt(this,n[r+l],o,l),d===et&&(d=this._$AH[l]),i||(i=!Dt(d)||d!==this._$AH[l]),d===H?e=H:e!==H&&(e+=(d??"")+a[l+1]),this._$AH[l]=d}i&&!s&&this.j(e)}j(e){e===H?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class rl extends ko{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===H?void 0:e}}class sl extends ko{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==H)}}class al extends ko{constructor(e,o,r,s,a){super(e,o,r,s,a),this.type=5}_$AI(e,o=this){if((e=bt(this,e,o,0)??H)===et)return;const r=this._$AH,s=e===H&&r!==H||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==H&&(r===H||s);s&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var o;typeof this._$AH=="function"?this._$AH.call(((o=this.options)==null?void 0:o.host)??this.element,e):this._$AH.handleEvent(e)}}class il{constructor(e,o,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=o,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){bt(this,e)}}const Cr=Lt.litHtmlPolyfillSupport;Cr==null||Cr(Nt,It),(Lt.litHtmlVersions??(Lt.litHtmlVersions=[])).push("3.3.1");const nl=(t,e,o)=>{const r=(o==null?void 0:o.renderBefore)??e;let s=r._$litPart$;if(s===void 0){const a=(o==null?void 0:o.renderBefore)??null;r._$litPart$=s=new It(e.insertBefore(Mt(),a),a,void 0,o??{})}return s._$AI(t),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var dl=Object.defineProperty,pl=Object.getOwnPropertyDescriptor,rt=(t,e,o,r)=>{for(var s=r>1?void 0:r?pl(e,o):e,a=t.length-1,i;a>=0;a--)(i=t[a])&&(s=(r?i(e,o,s):i(s))||s);return r&&s&&dl(e,o,s),s};const hl={GET:"GET",POST:"POST",PUT:"PUT",DELETE:"DEL",PATCH:"PAT",OPTIONS:"OPT",HEAD:"HEAD",TRACE:"TRC"};let Ce=class extends Ie{constructor(){super(),this.mode="",this.lower=!1,this.method="GET"}render(){if(this.mode==="nav-naked"){const o=this.method.toUpperCase(),r=hl[o]??o,s=this.method.toLowerCase();return Qe`<span class="method-naked ${s}">${r}</span>`}let t="medium";this.large&&(t="large"),this.tiny&&(t="small"),this.micro&&(t="small");const e=this.micro?`method ${t} micro`:`method ${t}`;return Qe`
        ...
        `}};Ce.styles=cl,rt([ae()],Ce.prototype,"method",2),rt([ae({type:Boolean})],Ce.prototype,"lower",2),rt([ae({type:Boolean})],Ce.prototype,"large",2),rt([ae({type:Boolean})],Ce.prototype,"tiny",2),rt([ae({type:Boolean})],Ce.prototype,"micro",2),rt([ae({reflect:!0})],Ce.prototype,"mode",2),Ce=rt([yo("pb33f-http-method")],Ce);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,zr=class extends q{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){const e=["menuitem","menuitemcheckbox"],o=t.composedPath(),r=o.find(n=>{var l;return e.includes(((l=n==null?void 0:n.getAttribute)==null?void 0:l.call(n,"role"))||"")});if(!r||o.find(n=>{var l;return((l=n==null?void 0:n.getAttribute)==null?void 0:l.call(n,"role"))==="menu"})!==this)return;const i=r;i.type==="checkbox"&&(i.checked=!i.checked),this.emit("sl-select",{detail:{item:i}})}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){const e=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),e==null||e.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){const e=this.getAllItems(),o=this.getCurrentItem();let r=o?e.indexOf(o):0;e.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?r++:t.key==="ArrowUp"?r--:t.key==="Home"?r=0:t.key==="End"&&(r=e.length-1),r<0&&(r=e.length-1),r>e.length-1&&(r=0),this.setCurrentItem(e[r]),e[r].focus())}}handleMouseDown(t){const e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){const t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){var e;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((e=t.getAttribute("role"))!=null?e:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(o=>{o.setAttribute("tabindex",o===t?"0":"-1")})}render(){return c`
      ...
      ></slot>
    `}};zr.styles=[Q,Ql],f([F("slot")],zr.prototype,"defaultSlot",2),zr.define("sl-menu");var ec=T`
  :host {
    --submenu-offset: -2px;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Jt=(t,e)=>{var r;const o=t._$AN;if(o===void 0)return!1;for(const s of o)(r=s._$AO)==null||r.call(s,e,!1),Jt(s,e);return!0},So=t=>{let e,o;do{if((e=t._$AM)===void 0)break;o=e._$AN,o.delete(t),t=e}while((o==null?void 0:o.size)===0)},Pa=t=>{for(let e;e=t._$AM;t=e){let o=e._$AN;if(o===void 0)e._$AN=o=new Set;else if(o.has(t))break;o.add(t),rc(e)}};function tc(t){this._$AN!==void 0?(So(this),this._$AM=t,Pa(this)):this._$AM=t}function oc(t,e=!1,o=0){const r=this._$AH,s=this._$AN;if(s!==void 0&&s.size!==0)if(e)if(Array.isArray(r))for(let a=o;a<r.length;a++)Jt(r[a],!1),So(r[a]);else r!=null&&(Jt(r,!1),So(r));else Jt(this,t)}const rc=t=>{t.type==Zo.CHILD&&(t._$AP??(t._$AP=oc),t._$AQ??(t._$AQ=tc))};class sc extends er{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,o,r){super._$AT(e,o,r),Pa(this),this.isConnected=e._$AU}_$AO(e,o=!0){var r,s;e!==this.isConnected&&(this.isConnected=e,e?(r=this.reconnected)==null||r.call(this):(s=this.disconnected)==null||s.call(this)),o&&(Jt(this,e),So(this))}setValue(e){if(Pi(this._$Ct))this._$Ct._$AI(e,this);else{const o=[...this._$Ct._$AH];o[this._$Ci]=e,this._$Ct._$AI(o,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,D=class extends q{constructor(){super(...arguments),this.formControlController=new dc(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new yr(this,"[default]","prefix","suffix"),this.localize=new be(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:jr}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),e=t?io`a`:io`button`;return no`
    ...
    `}};D.styles=[Q,pc],D.dependencies={"sl-icon":ee,"sl-spinner":Ir},f([F(".button")],D.prototype,"button",2),f([O()],D.prototype,"hasFocus",2),f([O()],D.prototype,"invalid",2),f([h()],D.prototype,"title",2),f([h({reflect:!0})],D.prototype,"variant",2),f([h({reflect:!0})],D.prototype,"size",2),f([h({type:Boolean,reflect:!0})],D.prototype,"caret",2),f([h({type:Boolean,reflect:!0})],D.prototype,"disabled",2),f([h({type:Boolean,reflect:!0})],D.prototype,"loading",2),f([h({type:Boolean,reflect:!0})],D.prototype,"outline",2),f([h({type:Boolean,reflect:!0})],D.prototype,"pill",2),f([h({type:Boolean,reflect:!0})],D.prototype,"circle",2),f([h()],D.prototype,"type",2),f([h()],D.prototype,"name",2),f([h()],D.prototype,"value",2),f([h()],D.prototype,"href",2),f([h()],D.prototype,"target",2),f([h()],D.prototype,"rel",2),f([h()],D.prototype,"download",2),f([h()],D.prototype,"form",2),f([h({attribute:"formaction"})],D.prototype,"formAction",2),f([h({attribute:"formenctype"})],D.prototype,"formEnctype",2),f([h({attribute:"formmethod"})],D.prototype,"formMethod",2),f([h({attribute:"formnovalidate",type:Boolean})],D.prototype,"formNoValidate",2),f([h({attribute:"formtarget"})],D.prototype,"formTarget",2),f([Y("disabled",{waitUntilFirstUpdate:!0})],D.prototype,"handleDisabledChange",1),D.define("sl-button");const Br=T`
    sl-button::part(base) {
...
`];var uc=Object.defineProperty,mc=Object.getOwnPropertyDescriptor,Yt=(t,e,o,r)=>{for(var s=r>1?void 0:r?mc(e,o):e,a=t.length-1,i;a>=0;a--)(i=t[a])&&(s=(r?i(e,o,s):i(s))||s);return r&&s&&uc(e,o,s),s};p.PpSchemaProperties=class extends N{constructor(){super(...arguments),this.schemaJson="",this.compact=!1,this.schema=null,this.oneOfSelectedIndex=0}willUpdate(e){if(e.has("schemaJson")&&this.schemaJson){try{this.schema=JSON.parse(this.schemaJson)}catch{this.schema=null}this.oneOfSelectedIndex=0}}renderRefAnchor(e,o){const r=c`<a class="ref-type-link" href="${o.href}">\u279c ${o.name}</a>`;return this.compact?r:c`
        ...
        `}renderPropertyTable(e,o){const r=Object.entries(e);return r.length?r.map(([s,a])=>{const i=a.oneOf??a.anyOf;return i&&Array.isArray(i)?this.compact?this.renderPropertyRow(s,a,o):c`
            ...
            <div class="composition-refs">
                ...
                ${e.map(o=>{const r=at(o.$ref);if(!r)return m;const s=Dr(o.$ref),a=(s==null?void 0:s.description)??"";return c`
                ...
                <div class="oneof-selector">
                    ${o?c`
                        <div class="oneof-prop-name">
                            ...
                            ${a?c`<span class="composition-label polymorphic">(${a})</span>`:m}
                        </div>
                    `:m}
                    ${e.length>1?c`
                        <sl-dropdown skidding="5" distance="5">
                            <sl-button slot="trigger" caret>${i.title||`Option ${this.oneOfSelectedIndex+1}`}</sl-button>
                    ...
                    `:c`
                        <span class="composition-label">${i.title||"Option 1"}</span>
                    `}
                    ${r?c`<span class="oneof-prop-desc">${r}</span>`:m}
                </div>
                ${this.renderOneOfOption(i)}
            </div>
        `}handleOneOfSelect(e){var s,a;const o=(a=(s=e.detail)==null?void 0:s.item)==null?void 0:a.value;if(o===void 0)return;const r=parseInt(o,10);r>=0&&(this.oneOfSelectedIndex=r)}renderOneOfOption(e){if(e.$ref){const r=at(e.$ref);if(!r)return m;const s=Dr(e.$ref);return c`
...
`;var _c=Object.defineProperty,Pc=Object.getOwnPropertyDescriptor,Vr=(t,e,o,r)=>{for(var s=r>1?void 0:r?Pc(e,o):e,a=t.length-1,i;a>=0;a--)(i=t[a])&&(s=(r?i(e,o,s):i(s))||s);return r&&s&&_c(e,o,s),s};p.PpExtensions=class extends N{constructor(){super(...arguments),this.extensionsJson="",this.extensions=[]}willUpdate(e){if(e.has("extensionsJson"))if(this.extensionsJson)try{this.extensions=JSON.parse(this.extensionsJson)}catch{this.extensions=[]}else this.extensions=[]}renderValue(e){return e==null?m:typeof e=="object"?c`<pp-code-viewer code=${JSON.stringify(e,null,2)} language="json"></pp-code-viewer>`:c`<span class="ext-scalar">${String(e)}</span>`}render(){return this.extensions.length?c`<div class="ext-grid">
      ...
      ${this.params.map(e=>{var s;const o=this.parseSchema(e.schemaJson),r=Mr(o);return c`
        ...
        `})}
    `:m}},p.PpOperationParameters.styles=[yt,Co,Ao,Jl],Jr([h({attribute:"parameters-json"})],p.PpOperationParameters.prototype,"parametersJson",2),Jr([O()],p.PpOperationParameters.prototype,"params",2),p.PpOperationParameters=Jr([B("pp-operation-parameters")],p.PpOperationParameters);const Sa=T`
    .status-ok {
        color: var(--primary-color);
        font-family: var(--font-stack-bold), monospace;
    }
...
`).length>1}
    ...
    `}render(){if(!this.parsed)return m;const e=this.parsed;return e.in?this.renderParameter(e):e.schema&&!e.properties&&!e.in?this.renderHeader(e):this.renderSchema(e)}},p.PpModelPage.styles=[yt,Co,Bc],ke([h({attribute:"model-json"})],p.PpModelPage.prototype,"modelJson",2),ke([h()],p.PpModelPage.prototype,"name",2),ke([h({attribute:"raw-yaml"})],p.PpModelPage.prototype,"rawYaml",2),ke([h({attribute:"schema-raw-yaml"})],p.PpModelPage.prototype,"schemaRawYaml",2),ke([h({attribute:"schema-raw-json"})],p.PpModelPage.prototype,"schemaRawJson",2),ke([h({attribute:"schema-start-line",type:Number})],p.PpModelPage.prototype,"schemaStartLine",2),ke([h({attribute:"start-line",type:Number})],p.PpModelPage.prototype,"startLine",2),ke([h()],p.PpModelPage.prototype,"location",2),ke([O()],p.PpModelPage.prototype,"parsed",2),p.PpModelPage=ke([B("pp-model-page")],p.PpModelPage);const Wc=T`
  :host {
    display: block;
  }
  a {
