var PrintingPress=(function(e){Object.defineProperty(e,Symbol.toStringTag,{value:`Module`});var t=Object.create,n=Object.defineProperty,r=Object.getOwnPropertyDescriptor,i=Object.getOwnPropertyNames,a=Object.getPrototypeOf,o=Object.prototype.hasOwnProperty,s=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),c=(e,t,a,s)=>{if(t&&typeof t==`object`||typeof t==`function`)for(var c=i(t),l=0,u=c.length,d;l<u;l++)d=c[l],!o.call(e,d)&&d!==a&&n(e,d,{get:(e=>t[e]).bind(null,d),enumerable:!(s=r(t,d))||s.enumerable});return e},l=(e,r,i)=>(i=e==null?{}:t(a(e)),c(r||!e||!e.__esModule?n(i,`default`,{value:e,enumerable:!0}):i,e));function u(e){return document.body?.dataset?.[e]||``}function d(){return u(`ppAssetMode`)===`served`?`served`:`portable`}async function f(e,t,n=d()){return e?n===`portable`?p(e,t):m(e):null}async function p(e,t){await new Promise((t,n)=>{let r=document.createElement(`script`);r.src=`${e}.js`,r.async=!1,r.onload=()=>{r.remove(),t()},r.onerror=()=>{r.remove(),n(Error(`unable to load script asset: ${e}.js`))},document.head.appendChild(r)});let n=globalThis[t];return delete globalThis[t],n||null}async function m(e){let t=await fetch(`${e}.json`);if(!t.ok)throw Error(`unable to fetch asset: ${e}.json (${t.status})`);return await t.json()}var h=new Map,g=new Map,ee=`__PP_PAGE_DATA__`;function te(e){h.clear();for(let[t,n]of Object.entries(e))h.set(t,n)}function _(e){return h.get(e)}function ne(e){if(e?.startsWith(`#/components/`))return _(e.replace(`#/components/`,``))}function re(e){return g.get(e)}function v(e){if(e?.startsWith(`#/components/`))return re(e.replace(`#/components/`,``))}async function y(e){let t=g.get(e);if(t)return t;let n=_(e);if(!n?.pageDataBase)return;let r=await f(n.pageDataBase,ee);if(r?.model)return g.set(e,r.model),r.model}async function b(e){if(e?.startsWith(`#/components/`))return y(e.replace(`#/components/`,``))}async function ie(e,t=new Set){let n=ae(e);for(let e of n){if(t.has(e))continue;t.add(e);let n=await b(e);if(n?.schemaJson)try{await ie(JSON.parse(n.schemaJson),t)}catch{}}}function ae(e,t=new Set){if(!e||typeof e!=`object`)return t;if(Array.isArray(e)){for(let n of e)ae(n,t);return t}typeof e.$ref==`string`&&t.add(e.$ref);for(let n of Object.values(e))ae(n,t);return t}var oe=`bags`,se=`saddlebag`,ce=class{_bags;_stateful;_db;constructor(e){this._bags=new Map,this._stateful=e}loadStatefulBags(){return new Promise(e=>{let t=indexedDB.open(se,1);t.onupgradeneeded=()=>{this._db=t.result,this._db.createObjectStore(oe)},t.onsuccess=()=>{if(this._db=t.result,this._db){this._bags.forEach(e=>{e.db||=this._db});let t=this._db.transaction(oe).objectStore(oe).openCursor();t.onsuccess=t=>{let n=t.target.result;if(n){let e=n.primaryKey,t=n.value,r=this.getBag(e);r&&!r.db&&(r.db=this._db),r?.populate(t),r&&this._bags.set(e,r),n.continue()}else e({db:this._db})}}}})}get db(){return this._db?this._db:null}createBag(e){if(this._bags.has(e))return this._bags.get(e);let t=de(e,this._stateful);return t.db=this._db,this._bags.set(e,t),t}getBag(e){return this._bags.has(e)?this._bags.get(e):this.createBag(e)}resetBags(){this._bags.forEach(e=>{e.reset()})}},le;function ue(e){return le||=new ce(e||!1),le}function de(e,t){return new pe(e,t)}var fe=class{_allChangesBit;_key;_subFunction;_allChangesFunction;_populatedFunction;_bag;constructor(e,t){this._bag=e,this._allChangesBit=t,this._key=``,this._subFunction=void 0,this._allChangesFunction=void 0,this._populatedFunction=void 0}set allChangeFunction(e){this._allChangesFunction=e}set populatedFunction(e){this._populatedFunction=e}set subscriptionFunction(e){this._subFunction=e}set key(e){this._key=e}unsubscribe(){switch(this._allChangesBit){case 0:let e=this._bag._subscriptions.get(this._key);e&&this._bag._subscriptions.set(this._key,e.filter(e=>e!==this._subFunction));break;case 1:this._bag._allChangesSubscriptions=this._bag._allChangesSubscriptions.filter(e=>e!==this._allChangesFunction);break;case 2:this._bag._storePopulatedSubscriptions=this._bag._storePopulatedSubscriptions.filter(e=>e!==this._populatedFunction)}}},pe=class{_id;_stateful;_values;_db;_subscriptions;_allChangesSubscriptions;_storePopulatedSubscriptions;constructor(e,t){this._values=new Map,this._subscriptions=new Map,this._allChangesSubscriptions=[],this._storePopulatedSubscriptions=[],this._stateful=t||!1,this._id=e}set(e,t){this._values.set(e,structuredClone(t)),this.alertSubscribers(e,t),this._stateful&&this._db&&this._db.transaction([`bags`],`readwrite`).objectStore(`bags`).put(this._values,this._id),this._stateful&&!this._db&&console.error(`db not available, cannot write to db for key:`,e)}get id(){return this._id}get db(){return this._db}set db(e){this._db=e}reset(){this._values.forEach((e,t)=>{this.alertSubscribers(t,void 0)}),this._values=new Map,this._stateful&&this._db&&this._db.transaction([`bags`],`readwrite`).objectStore(`bags`).delete(this._id)}alertSubscribers(e,t){this._subscriptions.has(e)&&this._subscriptions.get(e)?.forEach(e=>e(t)),this._allChangesSubscriptions.length>0&&this._allChangesSubscriptions.forEach(n=>n(e,t))}get(e){return this._values.get(e)}populate(e){e&&e.size>0&&(this._values=structuredClone(e),this._storePopulatedSubscriptions.length>0&&this._storePopulatedSubscriptions.forEach(t=>t(e)))}export(){return this._values}subscribe(e,t){if(!this._subscriptions.has(e))this._subscriptions.set(e,[t]);else{let n=this._subscriptions.get(e);n&&this._subscriptions.set(e,[...n,t])}let n=new fe(this,0);return n.key=e,n.subscriptionFunction=t,n}onAllChanges(e){this._allChangesSubscriptions.push(e);let t=new fe(this,1);return t.allChangeFunction=e,t}onPopulated(e){this._storePopulatedSubscriptions.push(e);let t=new fe(this,2);return t.populatedFunction=e,t}},me=`__PP_SHARED_DATA__`,he=`__PP_PAGE_DATA__`,ge=`shared-payload`,_e=`printing-press:shared:`,ve=`saddlebag`,ye=`bags`,be=null,xe=null;function x(e,t){let n=globalThis.__PP_LOG;typeof n==`function`&&n(e,t)}function Se(){return globalThis.__PP_BOOTSTRAP__||null}function Ce(){let e=globalThis,t=e.__PP_BOOTSTRAP__;if(t)return t;let n={};return e.__PP_BOOTSTRAP__=n,n}function we(){return Se()?.stopAtPreview===!0}async function Te(e,t,n){let r=Se(),i=n===`shared`?r?.sharedPromise:r?.pagePromise;if(i){x(`${n}-payload:await-bootstrap-promise`,{assetBase:e});try{let t=await i;if(t)return x(`${n}-payload:resolved-from-bootstrap-promise`,{assetBase:e,hasPayload:!0}),t;x(`${n}-payload:bootstrap-promise-empty`,{assetBase:e})}catch{let t=r?.[n];if(t)return x(`${n}-payload:bootstrap-promise-failed-using-store`,{assetBase:e}),t||null;x(`${n}-payload:bootstrap-promise-failed`,{assetBase:e})}}if(r?.[n])return x(`${n}-payload:resolved-from-store`,{assetBase:e}),r[n]||null;x(`${n}-payload:load-asset:start`,{assetBase:e});let a=await f(e,t);return x(`${n}-payload:load-asset:done`,{assetBase:e,hasPayload:!!a}),a}function Ee(e){try{return`${_e}${new URL(e,document.baseURI).href}`}catch{return`${_e}${e}`}}function De(){return new Promise(e=>{try{let t=indexedDB.open(ve,1);t.onerror=()=>e(null),t.onupgradeneeded=()=>{let e=t.result;e.objectStoreNames.contains(ye)||e.createObjectStore(ye)},t.onsuccess=()=>e(t.result)}catch{e(null)}})}function Oe(){return new Promise(e=>{try{let t=indexedDB.deleteDatabase(ve);t.onsuccess=()=>e(),t.onerror=()=>e(),t.onblocked=()=>e()}catch{e()}})}async function ke(){if(typeof indexedDB>`u`)return x(`shared-cache:indexeddb-unavailable`),!1;xe||=(async()=>{let e=await De();if(!e)return x(`shared-cache:db-open-failed`),!1;if(e.objectStoreNames.contains(ye))return e.close(),x(`shared-cache:db-ready`),!0;if(e.close(),x(`shared-cache:missing-store-reset`),await Oe(),e=await De(),!e)return x(`shared-cache:db-reopen-failed`),!1;let t=e.objectStoreNames.contains(ye);return e.close(),x(`shared-cache:db-reset-result`,{ready:t}),t})();let e=await xe;return e||(xe=null),e}async function Ae(e){return!e||!await ke()?(x(`shared-cache:bag-unavailable`,{assetBase:e}),null):(be||=(async()=>{try{let e=ue(!0);return await e.loadStatefulBags(),x(`shared-cache:bag-manager-ready`),e}catch{return x(`shared-cache:bag-manager-failed`),null}})(),(await be)?.getBag(Ee(e))??null)}async function je(e,t){if(!e||!t)return null;let n=await Ae(e),r=n?.get(ge);return r?r.hash===t?(x(`shared-cache:hit`,{assetBase:e}),r.payload??null):(n?.reset(),x(`shared-cache:stale`,{assetBase:e,cachedHash:r.hash,expectedHash:t}),null):(x(`shared-cache:miss`,{assetBase:e}),null)}async function Me(e,t,n){!e||!t||!n||((await Ae(e))?.set(ge,{hash:t,payload:n}),x(`shared-cache:write`,{assetBase:e,expectedHash:t}))}function Ne(e){for(let[t,n]of Object.entries(e)){let e=document.getElementById(t);if(e){for(let[t,r]of Object.entries(n))e.setAttribute(t,r);t===`pp-nav`&&x(`nav-attributes:applied`,{nav:!!n[`data-nav`],models:!!n[`data-models`],webhooks:!!n[`data-webhooks`]})}}}function Pe(e){e.querySelectorAll(`:scope > [data-pp-hydrated="true"]`).forEach(e=>e.remove())}function Fe(e){let t=document.createElement(e.tag);return t.setAttribute(`data-pp-hydrated`,`true`),e.id&&(t.id=e.id),e.class&&(t.className=e.class),e.type&&e.tag===`script`&&(t.type=e.type),e.tag===`template`?t.innerHTML=e.html||``:t.textContent=e.text||``,t}function Ie(e){for(let[t,n]of Object.entries(e)){let e=document.getElementById(t);if(e){Pe(e);for(let t of n)e.appendChild(Fe(t))}}}function Le(e,t={}){if(!e)return;let n=t.includeModel??!0;e.schemaRegistry&&te(e.schemaRegistry),e.attributes&&Ne(e.attributes),e.children&&Ie(e.children),n&&e.model&&Re(e.model)}function Re(e){let t=document.getElementById(`pp-model-page`);t&&(t.setAttribute(`model-json`,e.schemaJson),e.mockJson&&t.setAttribute(`mock-json`,e.mockJson),e.rawYaml&&t.setAttribute(`raw-yaml`,e.rawYaml),e.schemaRawYaml&&t.setAttribute(`schema-raw-yaml`,e.schemaRawYaml),e.schemaRawJson&&t.setAttribute(`schema-raw-json`,e.schemaRawJson));let n=document.getElementById(`pp-model-security-scheme`);n&&n.setAttribute(`scheme-json`,e.schemaJson)}function ze(){document.dispatchEvent(new CustomEvent(`pp:hydrated`))}async function Be(){if(we()){x(`hydrate:skipped`,{reason:`preview-hold`});return}let e=u(`ppShared`),t=u(`ppSharedHash`),n=u(`ppPage`),r=Se();x(`hydrate:start`,{sharedAssetBase:e,pageAssetBase:n,hasBootstrapShared:!!r?.shared,hasBootstrapSharedPromise:!!r?.sharedPromise});let i=r?.shared||(r?.sharedPromise?null:await je(e,t));i&&!r?.shared&&(Ce().shared=i,x(`shared-cache:seeded-bootstrap-store`));let a=Te(e,me,`shared`).then(async n=>(i||await Me(e,t,n),Le(n),x(`shared-payload:applied`,{hasPayload:!!n}),n)),o=Te(n,he,`page`).then(async e=>{try{await a}catch{}return Le(e,{includeModel:!1}),x(`page-payload:applied`,{hasPayload:!!e}),e}),[s,c]=await Promise.allSettled([a,o]),l=[s,c];for(let e of l)e.status===`rejected`&&console.error(`printing-press hydration failed`,e.reason);c.status===`fulfilled`&&c.value?.model&&(Re(c.value.model),x(`model-payload:applied`)),x(`hydrate:complete`),ze()}var Ve={"info-square":`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"><rect x="2.25" y="2.25" width="11.5" height="11.5" rx="1.25"/><path d="M8 7.15v3.35"/><circle cx="8" cy="5.2" r=".55" fill="currentColor" stroke="none"/></svg>`,"exclamation-triangle":`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2.1 13.8 12.9H2.2L8 2.1Z"/><path d="M8 6.1v3.45"/><circle cx="8" cy="11.35" r=".55" fill="currentColor" stroke="none"/></svg>`,"exclamation-square":`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"><rect x="2.25" y="2.25" width="11.5" height="11.5" rx="1.25"/><path d="M8 5.35v4.1"/><circle cx="8" cy="11.35" r=".55" fill="currentColor" stroke="none"/></svg>`,"check-square":`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"><rect x="2.25" y="2.25" width="11.5" height="11.5" rx="1.25"/><path d="M5.05 8.2 7.1 10.25 11.05 6.3"/></svg>`,"question-square":`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"><rect x="2.25" y="2.25" width="11.5" height="11.5" rx="1.25"/><path d="M6.4 6.15A1.66 1.66 0 0 1 8 5.2c1.02 0 1.85.72 1.85 1.72 0 1.25-1.35 1.55-1.85 2.55"/><circle cx="8" cy="11.35" r=".55" fill="currentColor" stroke="none"/></svg>`},He=globalThis,Ue=He.ShadowRoot&&(He.ShadyCSS===void 0||He.ShadyCSS.nativeShadow)&&`adoptedStyleSheets`in Document.prototype&&`replace`in CSSStyleSheet.prototype,We=Symbol(),Ge=new WeakMap,Ke=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==We)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Ue&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=Ge.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Ge.set(t,e))}return e}toString(){return this.cssText}},qe=e=>new Ke(typeof e==`string`?e:e+``,void 0,We),S=(e,...t)=>new Ke(e.length===1?e[0]:t.reduce((t,n,r)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if(typeof e==`number`)return e;throw Error(`Value passed to 'css' function must be a 'css' function result: `+e+`. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)})(n)+e[r+1],e[0]),e,We),Je=(e,t)=>{if(Ue)e.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let n of t){let t=document.createElement(`style`),r=He.litNonce;r!==void 0&&t.setAttribute(`nonce`,r),t.textContent=n.cssText,e.appendChild(t)}},Ye=Ue?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t=``;for(let n of e.cssRules)t+=n.cssText;return qe(t)})(e):e,{is:Xe,defineProperty:Ze,getOwnPropertyDescriptor:Qe,getOwnPropertyNames:$e,getOwnPropertySymbols:et,getPrototypeOf:tt}=Object,nt=globalThis,rt=nt.trustedTypes,it=rt?rt.emptyScript:``,at=nt.reactiveElementPolyfillSupport,ot=(e,t)=>e,st={toAttribute(e,t){switch(t){case Boolean:e=e?it:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let n=e;switch(t){case Boolean:n=e!==null;break;case Number:n=e===null?null:Number(e);break;case Object:case Array:try{n=JSON.parse(e)}catch{n=null}}return n}},ct=(e,t)=>!Xe(e,t),lt={attribute:!0,type:String,converter:st,reflect:!1,useDefault:!1,hasChanged:ct};Symbol.metadata??=Symbol(`metadata`),nt.litPropertyMetadata??=new WeakMap;var ut=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=lt){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),r=this.getPropertyDescriptor(e,n,t);r!==void 0&&Ze(this.prototype,e,r)}}static getPropertyDescriptor(e,t,n){let{get:r,set:i}=Qe(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};return{get:r,set(t){let a=r?.call(this);i?.call(this,t),this.requestUpdate(e,a,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??lt}static _$Ei(){if(this.hasOwnProperty(ot(`elementProperties`)))return;let e=tt(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(ot(`finalized`)))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ot(`properties`))){let e=this.properties,t=[...$e(e),...et(e)];for(let n of t)this.createProperty(n,e[n])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[e,n]of t)this.elementProperties.set(e,n)}this._$Eh=new Map;for(let[e,t]of this.elementProperties){let n=this._$Eu(e,t);n!==void 0&&this._$Eh.set(n,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let e of n)t.unshift(Ye(e))}else e!==void 0&&t.push(Ye(e));return t}static _$Eu(e,t){let n=t.attribute;return!1===n?void 0:typeof n==`string`?n:typeof e==`string`?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Je(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$ET(e,t){let n=this.constructor.elementProperties.get(e),r=this.constructor._$Eu(e,n);if(r!==void 0&&!0===n.reflect){let i=(n.converter?.toAttribute===void 0?st:n.converter).toAttribute(t,n.type);this._$Em=e,i==null?this.removeAttribute(r):this.setAttribute(r,i),this._$Em=null}}_$AK(e,t){let n=this.constructor,r=n._$Eh.get(e);if(r!==void 0&&this._$Em!==r){let e=n.getPropertyOptions(r),i=typeof e.converter==`function`?{fromAttribute:e.converter}:e.converter?.fromAttribute===void 0?st:e.converter;this._$Em=r;let a=i.fromAttribute(t,e.type);this[r]=a??this._$Ej?.get(r)??a,this._$Em=null}}requestUpdate(e,t,n,r=!1,i){if(e!==void 0){let a=this.constructor;if(!1===r&&(i=this[e]),n??=a.getPropertyOptions(e),!((n.hasChanged??ct)(i,t)||n.useDefault&&n.reflect&&i===this._$Ej?.get(e)&&!this.hasAttribute(a._$Eu(e,n))))return;this.C(e,t,n)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(e,t,{useDefault:n,reflect:r,wrapped:i},a){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,a??t??this[e]),!0!==i||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(t=void 0),this._$AL.set(e,t)),!0===r&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[e,t]of this._$Ep)this[e]=t;this._$Ep=void 0}let e=this.constructor.elementProperties;if(e.size>0)for(let[t,n]of e){let{wrapped:e}=n,r=this[t];!0!==e||this._$AL.has(t)||r===void 0||this.C(t,void 0,n,r)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(e=>e.hostUpdate?.()),this.update(t)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(e){}firstUpdated(e){}};ut.elementStyles=[],ut.shadowRootOptions={mode:`open`},ut[ot(`elementProperties`)]=new Map,ut[ot(`finalized`)]=new Map,at?.({ReactiveElement:ut}),(nt.reactiveElementVersions??=[]).push(`2.1.2`);var dt=globalThis,ft=e=>e,pt=dt.trustedTypes,mt=pt?pt.createPolicy(`lit-html`,{createHTML:e=>e}):void 0,ht=`$lit$`,gt=`lit$${Math.random().toFixed(9).slice(2)}$`,_t=`?`+gt,vt=`<${_t}>`,yt=document,bt=()=>yt.createComment(``),xt=e=>e===null||typeof e!=`object`&&typeof e!=`function`,St=Array.isArray,Ct=e=>St(e)||typeof e?.[Symbol.iterator]==`function`,wt=`[ 	
\f\r]`,Tt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Et=/-->/g,Dt=/>/g,Ot=RegExp(`>|${wt}(?:([^\\s"'>=/]+)(${wt}*=${wt}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),kt=/'/g,At=/"/g,jt=/^(?:script|style|textarea|title)$/i,C=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),Mt=Symbol.for(`lit-noChange`),w=Symbol.for(`lit-nothing`),Nt=new WeakMap,Pt=yt.createTreeWalker(yt,129);function Ft(e,t){if(!St(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return mt===void 0?t:mt.createHTML(t)}var It=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=Tt;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===Tt?c[1]===`!--`?o=Et:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=Ot):(jt.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=Ot):o=Dt:o===Ot?c[0]===`>`?(o=i??Tt,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?Ot:c[3]===`"`?At:kt):o===At||o===kt?o=Ot:o===Et||o===Dt?o=Tt:(o=Ot,i=void 0);let d=o===Ot&&e[t+1].startsWith(`/>`)?` `:``;a+=o===Tt?n+vt:l>=0?(r.push(s),n.slice(0,l)+ht+n.slice(l)+gt+d):n+gt+(l===-2?t:d)}return[Ft(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},Lt=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=It(t,n);if(this.el=e.createElement(l,r),Pt.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=Pt.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(ht)){let t=u[o++],n=i.getAttribute(e).split(gt),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Ht:r[1]===`?`?Ut:r[1]===`@`?Wt:Vt}),i.removeAttribute(e)}else e.startsWith(gt)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(jt.test(i.tagName)){let e=i.textContent.split(gt),t=e.length-1;if(t>0){i.textContent=pt?pt.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],bt()),Pt.nextNode(),c.push({type:2,index:++a});i.append(e[t],bt())}}}else if(i.nodeType===8)if(i.data===_t)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(gt,e+1))!==-1;)c.push({type:7,index:a}),e+=gt.length-1}a++}}static createElement(e,t){let n=yt.createElement(`template`);return n.innerHTML=e,n}};function Rt(e,t,n=e,r){if(t===Mt)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=xt(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=Rt(e,i._$AS(e,t.values),i,r)),t}var zt=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??yt).importNode(t,!0);Pt.currentNode=r;let i=Pt.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Bt(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Gt(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=Pt.nextNode(),a++)}return Pt.currentNode=yt,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Bt=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=w,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Rt(this,e,t),xt(e)?e===w||e==null||e===``?(this._$AH!==w&&this._$AR(),this._$AH=w):e!==this._$AH&&e!==Mt&&this._(e):e._$litType$===void 0?e.nodeType===void 0?Ct(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==w&&xt(this._$AH)?this._$AA.nextSibling.data=e:this.T(yt.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Lt.createElement(Ft(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new zt(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Nt.get(e.strings);return t===void 0&&Nt.set(e.strings,t=new Lt(e)),t}k(t){St(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(bt()),this.O(bt()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=ft(e).nextSibling;ft(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Vt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=w,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=w}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=Rt(this,e,t,0),a=!xt(e)||e!==this._$AH&&e!==Mt,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=Rt(this,r[n+o],t,o),s===Mt&&(s=this._$AH[o]),a||=!xt(s)||s!==this._$AH[o],s===w?e=w:e!==w&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===w?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ht=class extends Vt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===w?void 0:e}},Ut=class extends Vt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==w)}},Wt=class extends Vt{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=Rt(this,e,t,0)??w)===Mt)return;let n=this._$AH,r=e===w&&n!==w||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==w&&(n===w||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Gt=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){Rt(this,e)}},Kt={M:ht,P:gt,A:_t,C:1,L:It,R:zt,D:Ct,V:Rt,I:Bt,H:Vt,N:Ut,U:Wt,B:Ht,F:Gt},qt=dt.litHtmlPolyfillSupport;qt?.(Lt,Bt),(dt.litHtmlVersions??=[]).push(`3.3.2`);var Jt=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Bt(t.insertBefore(bt(),e),e,void 0,n??{})}return i._$AI(e),i},Yt=globalThis,T=class extends ut{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Jt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Mt}};T._$litElement$=!0,T.finalized=!0,Yt.litElementHydrateSupport?.({LitElement:T});var Xt=Yt.litElementPolyfillSupport;Xt?.({LitElement:T}),(Yt.litElementVersions??=[]).push(`4.2.2`);var Zt=S`
  :host {
...
`,$t=``;function en(e){$t=e}function tn(e=``){if(!$t){let e=[...document.getElementsByTagName(`script`)],t=e.find(e=>e.hasAttribute(`data-shoelace`));if(t)en(t.getAttribute(`data-shoelace`));else{let t=e.find(e=>/shoelace(\.min)?\.js($|\?)/.test(e.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(e.src)),n=``;t&&(n=t.getAttribute(`src`)),en(n.split(`/`).slice(0,-1).join(`/`))}}return $t.replace(/\/$/,``)+(e?`/${e.replace(/^\//,``)}`:``)}var nn={name:`default`,resolver:e=>tn(`assets/icons/${e}.svg`)},rn={caret:`
  ...
  `},an=[nn,{name:`system`,resolver:e=>e in rn?`data:image/svg+xml,${encodeURIComponent(rn[e])}`:``}],on=[];function sn(e){on.push(e)}function cn(e){on=on.filter(t=>t!==e)}function ln(e){return an.find(t=>t.name===e)}function un(e,t){dn(e),an.push({name:e,resolver:t.resolver,mutator:t.mutator,spriteSheet:t.spriteSheet}),on.forEach(t=>{t.library===e&&t.setIcon()})}function dn(e){an=an.filter(t=>t.name!==e)}var fn=S`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`,pn=Object.defineProperty,mn=Object.defineProperties,hn=Object.getOwnPropertyDescriptor,gn=Object.getOwnPropertyDescriptors,_n=Object.getOwnPropertySymbols,vn=Object.prototype.hasOwnProperty,yn=Object.prototype.propertyIsEnumerable,bn=(e,t)=>(t=Symbol[e])?t:Symbol.for(`Symbol.`+e),xn=e=>{throw TypeError(e)},Sn=(e,t,n)=>t in e?pn(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,Cn=(e,t)=>{for(var n in t||={})vn.call(t,n)&&Sn(e,n,t[n]);if(_n)for(var n of _n(t))yn.call(t,n)&&Sn(e,n,t[n]);return e},wn=(e,t)=>mn(e,gn(t)),E=(e,t,n,r)=>{for(var i=r>1?void 0:r?hn(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&pn(t,n,i),i},Tn=(e,t,n)=>t.has(e)||xn(`Cannot `+n),En=(e,t,n)=>(Tn(e,t,`read from private field`),n?n.call(e):t.get(e)),Dn=(e,t,n)=>t.has(e)?xn(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),On=(e,t,n,r)=>(Tn(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),kn=function(e,t){this[0]=e,this[1]=t},An=e=>{var t=e[bn(`asyncIterator`)],n=!1,r,i={};return t==null?(t=e[bn(`iterator`)](),r=e=>i[e]=n=>t[e](n)):(t=t.call(e),r=e=>i[e]=r=>{if(n){if(n=!1,e===`throw`)throw r;return r}return n=!0,{done:!1,value:new kn(new Promise(n=>{var i=t[e](r);i instanceof Object||xn(`Object expected`),n(i)}),1)}}),i[bn(`iterator`)]=()=>i,r(`next`),`throw`in t?r(`throw`):i.throw=e=>{throw e},`return`in t&&r(`return`),i};function D(e,t){let n=Cn({waitUntilFirstUpdate:!1},t);return(t,r)=>{let{update:i}=t,a=Array.isArray(e)?e:[e];t.update=function(e){a.forEach(t=>{let i=t;if(e.has(i)){let t=e.get(i),a=this[i];t!==a&&(!n.waitUntilFirstUpdate||this.hasUpdated)&&this[r](t,a)}}),i.call(this,e)}}}var O=S`
  :host {
...
`,k=e=>(t,n)=>{n===void 0?customElements.define(e,t):n.addInitializer(()=>{customElements.define(e,t)})},jn={attribute:!0,type:String,converter:st,reflect:!1,hasChanged:ct},Mn=(e=jn,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function A(e){return(t,n)=>typeof n==`object`?Mn(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function j(e){return A({...e,state:!0,attribute:!1})}function Nn(e){return(t,n)=>{let r=typeof t==`function`?t:t[n];Object.assign(r,e)}}var Pn=(e,t,n)=>(n.configurable=!0,n.enumerable=!0,Reflect.decorate&&typeof t!=`object`&&Object.defineProperty(e,t,n),n);function M(e,t){return(n,r,i)=>{let a=t=>t.renderRoot?.querySelector(e)??null;if(t){let{get:e,set:t}=typeof r==`object`?n:i??(()=>{let e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return Pn(n,r,{get(){let n=e.call(this);return n===void 0&&(n=a(this),(n!==null||this.hasUpdated)&&t.call(this,n)),n}})}return Pn(n,r,{get(){return a(this)}})}}var Fn,N=class extends T{constructor(){super(),Dn(this,Fn,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,Cn({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v`+t.version),`version`in r&&r.version&&(a=` v`+r.version),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}attributeChangedCallback(e,t,n){En(this,Fn)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),On(this,Fn,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}};Fn=new WeakMap,N.version=`2.20.1`,N.dependencies={},E([A()],N.prototype,`dir`,2),E([A()],N.prototype,`lang`,2);var{I:In}=Kt,Ln=(e,t)=>t===void 0?e?._$litType$!==void 0:e?._$litType$===t,Rn=e=>e.strings===void 0,zn={},Bn=(e,t=zn)=>e._$AH=t,Vn=Symbol(),Hn=Symbol(),Un,Wn=new Map,Gn=class extends N{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label=``,this.library=`default`}async resolveIcon(e,t){let n;if(t?.spriteSheet)return this.svg=C`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(n=await fetch(e,{mode:`cors`}),!n.ok)return n.status===410?Vn:Hn}catch{return Hn}try{let e=document.createElement(`div`);e.innerHTML=await n.text();let t=e.firstElementChild;if((t?.tagName)?.toLowerCase()!==`svg`)return Vn;Un||=new DOMParser;let r=Un.parseFromString(t.outerHTML,`text/html`).body.querySelector(`svg`);return r?(r.part.add(`svg`),document.adoptNode(r)):Vn}catch{return Vn}}connectedCallback(){super.connectedCallback(),sn(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),cn(this)}getIconSource(){let e=ln(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label==`string`&&this.label.length>0?(this.setAttribute(`role`,`img`),this.setAttribute(`aria-label`,this.label),this.removeAttribute(`aria-hidden`)):(this.removeAttribute(`role`),this.removeAttribute(`aria-label`),this.setAttribute(`aria-hidden`,`true`))}async setIcon(){var e;let{url:t,fromLibrary:n}=this.getIconSource(),r=n?ln(this.library):void 0;if(!t){this.svg=null;return}let i=Wn.get(t);if(i||(i=this.resolveIcon(t,r),Wn.set(t,i)),!this.initialRender)return;let a=await i;if(a===Hn&&Wn.delete(t),t===this.getIconSource().url){if(Ln(a)){if(this.svg=a,r){await this.updateComplete;let e=this.shadowRoot.querySelector(`[part='svg']`);typeof r.mutator==`function`&&e&&r.mutator(e)}return}switch(a){case Hn:case Vn:this.svg=null,this.emit(`sl-error`);break;default:this.svg=a.cloneNode(!0),(e=r?.mutator)==null||e.call(r,this.svg),this.emit(`sl-load`)}}}render(){return this.svg}};Gn.styles=[O,fn],E([j()],Gn.prototype,`svg`,2),E([A({reflect:!0})],Gn.prototype,`name`,2),E([A()],Gn.prototype,`src`,2),E([A()],Gn.prototype,`label`,2),E([A({reflect:!0})],Gn.prototype,`library`,2),E([D(`label`)],Gn.prototype,`handleLabelChange`,1),E([D([`name`,`src`,`library`])],Gn.prototype,`setIcon`,1);var Kn={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},qn=e=>(...t)=>({_$litDirective$:e,values:t}),Jn=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},P=qn(class extends Jn{constructor(e){if(super(e),e.type!==Kn.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter(t=>e[t]).join(` `)+` `}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter(e=>e!==``)));for(let e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}let n=e.element.classList;for(let e of this.st)e in t||(n.remove(e),this.st.delete(e));for(let e in t){let r=!!t[e];r===this.st.has(e)||this.nt?.has(e)||(r?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return Mt}}),Yn=Symbol.for(``),Xn=e=>{if(e?.r===Yn)return e?._$litStatic$},Zn=e=>({_$litStatic$:e,r:Yn}),Qn=(e,...t)=>({_$litStatic$:t.reduce((t,n,r)=>t+(e=>{if(e._$litStatic$!==void 0)return e._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(n)+e[r+1],e[0]),r:Yn}),$n=new Map,er=(e=>(t,...n)=>{let r=n.length,i,a,o=[],s=[],c,l=0,u=!1;for(;l<r;){for(c=t[l];l<r&&(a=n[l],i=Xn(a))!==void 0;)c+=i+t[++l],u=!0;l!==r&&s.push(a),o.push(c),l++}if(l===r&&o.push(t[r]),u){let e=o.join(`$$lit$$`);(t=$n.get(e))===void 0&&(o.raw=o,$n.set(e,t=o)),n=s}return e(t,...n)})(C),F=e=>e??w,I=class extends N{constructor(){super(...arguments),this.hasFocus=!1,this.label=``,this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit(`sl-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`sl-focus`)}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?Qn`a`:Qn`button`;return er`
      <${t}
        part="base"
    ...
    `}};I.styles=[O,Qt],I.dependencies={"sl-icon":Gn},E([M(`.icon-button`)],I.prototype,`button`,2),E([j()],I.prototype,`hasFocus`,2),E([A()],I.prototype,`name`,2),E([A()],I.prototype,`library`,2),E([A()],I.prototype,`src`,2),E([A()],I.prototype,`href`,2),E([A()],I.prototype,`target`,2),E([A()],I.prototype,`download`,2),E([A()],I.prototype,`label`,2),E([A({type:Boolean,reflect:!0})],I.prototype,`disabled`,2);var tr=new Set,nr=new Map,rr,ir=`ltr`,ar=`en`,or=typeof MutationObserver<`u`&&typeof document<`u`&&document.documentElement!==void 0;if(or){let e=new MutationObserver(cr);ir=document.documentElement.dir||`ltr`,ar=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributes:!0,attributeFilter:[`dir`,`lang`]})}function sr(...e){e.map(e=>{let t=e.$code.toLowerCase();nr.has(t)?nr.set(t,Object.assign(Object.assign({},nr.get(t)),e)):nr.set(t,e),rr||=e}),cr()}function cr(){or&&(ir=document.documentElement.dir||`ltr`,ar=document.documentElement.lang||navigator.language),[...tr.keys()].map(e=>{typeof e.requestUpdate==`function`&&e.requestUpdate()})}var lr=class{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){tr.add(this.host)}hostDisconnected(){tr.delete(this.host)}dir(){return`${this.host.dir||ir}`.toLowerCase()}lang(){return`${this.host.lang||ar}`.toLowerCase()}getTranslationData(e){let t=new Intl.Locale(e.replace(/_/g,`-`)),n=t?.language.toLowerCase(),r=(t?.region)?.toLowerCase()??``;return{locale:t,language:n,region:r,primary:nr.get(`${n}-${r}`),secondary:nr.get(n)}}exists(e,t){let{primary:n,secondary:r}=this.getTranslationData(t.lang??this.lang());return t=Object.assign({includeFallback:!1},t),!!(n&&n[e]||r&&r[e]||t.includeFallback&&rr&&rr[e])}term(e,...t){let{primary:n,secondary:r}=this.getTranslationData(this.lang()),i;if(n&&n[e])i=n[e];else if(r&&r[e])i=r[e];else if(rr&&rr[e])i=rr[e];else return console.error(`No translation found for: ${String(e)}`),String(e);return typeof i==`function`?i(...t):i}date(e,t){return e=new Date(e),new Intl.DateTimeFormat(this.lang(),t).format(e)}number(e,t){return e=Number(e),isNaN(e)?``:new Intl.NumberFormat(this.lang(),t).format(e)}relativeTime(e,t,n){return new Intl.RelativeTimeFormat(this.lang(),n).format(e,t)}},ur={$code:`en`,$name:`English`,$dir:`ltr`,carousel:`Carousel`,clearEntry:`Clear entry`,close:`Close`,copied:`Copied`,copy:`Copy`,currentValue:`Current value`,error:`Error`,goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:`Hide password`,loading:`Loading`,nextSlide:`Next slide`,numOptionsSelected:e=>e===0?`No options selected`:e===1?`1 option selected`:`${e} options selected`,previousSlide:`Previous slide`,progress:`Progress`,remove:`Remove`,resize:`Resize`,scrollToEnd:`Scroll to end`,scrollToStart:`Scroll to start`,selectAColorFromTheScreen:`Select a color from the screen`,showPassword:`Show password`,slideNum:e=>`Slide ${e}`,toggleColorFormat:`Toggle color format`};sr(ur);var dr=ur,L=class extends lr{};sr(dr);var fr=class extends N{constructor(){super(...arguments),this.localize=new L(this),this.variant=`neutral`,this.size=`medium`,this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit(`sl-remove`)}render(){return C`
      <span
        part="base"
    ...
    `}};fr.styles=[O,Zt],fr.dependencies={"sl-icon-button":I},E([A({reflect:!0})],fr.prototype,`variant`,2),E([A({reflect:!0})],fr.prototype,`size`,2),E([A({type:Boolean,reflect:!0})],fr.prototype,`pill`,2),E([A({type:Boolean})],fr.prototype,`removable`,2),fr.define(`sl-tag`),I.define(`sl-icon-button`);var pr=S`
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
    --show-delay: 150ms;
...
`,hr=Math.min,gr=Math.max,_r=Math.round,vr=Math.floor,yr=e=>({x:e,y:e}),br={left:`right`,right:`left`,bottom:`top`,top:`bottom`};function xr(e,t,n){return gr(e,hr(t,n))}function Sr(e,t){return typeof e==`function`?e(t):e}function Cr(e){return e.split(`-`)[0]}function wr(e){return e.split(`-`)[1]}function Tr(e){return e===`x`?`y`:`x`}function Er(e){return e===`y`?`height`:`width`}function Dr(e){let t=e[0];return t===`t`||t===`b`?`y`:`x`}function Or(e){return Tr(Dr(e))}function kr(e,t,n){n===void 0&&(n=!1);let r=wr(e),i=Or(e),a=Er(i),o=i===`x`?r===(n?`end`:`start`)?`right`:`left`:r===`start`?`bottom`:`top`;return t.reference[a]>t.floating[a]&&(o=Rr(o)),[o,Rr(o)]}function Ar(e){let t=Rr(e);return[jr(e),t,jr(t)]}function jr(e){return e.includes(`start`)?e.replace(`start`,`end`):e.replace(`end`,`start`)}var Mr=[`left`,`right`],Nr=[`right`,`left`],Pr=[`top`,`bottom`],Fr=[`bottom`,`top`];function Ir(e,t,n){switch(e){case`top`:case`bottom`:return n?t?Nr:Mr:t?Mr:Nr;case`left`:case`right`:return t?Pr:Fr;default:return[]}}function Lr(e,t,n,r){let i=wr(e),a=Ir(Cr(e),n===`start`,r);return i&&(a=a.map(e=>e+`-`+i),t&&(a=a.concat(a.map(jr)))),a}function Rr(e){let t=Cr(e);return br[t]+e.slice(t.length)}function zr(e){return{top:0,right:0,bottom:0,left:0,...e}}function Br(e){return typeof e==`number`?{top:e,right:e,bottom:e,left:e}:zr(e)}function Vr(e){let{x:t,y:n,width:r,height:i}=e;return{width:r,height:i,top:n,left:t,right:t+r,bottom:n+i,x:t,y:n}}function Hr(e,t,n){let{reference:r,floating:i}=e,a=Dr(t),o=Or(t),s=Er(o),c=Cr(t),l=a===`y`,u=r.x+r.width/2-i.width/2,d=r.y+r.height/2-i.height/2,f=r[s]/2-i[s]/2,p;switch(c){case`top`:p={x:u,y:r.y-i.height};break;case`bottom`:p={x:u,y:r.y+r.height};break;case`right`:p={x:r.x+r.width,y:d};break;case`left`:p={x:r.x-i.width,y:d};break;default:p={x:r.x,y:r.y}}switch(wr(t)){case`start`:p[o]-=f*(n&&l?-1:1);break;case`end`:p[o]+=f*(n&&l?-1:1);break}return p}async function Ur(e,t){t===void 0&&(t={});let{x:n,y:r,platform:i,rects:a,elements:o,strategy:s}=e,{boundary:c=`clippingAncestors`,rootBoundary:l=`viewport`,elementContext:u=`floating`,altBoundary:d=!1,padding:f=0}=Sr(t,e),p=Br(f),m=o[d?u===`floating`?`reference`:`floating`:u],h=Vr(await i.getClippingRect({element:await(i.isElement==null?void 0:i.isElement(m))??!0?m:m.contextElement||await(i.getDocumentElement==null?void 0:i.getDocumentElement(o.floating)),boundary:c,rootBoundary:l,strategy:s})),g=u===`floating`?{x:n,y:r,width:a.floating.width,height:a.floating.height}:a.reference,ee=await(i.getOffsetParent==null?void 0:i.getOffsetParent(o.floating)),te=await(i.isElement==null?void 0:i.isElement(ee))&&await(i.getScale==null?void 0:i.getScale(ee))||{x:1,y:1},_=Vr(i.convertOffsetParentRelativeRectToViewportRelativeRect?await i.convertOffsetParentRelativeRectToViewportRelativeRect({elements:o,rect:g,offsetParent:ee,strategy:s}):g);return{top:(h.top-_.top+p.top)/te.y,bottom:(_.bottom-h.bottom+p.bottom)/te.y,left:(h.left-_.left+p.left)/te.x,right:(_.right-h.right+p.right)/te.x}}var Wr=50,Gr=async(e,t,n)=>{let{placement:r=`bottom`,strategy:i=`absolute`,middleware:a=[],platform:o}=n,s=o.detectOverflow?o:{...o,detectOverflow:Ur},c=await(o.isRTL==null?void 0:o.isRTL(t)),l=await o.getElementRects({reference:e,floating:t,strategy:i}),{x:u,y:d}=Hr(l,r,c),f=r,p=0,m={};for(let n=0;n<a.length;n++){let h=a[n];if(!h)continue;let{name:g,fn:ee}=h,{x:te,y:_,data:ne,reset:re}=await ee({x:u,y:d,initialPlacement:r,placement:f,strategy:i,middlewareData:m,rects:l,platform:s,elements:{reference:e,floating:t}});u=te??u,d=_??d,m[g]={...m[g],...ne},re&&p<Wr&&(p++,typeof re==`object`&&(re.placement&&(f=re.placement),re.rects&&(l=re.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:i}):re.rects),{x:u,y:d}=Hr(l,f,c)),n=-1)}return{x:u,y:d,placement:f,strategy:i,middlewareData:m}},Kr=e=>({name:`arrow`,options:e,async fn(t){let{x:n,y:r,placement:i,rects:a,platform:o,elements:s,middlewareData:c}=t,{element:l,padding:u=0}=Sr(e,t)||{};if(l==null)return{};let d=Br(u),f={x:n,y:r},p=Or(i),m=Er(p),h=await o.getDimensions(l),g=p===`y`,ee=g?`top`:`left`,te=g?`bottom`:`right`,_=g?`clientHeight`:`clientWidth`,ne=a.reference[m]+a.reference[p]-f[p]-a.floating[m],re=f[p]-a.reference[p],v=await(o.getOffsetParent==null?void 0:o.getOffsetParent(l)),y=v?v[_]:0;(!y||!await(o.isElement==null?void 0:o.isElement(v)))&&(y=s.floating[_]||a.floating[m]);let b=ne/2-re/2,ie=y/2-h[m]/2-1,ae=hr(d[ee],ie),oe=hr(d[te],ie),se=ae,ce=y-h[m]-oe,le=y/2-h[m]/2+b,ue=xr(se,le,ce),de=!c.arrow&&wr(i)!=null&&le!==ue&&a.reference[m]/2-(le<se?ae:oe)-h[m]/2<0,fe=de?le<se?le-se:le-ce:0;return{[p]:f[p]+fe,data:{[p]:ue,centerOffset:le-ue-fe,...de&&{alignmentOffset:fe}},reset:de}}}),qr=function(e){return e===void 0&&(e={}),{name:`flip`,options:e,async fn(t){var n;let{placement:r,middlewareData:i,rects:a,initialPlacement:o,platform:s,elements:c}=t,{mainAxis:l=!0,crossAxis:u=!0,fallbackPlacements:d,fallbackStrategy:f=`bestFit`,fallbackAxisSideDirection:p=`none`,flipAlignment:m=!0,...h}=Sr(e,t);if((n=i.arrow)!=null&&n.alignmentOffset)return{};let g=Cr(r),ee=Dr(o),te=Cr(o)===o,_=await(s.isRTL==null?void 0:s.isRTL(c.floating)),ne=d||(te||!m?[Rr(o)]:Ar(o)),re=p!==`none`;!d&&re&&ne.push(...Lr(o,m,p,_));let v=[o,...ne],y=await s.detectOverflow(t,h),b=[],ie=i.flip?.overflows||[];if(l&&b.push(y[g]),u){let e=kr(r,a,_);b.push(y[e[0]],y[e[1]])}if(ie=[...ie,{placement:r,overflows:b}],!b.every(e=>e<=0)){let e=(i.flip?.index||0)+1,t=v[e];if(t&&(!(u===`alignment`&&ee!==Dr(t))||ie.every(e=>Dr(e.placement)===ee?e.overflows[0]>0:!0)))return{data:{index:e,overflows:ie},reset:{placement:t}};let n=ie.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0]?.placement;if(!n)switch(f){case`bestFit`:{let e=ie.filter(e=>{if(re){let t=Dr(e.placement);return t===ee||t===`y`}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0]?.[0];e&&(n=e);break}case`initialPlacement`:n=o;break}if(r!==n)return{reset:{placement:n}}}return{}}}},Jr=new Set([`left`,`top`]);async function Yr(e,t){let{placement:n,platform:r,elements:i}=e,a=await(r.isRTL==null?void 0:r.isRTL(i.floating)),o=Cr(n),s=wr(n),c=Dr(n)===`y`,l=Jr.has(o)?-1:1,u=a&&c?-1:1,d=Sr(t,e),{mainAxis:f,crossAxis:p,alignmentAxis:m}=typeof d==`number`?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return s&&typeof m==`number`&&(p=s===`end`?m*-1:m),c?{x:p*u,y:f*l}:{x:f*l,y:p*u}}var Xr=function(e){return e===void 0&&(e=0),{name:`offset`,options:e,async fn(t){var n;let{x:r,y:i,placement:a,middlewareData:o}=t,s=await Yr(t,e);return a===o.offset?.placement&&(n=o.arrow)!=null&&n.alignmentOffset?{}:{x:r+s.x,y:i+s.y,data:{...s,placement:a}}}}},Zr=function(e){return e===void 0&&(e={}),{name:`shift`,options:e,async fn(t){let{x:n,y:r,placement:i,platform:a}=t,{mainAxis:o=!0,crossAxis:s=!1,limiter:c={fn:e=>{let{x:t,y:n}=e;return{x:t,y:n}}},...l}=Sr(e,t),u={x:n,y:r},d=await a.detectOverflow(t,l),f=Dr(Cr(i)),p=Tr(f),m=u[p],h=u[f];if(o){let e=p===`y`?`top`:`left`,t=p===`y`?`bottom`:`right`,n=m+d[e],r=m-d[t];m=xr(n,m,r)}if(s){let e=f===`y`?`top`:`left`,t=f===`y`?`bottom`:`right`,n=h+d[e],r=h-d[t];h=xr(n,h,r)}let g=c.fn({...t,[p]:m,[f]:h});return{...g,data:{x:g.x-n,y:g.y-r,enabled:{[p]:o,[f]:s}}}}}},Qr=function(e){return e===void 0&&(e={}),{name:`size`,options:e,async fn(t){var n,r;let{placement:i,rects:a,platform:o,elements:s}=t,{apply:c=()=>{},...l}=Sr(e,t),u=await o.detectOverflow(t,l),d=Cr(i),f=wr(i),p=Dr(i)===`y`,{width:m,height:h}=a.floating,g,ee;d===`top`||d===`bottom`?(g=d,ee=f===(await(o.isRTL==null?void 0:o.isRTL(s.floating))?`start`:`end`)?`left`:`right`):(ee=d,g=f===`end`?`top`:`bottom`);let te=h-u.top-u.bottom,_=m-u.left-u.right,ne=hr(h-u[g],te),re=hr(m-u[ee],_),v=!t.middlewareData.shift,y=ne,b=re;if((n=t.middlewareData.shift)!=null&&n.enabled.x&&(b=_),(r=t.middlewareData.shift)!=null&&r.enabled.y&&(y=te),v&&!f){let e=gr(u.left,0),t=gr(u.right,0),n=gr(u.top,0),r=gr(u.bottom,0);p?b=m-2*(e!==0||t!==0?e+t:gr(u.left,u.right)):y=h-2*(n!==0||r!==0?n+r:gr(u.top,u.bottom))}await c({...t,availableWidth:b,availableHeight:y});let ie=await o.getDimensions(s.floating);return m!==ie.width||h!==ie.height?{reset:{rects:!0}}:{}}}};function $r(){return typeof window<`u`}function ei(e){return ri(e)?(e.nodeName||``).toLowerCase():`#document`}function ti(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function ni(e){return((ri(e)?e.ownerDocument:e.document)||window.document)?.documentElement}function ri(e){return $r()?e instanceof Node||e instanceof ti(e).Node:!1}function ii(e){return $r()?e instanceof Element||e instanceof ti(e).Element:!1}function ai(e){return $r()?e instanceof HTMLElement||e instanceof ti(e).HTMLElement:!1}function oi(e){return!$r()||typeof ShadowRoot>`u`?!1:e instanceof ShadowRoot||e instanceof ti(e).ShadowRoot}function si(e){let{overflow:t,overflowX:n,overflowY:r,display:i}=vi(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&i!==`inline`&&i!==`contents`}function ci(e){return/^(table|td|th)$/.test(ei(e))}function li(e){try{if(e.matches(`:popover-open`))return!0}catch{}try{return e.matches(`:modal`)}catch{return!1}}var ui=/transform|translate|scale|rotate|perspective|filter/,di=/paint|layout|strict|content/,fi=e=>!!e&&e!==`none`,pi;function mi(e){let t=ii(e)?vi(e):e;return fi(t.transform)||fi(t.translate)||fi(t.scale)||fi(t.rotate)||fi(t.perspective)||!gi()&&(fi(t.backdropFilter)||fi(t.filter))||ui.test(t.willChange||``)||di.test(t.contain||``)}function hi(e){let t=bi(e);for(;ai(t)&&!_i(t);){if(mi(t))return t;if(li(t))return null;t=bi(t)}return null}function gi(){return pi??=typeof CSS<`u`&&CSS.supports&&CSS.supports(`-webkit-backdrop-filter`,`none`),pi}function _i(e){return/^(html|body|#document)$/.test(ei(e))}function vi(e){return ti(e).getComputedStyle(e)}function yi(e){return ii(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function bi(e){if(ei(e)===`html`)return e;let t=e.assignedSlot||e.parentNode||oi(e)&&e.host||ni(e);return oi(t)?t.host:t}function xi(e){let t=bi(e);return _i(t)?e.ownerDocument?e.ownerDocument.body:e.body:ai(t)&&si(t)?t:xi(t)}function Si(e,t,n){t===void 0&&(t=[]),n===void 0&&(n=!0);let r=xi(e),i=r===e.ownerDocument?.body,a=ti(r);if(i){let e=Ci(a);return t.concat(a,a.visualViewport||[],si(r)?r:[],e&&n?Si(e):[])}else return t.concat(r,Si(r,[],n))}function Ci(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function wi(e){let t=vi(e),n=parseFloat(t.width)||0,r=parseFloat(t.height)||0,i=ai(e),a=i?e.offsetWidth:n,o=i?e.offsetHeight:r,s=_r(n)!==a||_r(r)!==o;return s&&(n=a,r=o),{width:n,height:r,$:s}}function Ti(e){return ii(e)?e:e.contextElement}function Ei(e){let t=Ti(e);if(!ai(t))return yr(1);let n=t.getBoundingClientRect(),{width:r,height:i,$:a}=wi(t),o=(a?_r(n.width):n.width)/r,s=(a?_r(n.height):n.height)/i;return(!o||!Number.isFinite(o))&&(o=1),(!s||!Number.isFinite(s))&&(s=1),{x:o,y:s}}var Di=yr(0);function Oi(e){let t=ti(e);return!gi()||!t.visualViewport?Di:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function ki(e,t,n){return t===void 0&&(t=!1),!n||t&&n!==ti(e)?!1:t}function Ai(e,t,n,r){t===void 0&&(t=!1),n===void 0&&(n=!1);let i=e.getBoundingClientRect(),a=Ti(e),o=yr(1);t&&(r?ii(r)&&(o=Ei(r)):o=Ei(e));let s=ki(a,n,r)?Oi(a):yr(0),c=(i.left+s.x)/o.x,l=(i.top+s.y)/o.y,u=i.width/o.x,d=i.height/o.y;if(a){let e=ti(a),t=r&&ii(r)?ti(r):r,n=e,i=Ci(n);for(;i&&r&&t!==n;){let e=Ei(i),t=i.getBoundingClientRect(),r=vi(i),a=t.left+(i.clientLeft+parseFloat(r.paddingLeft))*e.x,o=t.top+(i.clientTop+parseFloat(r.paddingTop))*e.y;c*=e.x,l*=e.y,u*=e.x,d*=e.y,c+=a,l+=o,n=ti(i),i=Ci(n)}}return Vr({width:u,height:d,x:c,y:l})}function ji(e,t){let n=yi(e).scrollLeft;return t?t.left+n:Ai(ni(e)).left+n}function Mi(e,t){let n=e.getBoundingClientRect();return{x:n.left+t.scrollLeft-ji(e,n),y:n.top+t.scrollTop}}function Ni(e){let{elements:t,rect:n,offsetParent:r,strategy:i}=e,a=i===`fixed`,o=ni(r),s=t?li(t.floating):!1;if(r===o||s&&a)return n;let c={scrollLeft:0,scrollTop:0},l=yr(1),u=yr(0),d=ai(r);if((d||!d&&!a)&&((ei(r)!==`body`||si(o))&&(c=yi(r)),d)){let e=Ai(r);l=Ei(r),u.x=e.x+r.clientLeft,u.y=e.y+r.clientTop}let f=o&&!d&&!a?Mi(o,c):yr(0);return{width:n.width*l.x,height:n.height*l.y,x:n.x*l.x-c.scrollLeft*l.x+u.x+f.x,y:n.y*l.y-c.scrollTop*l.y+u.y+f.y}}function Pi(e){return Array.from(e.getClientRects())}function Fi(e){let t=ni(e),n=yi(e),r=e.ownerDocument.body,i=gr(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),a=gr(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight),o=-n.scrollLeft+ji(e),s=-n.scrollTop;return vi(r).direction===`rtl`&&(o+=gr(t.clientWidth,r.clientWidth)-i),{width:i,height:a,x:o,y:s}}var Ii=25;function Li(e,t){let n=ti(e),r=ni(e),i=n.visualViewport,a=r.clientWidth,o=r.clientHeight,s=0,c=0;if(i){a=i.width,o=i.height;let e=gi();(!e||e&&t===`fixed`)&&(s=i.offsetLeft,c=i.offsetTop)}let l=ji(r);if(l<=0){let e=r.ownerDocument,t=e.body,n=getComputedStyle(t),i=e.compatMode===`CSS1Compat`&&parseFloat(n.marginLeft)+parseFloat(n.marginRight)||0,o=Math.abs(r.clientWidth-t.clientWidth-i);o<=Ii&&(a-=o)}else l<=Ii&&(a+=l);return{width:a,height:o,x:s,y:c}}function Ri(e,t){let n=Ai(e,!0,t===`fixed`),r=n.top+e.clientTop,i=n.left+e.clientLeft,a=ai(e)?Ei(e):yr(1);return{width:e.clientWidth*a.x,height:e.clientHeight*a.y,x:i*a.x,y:r*a.y}}function zi(e,t,n){let r;if(t===`viewport`)r=Li(e,n);else if(t===`document`)r=Fi(ni(e));else if(ii(t))r=Ri(t,n);else{let n=Oi(e);r={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return Vr(r)}function Bi(e,t){let n=bi(e);return n===t||!ii(n)||_i(n)?!1:vi(n).position===`fixed`||Bi(n,t)}function Vi(e,t){let n=t.get(e);if(n)return n;let r=Si(e,[],!1).filter(e=>ii(e)&&ei(e)!==`body`),i=null,a=vi(e).position===`fixed`,o=a?bi(e):e;for(;ii(o)&&!_i(o);){let t=vi(o),n=mi(o);!n&&t.position===`fixed`&&(i=null),(a?!n&&!i:!n&&t.position===`static`&&i&&(i.position===`absolute`||i.position===`fixed`)||si(o)&&!n&&Bi(e,o))?r=r.filter(e=>e!==o):i=t,o=bi(o)}return t.set(e,r),r}function Hi(e){let{element:t,boundary:n,rootBoundary:r,strategy:i}=e,a=[...n===`clippingAncestors`?li(t)?[]:Vi(t,this._c):[].concat(n),r],o=zi(t,a[0],i),s=o.top,c=o.right,l=o.bottom,u=o.left;for(let e=1;e<a.length;e++){let n=zi(t,a[e],i);s=gr(n.top,s),c=hr(n.right,c),l=hr(n.bottom,l),u=gr(n.left,u)}return{width:c-u,height:l-s,x:u,y:s}}function Ui(e){let{width:t,height:n}=wi(e);return{width:t,height:n}}function Wi(e,t,n){let r=ai(t),i=ni(t),a=n===`fixed`,o=Ai(e,!0,a,t),s={scrollLeft:0,scrollTop:0},c=yr(0);function l(){c.x=ji(i)}if(r||!r&&!a)if((ei(t)!==`body`||si(i))&&(s=yi(t)),r){let e=Ai(t,!0,a,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else i&&l();a&&!r&&i&&l();let u=i&&!r&&!a?Mi(i,s):yr(0);return{x:o.left+s.scrollLeft-c.x-u.x,y:o.top+s.scrollTop-c.y-u.y,width:o.width,height:o.height}}function Gi(e){return vi(e).position===`static`}function Ki(e,t){if(!ai(e)||vi(e).position===`fixed`)return null;if(t)return t(e);let n=e.offsetParent;return ni(e)===n&&(n=n.ownerDocument.body),n}function qi(e,t){let n=ti(e);if(li(e))return n;if(!ai(e)){let t=bi(e);for(;t&&!_i(t);){if(ii(t)&&!Gi(t))return t;t=bi(t)}return n}let r=Ki(e,t);for(;r&&ci(r)&&Gi(r);)r=Ki(r,t);return r&&_i(r)&&Gi(r)&&!mi(r)?n:r||hi(e)||n}var Ji=async function(e){let t=this.getOffsetParent||qi,n=this.getDimensions,r=await n(e.floating);return{reference:Wi(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function Yi(e){return vi(e).direction===`rtl`}var Xi={convertOffsetParentRelativeRectToViewportRelativeRect:Ni,getDocumentElement:ni,getClippingRect:Hi,getOffsetParent:qi,getElementRects:Ji,getClientRects:Pi,getDimensions:Ui,getScale:Ei,isElement:ii,isRTL:Yi};function Zi(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function Qi(e,t){let n=null,r,i=ni(e);function a(){var e;clearTimeout(r),(e=n)==null||e.disconnect(),n=null}function o(s,c){s===void 0&&(s=!1),c===void 0&&(c=1),a();let l=e.getBoundingClientRect(),{left:u,top:d,width:f,height:p}=l;if(s||t(),!f||!p)return;let m=vr(d),h=vr(i.clientWidth-(u+f)),g=vr(i.clientHeight-(d+p)),ee=vr(u),te={rootMargin:-m+`px `+-h+`px `+-g+`px `+-ee+`px`,threshold:gr(0,hr(1,c))||1},_=!0;function ne(t){let n=t[0].intersectionRatio;if(n!==c){if(!_)return o();n?o(!1,n):r=setTimeout(()=>{o(!1,1e-7)},1e3)}n===1&&!Zi(l,e.getBoundingClientRect())&&o(),_=!1}try{n=new IntersectionObserver(ne,{...te,root:i.ownerDocument})}catch{n=new IntersectionObserver(ne,te)}n.observe(e)}return o(!0),a}function $i(e,t,n,r){r===void 0&&(r={});let{ancestorScroll:i=!0,ancestorResize:a=!0,elementResize:o=typeof ResizeObserver==`function`,layoutShift:s=typeof IntersectionObserver==`function`,animationFrame:c=!1}=r,l=Ti(e),u=i||a?[...l?Si(l):[],...t?Si(t):[]]:[];u.forEach(e=>{i&&e.addEventListener(`scroll`,n,{passive:!0}),a&&e.addEventListener(`resize`,n)});let d=l&&s?Qi(l,n):null,f=-1,p=null;o&&(p=new ResizeObserver(e=>{let[r]=e;r&&r.target===l&&p&&t&&(p.unobserve(t),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var e;(e=p)==null||e.observe(t)})),n()}),l&&!c&&p.observe(l),t&&p.observe(t));let m,h=c?Ai(e):null;c&&g();function g(){let t=Ai(e);h&&!Zi(h,t)&&n(),h=t,m=requestAnimationFrame(g)}return n(),()=>{var e;u.forEach(e=>{i&&e.removeEventListener(`scroll`,n),a&&e.removeEventListener(`resize`,n)}),d?.(),(e=p)==null||e.disconnect(),p=null,c&&cancelAnimationFrame(m)}}var ea=Xr,ta=Zr,na=qr,ra=Qr,ia=Kr,aa=(e,t,n)=>{let r=new Map,i={platform:Xi,...n},a={...i.platform,_c:r};return Gr(e,t,{...i,platform:a})};function oa(e){return ca(e)}function sa(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function ca(e){for(let t=e;t;t=sa(t))if(t instanceof Element&&getComputedStyle(t).display===`none`)return null;for(let t=sa(e);t;t=sa(t)){if(!(t instanceof Element))continue;let e=getComputedStyle(t);if(e.display!==`contents`&&(e.position!==`static`||mi(e)||t.tagName===`BODY`))return t}return null}function la(e){return typeof e==`object`&&!!e&&`getBoundingClientRect`in e&&(`contextElement`in e?e.contextElement instanceof Element:!0)}var R=class extends N{constructor(){super(...arguments),this.localize=new L(this),this.active=!1,this.placement=`top`,this.strategy=`absolute`,this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement=`anchor`,this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements=``,this.flipFallbackStrategy=`best-fit`,this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=this.placement.includes(`top`)||this.placement.includes(`bottom`),r=0,i=0,a=0,o=0,s=0,c=0,l=0,u=0;n?e.top<t.top?(r=e.left,i=e.bottom,a=e.right,o=e.bottom,s=t.left,c=t.top,l=t.right,u=t.top):(r=t.left,i=t.bottom,a=t.right,o=t.bottom,s=e.left,c=e.top,l=e.right,u=e.top):e.left<t.left?(r=e.right,i=e.top,a=t.left,o=t.top,s=e.right,c=e.bottom,l=t.left,u=t.bottom):(r=t.right,i=t.top,a=e.left,o=e.top,s=t.right,c=t.bottom,l=e.left,u=e.bottom),this.style.setProperty(`--hover-bridge-top-left-x`,`${r}px`),this.style.setProperty(`--hover-bridge-top-left-y`,`${i}px`),this.style.setProperty(`--hover-bridge-top-right-x`,`${a}px`),this.style.setProperty(`--hover-bridge-top-right-y`,`${o}px`),this.style.setProperty(`--hover-bridge-bottom-left-x`,`${s}px`),this.style.setProperty(`--hover-bridge-bottom-left-y`,`${c}px`),this.style.setProperty(`--hover-bridge-bottom-right-x`,`${l}px`),this.style.setProperty(`--hover-bridge-bottom-right-y`,`${u}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has(`active`)&&(this.active?this.start():this.stop()),e.has(`anchor`)&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){await this.stop(),this.anchor&&typeof this.anchor==`string`?this.anchorEl=this.getRootNode().getElementById(this.anchor):this.anchor instanceof Element||la(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector(`[slot="anchor"]`),this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=$i(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute(`data-current-placement`),this.style.removeProperty(`--auto-size-available-width`),this.style.removeProperty(`--auto-size-available-height`),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;let e=[ea({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(ra({apply:({rects:e})=>{let t=this.sync===`width`||this.sync===`both`,n=this.sync===`height`||this.sync===`both`;this.popup.style.width=t?`${e.reference.width}px`:``,this.popup.style.height=n?`${e.reference.height}px`:``}})):(this.popup.style.width=``,this.popup.style.height=``),this.flip&&e.push(na({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy===`best-fit`?`bestFit`:`initialPlacement`,padding:this.flipPadding})),this.shift&&e.push(ta({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(ra({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{this.autoSize===`vertical`||this.autoSize===`both`?this.style.setProperty(`--auto-size-available-height`,`${t}px`):this.style.removeProperty(`--auto-size-available-height`),this.autoSize===`horizontal`||this.autoSize===`both`?this.style.setProperty(`--auto-size-available-width`,`${e}px`):this.style.removeProperty(`--auto-size-available-width`)}})):(this.style.removeProperty(`--auto-size-available-width`),this.style.removeProperty(`--auto-size-available-height`)),this.arrow&&e.push(ia({element:this.arrowEl,padding:this.arrowPadding}));let t=this.strategy===`absolute`?e=>Xi.getOffsetParent(e,oa):Xi.getOffsetParent;aa(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:wn(Cn({},Xi),{getOffsetParent:t})}).then(({x:e,y:t,middlewareData:n,placement:r})=>{let i=this.localize.dir()===`rtl`,a={top:`bottom`,right:`left`,bottom:`top`,left:`right`}[r.split(`-`)[0]];if(this.setAttribute(`data-current-placement`,r),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){let e=n.arrow.x,t=n.arrow.y,r=``,o=``,s=``,c=``;if(this.arrowPlacement===`start`){let n=typeof e==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``;r=typeof t==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``,o=i?n:``,c=i?``:n}else if(this.arrowPlacement===`end`){let n=typeof e==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``;o=i?``:n,c=i?n:``,s=typeof t==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``}else this.arrowPlacement===`center`?(c=typeof e==`number`?`calc(50% - var(--arrow-size-diagonal))`:``,r=typeof t==`number`?`calc(50% - var(--arrow-size-diagonal))`:``):(c=typeof e==`number`?`${e}px`:``,r=typeof t==`number`?`${t}px`:``);Object.assign(this.arrowEl.style,{top:r,right:o,bottom:s,left:c,[a]:`calc(var(--arrow-size-diagonal) * -1)`})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit(`sl-reposition`)}render(){return C`
    ...
    `}};R.styles=[O,mr],E([M(`.popup`)],R.prototype,`popup`,2),E([M(`.popup__arrow`)],R.prototype,`arrowEl`,2),E([A()],R.prototype,`anchor`,2),E([A({type:Boolean,reflect:!0})],R.prototype,`active`,2),E([A({reflect:!0})],R.prototype,`placement`,2),E([A({reflect:!0})],R.prototype,`strategy`,2),E([A({type:Number})],R.prototype,`distance`,2),E([A({type:Number})],R.prototype,`skidding`,2),E([A({type:Boolean})],R.prototype,`arrow`,2),E([A({attribute:`arrow-placement`})],R.prototype,`arrowPlacement`,2),E([A({attribute:`arrow-padding`,type:Number})],R.prototype,`arrowPadding`,2),E([A({type:Boolean})],R.prototype,`flip`,2),E([A({attribute:`flip-fallback-placements`,converter:{fromAttribute:e=>e.split(` `).map(e=>e.trim()).filter(e=>e!==``),toAttribute:e=>e.join(` `)}})],R.prototype,`flipFallbackPlacements`,2),E([A({attribute:`flip-fallback-strategy`})],R.prototype,`flipFallbackStrategy`,2),E([A({type:Object})],R.prototype,`flipBoundary`,2),E([A({attribute:`flip-padding`,type:Number})],R.prototype,`flipPadding`,2),E([A({type:Boolean})],R.prototype,`shift`,2),E([A({type:Object})],R.prototype,`shiftBoundary`,2),E([A({attribute:`shift-padding`,type:Number})],R.prototype,`shiftPadding`,2),E([A({attribute:`auto-size`})],R.prototype,`autoSize`,2),E([A()],R.prototype,`sync`,2),E([A({type:Object})],R.prototype,`autoSizeBoundary`,2),E([A({attribute:`auto-size-padding`,type:Number})],R.prototype,`autoSizePadding`,2),E([A({attribute:`hover-bridge`,type:Boolean})],R.prototype,`hoverBridge`,2);var ua=new Map,da=new WeakMap;function fa(e){return e??{keyframes:[],options:{duration:0}}}function pa(e,t){return t.toLowerCase()===`rtl`?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function z(e,t){ua.set(e,fa(t))}function B(e,t,n){let r=da.get(e);if(r?.[t])return pa(r[t],n.dir);let i=ua.get(t);return i?pa(i,n.dir):{keyframes:[],options:{duration:0}}}function ma(e,t){return new Promise(n=>{function r(i){i.target===e&&(e.removeEventListener(t,r),n())}e.addEventListener(t,r)})}function V(e,t,n){return new Promise(r=>{if(n?.duration===1/0)throw Error(`Promise-based animations must be finite.`);let i=e.animate(t,wn(Cn({},n),{duration:ga()?0:n.duration}));i.addEventListener(`cancel`,r,{once:!0}),i.addEventListener(`finish`,r,{once:!0})})}function ha(e){return e=e.toString().toLowerCase(),e.indexOf(`ms`)>-1?parseFloat(e):e.indexOf(`s`)>-1?parseFloat(e)*1e3:parseFloat(e)}function ga(){return window.matchMedia(`(prefers-reduced-motion: reduce)`).matches}function H(e){return Promise.all(e.getAnimations().map(e=>new Promise(t=>{e.cancel(),requestAnimationFrame(t)})))}function _a(e,t){return e.map(e=>wn(Cn({},e),{height:e.height===`auto`?`${t}px`:e.height}))}var U=class extends N{constructor(){super(),this.localize=new L(this),this.content=``,this.placement=`top`,this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger=`hover focus`,this.hoist=!1,this.handleBlur=()=>{this.hasTrigger(`focus`)&&this.hide()},this.handleClick=()=>{this.hasTrigger(`click`)&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger(`focus`)&&this.show()},this.handleDocumentKeyDown=e=>{e.key===`Escape`&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger(`hover`)){let e=ha(getComputedStyle(this).getPropertyValue(`--show-delay`));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger(`hover`)){let e=ha(getComputedStyle(this).getPropertyValue(`--hide-delay`));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener(`blur`,this.handleBlur,!0),this.addEventListener(`focus`,this.handleFocus,!0),this.addEventListener(`click`,this.handleClick),this.addEventListener(`mouseover`,this.handleMouseOver),this.addEventListener(`mouseout`,this.handleMouseOut)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(` `).includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit(`sl-show`),`CloseWatcher`in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener(`keydown`,this.handleDocumentKeyDown),await H(this.body),this.body.hidden=!1,this.popup.active=!0;let{keyframes:t,options:n}=B(this,`tooltip.show`,{dir:this.localize.dir()});await V(this.popup.popup,t,n),this.popup.reposition(),this.emit(`sl-after-show`)}else{this.emit(`sl-hide`),(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown),await H(this.body);let{keyframes:e,options:n}=B(this,`tooltip.hide`,{dir:this.localize.dir()});await V(this.popup.popup,e,n),this.popup.active=!1,this.body.hidden=!0,this.emit(`sl-after-hide`)}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,ma(this,`sl-after-show`)}async hide(){if(this.open)return this.open=!1,ma(this,`sl-after-hide`)}render(){return C`
      <sl-popup
        part="base"
        exportparts="
          popup:base__popup,
    ...
    `}};U.styles=[O,pr],U.dependencies={"sl-popup":R},E([M(`slot:not([name])`)],U.prototype,`defaultSlot`,2),E([M(`.tooltip__body`)],U.prototype,`body`,2),E([M(`sl-popup`)],U.prototype,`popup`,2),E([A()],U.prototype,`content`,2),E([A()],U.prototype,`placement`,2),E([A({type:Boolean,reflect:!0})],U.prototype,`disabled`,2),E([A({type:Number})],U.prototype,`distance`,2),E([A({type:Boolean,reflect:!0})],U.prototype,`open`,2),E([A({type:Number})],U.prototype,`skidding`,2),E([A()],U.prototype,`trigger`,2),E([A({type:Boolean})],U.prototype,`hoist`,2),E([D(`open`,{waitUntilFirstUpdate:!0})],U.prototype,`handleOpenChange`,1),E([D([`content`,`distance`,`hoist`,`placement`,`skidding`])],U.prototype,`handleOptionsChange`,1),E([D(`disabled`)],U.prototype,`handleDisabledChange`,1),z(`tooltip.show`,{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:`ease`}}),z(`tooltip.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:`ease`}}),U.define(`sl-tooltip`),Gn.define(`sl-icon`);var va=S`
  :host {
    --divider-width: 4px;
...
`;function ya(e,t){function n(n){let r=e.getBoundingClientRect(),i=e.ownerDocument.defaultView,a=r.left+i.scrollX,o=r.top+i.scrollY,s=n.pageX-a,c=n.pageY-o;t?.onMove&&t.onMove(s,c)}function r(){document.removeEventListener(`pointermove`,n),document.removeEventListener(`pointerup`,r),t?.onStop&&t.onStop()}document.addEventListener(`pointermove`,n,{passive:!0}),document.addEventListener(`pointerup`,r),t?.initialEvent instanceof PointerEvent&&n(t.initialEvent)}function ba(e,t,n){return(e=>Object.is(e,-0)?0:e)(e<t?t:e>n?n:e)}var xa=()=>null,Sa=class extends N{constructor(){super(...arguments),this.isCollapsed=!1,this.localize=new L(this),this.positionBeforeCollapsing=0,this.position=50,this.vertical=!1,this.disabled=!1,this.snapValue=``,this.snapFunction=xa,this.snapThreshold=12}toSnapFunction(e){let t=e.split(` `);return({pos:n,size:r,snapThreshold:i,isRtl:a,vertical:o})=>{let s=n,c=1/0;return t.forEach(t=>{let l;if(t.startsWith(`repeat(`)){let t=e.substring(7,e.length-1),i=t.endsWith(`%`),s=Number.parseFloat(t),c=i?s/100*r:s;l=Math.round((a&&!o?r-n:n)/c)*c}else l=t.endsWith(`%`)?Number.parseFloat(t)/100*r:Number.parseFloat(t);a&&!o&&(l=r-l);let u=Math.abs(n-l);u<=i&&u<c&&(s=l,c=u)}),s}}set snap(e){this.snapValue=e??``,e?this.snapFunction=typeof e==`string`?this.toSnapFunction(e):e:this.snapFunction=xa}get snap(){return this.snapValue}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.updateComplete.then(()=>this.resizeObserver.observe(this)),this.detectSize(),this.cachedPositionInPixels=this.percentageToPixels(this.position)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.resizeObserver)==null||e.unobserve(this)}detectSize(){let{width:e,height:t}=this.getBoundingClientRect();this.size=this.vertical?t:e}percentageToPixels(e){return this.size*(e/100)}pixelsToPercentage(e){return e/this.size*100}handleDrag(e){let t=this.localize.dir()===`rtl`;this.disabled||(e.cancelable&&e.preventDefault(),ya(this,{onMove:(e,n)=>{let r=this.vertical?n:e;this.primary===`end`&&(r=this.size-r),r=this.snapFunction({pos:r,size:this.size,snapThreshold:this.snapThreshold,isRtl:t,vertical:this.vertical})??r,this.position=ba(this.pixelsToPercentage(r),0,100)},initialEvent:e}))}handleKeyDown(e){if(!this.disabled&&[`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`,`Enter`].includes(e.key)){let t=this.position,n=(e.shiftKey?10:1)*(this.primary===`end`?-1:1);if(e.preventDefault(),(e.key===`ArrowLeft`&&!this.vertical||e.key===`ArrowUp`&&this.vertical)&&(t-=n),(e.key===`ArrowRight`&&!this.vertical||e.key===`ArrowDown`&&this.vertical)&&(t+=n),e.key===`Home`&&(t=this.primary===`end`?100:0),e.key===`End`&&(t=this.primary===`end`?0:100),e.key===`Enter`)if(this.isCollapsed)t=this.positionBeforeCollapsing,this.isCollapsed=!1;else{let e=this.position;t=0,requestAnimationFrame(()=>{this.isCollapsed=!0,this.positionBeforeCollapsing=e})}this.position=ba(t,0,100)}}handleResize(e){let{width:t,height:n}=e[0].contentRect;this.size=this.vertical?n:t,(isNaN(this.cachedPositionInPixels)||this.position===1/0)&&(this.cachedPositionInPixels=Number(this.getAttribute(`position-in-pixels`)),this.positionInPixels=Number(this.getAttribute(`position-in-pixels`)),this.position=this.pixelsToPercentage(this.positionInPixels)),this.primary&&(this.position=this.pixelsToPercentage(this.cachedPositionInPixels))}handlePositionChange(){this.cachedPositionInPixels=this.percentageToPixels(this.position),this.isCollapsed=!1,this.positionBeforeCollapsing=0,this.positionInPixels=this.percentageToPixels(this.position),this.emit(`sl-reposition`)}handlePositionInPixelsChange(){this.position=this.pixelsToPercentage(this.positionInPixels)}handleVerticalChange(){this.detectSize()}render(){let e=this.vertical?`gridTemplateRows`:`gridTemplateColumns`,t=this.vertical?`gridTemplateColumns`:`gridTemplateRows`,n=this.localize.dir()===`rtl`,r=`
    ...
    `,i=`auto`;return this.primary===`end`?n&&!this.vertical?this.style[e]=`${r} var(--divider-width) ${i}`:this.style[e]=`${i} var(--divider-width) ${r}`:n&&!this.vertical?this.style[e]=`${i} var(--divider-width) ${r}`:this.style[e]=`${r} var(--divider-width) ${i}`,this.style[t]=``,C`
    ...
    `}};Sa.styles=[O,va],E([M(`.divider`)],Sa.prototype,`divider`,2),E([A({type:Number,reflect:!0})],Sa.prototype,`position`,2),E([A({attribute:`position-in-pixels`,type:Number})],Sa.prototype,`positionInPixels`,2),E([A({type:Boolean,reflect:!0})],Sa.prototype,`vertical`,2),E([A({type:Boolean,reflect:!0})],Sa.prototype,`disabled`,2),E([A()],Sa.prototype,`primary`,2),E([A({reflect:!0})],Sa.prototype,`snap`,1),E([A({type:Number,attribute:`snap-threshold`})],Sa.prototype,`snapThreshold`,2),E([D(`position`)],Sa.prototype,`handlePositionChange`,1),E([D(`positionInPixels`)],Sa.prototype,`handlePositionInPixelsChange`,1),E([D(`vertical`)],Sa.prototype,`handleVerticalChange`,1),Sa.define(`sl-split-panel`);var Ca=S`
  :host {
    --size: 25rem;
...
`;function*wa(e=document.activeElement){e!=null&&(yield e,`shadowRoot`in e&&e.shadowRoot&&e.shadowRoot.mode!==`closed`&&(yield*An(wa(e.shadowRoot.activeElement))))}function Ta(){return[...wa()].pop()}var Ea=new WeakMap;function Da(e){let t=Ea.get(e);return t||(t=window.getComputedStyle(e,null),Ea.set(e,t)),t}function Oa(e){if(typeof e.checkVisibility==`function`)return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});let t=Da(e);return t.visibility!==`hidden`&&t.display!==`none`}function ka(e){let{overflowY:t,overflowX:n}=Da(e);return t===`scroll`||n===`scroll`?!0:t!==`auto`||n!==`auto`?!1:e.scrollHeight>e.clientHeight&&t===`auto`||e.scrollWidth>e.clientWidth&&n===`auto`}function Aa(e){let t=e.tagName.toLowerCase(),n=Number(e.getAttribute(`tabindex`));if(e.hasAttribute(`tabindex`)&&(isNaN(n)||n<=-1)||e.hasAttribute(`disabled`)||e.closest(`[inert]`))return!1;if(t===`input`&&e.getAttribute(`type`)===`radio`){let t=e.getRootNode(),n=`input[type='radio'][name="${e.getAttribute(`name`)}"]`,r=t.querySelector(`${n}:checked`);return r?r===e:t.querySelector(n)===e}return Oa(e)?(t===`audio`||t===`video`)&&e.hasAttribute(`controls`)||e.hasAttribute(`tabindex`)||e.hasAttribute(`contenteditable`)&&e.getAttribute(`contenteditable`)!==`false`||[`button`,`input`,`select`,`textarea`,`a`,`audio`,`video`,`summary`,`iframe`].includes(t)?!0:ka(e):!1}function ja(e){let t=Na(e);return{start:t[0]??null,end:t[t.length-1]??null}}function Ma(e,t){return e.getRootNode({composed:!0})?.host!==t}function Na(e){let t=new WeakMap,n=[];function r(i){if(i instanceof Element){if(i.hasAttribute(`inert`)||i.closest(`[inert]`)||t.has(i))return;t.set(i,!0),!n.includes(i)&&Aa(i)&&n.push(i),i instanceof HTMLSlotElement&&Ma(i,e)&&i.assignedElements({flatten:!0}).forEach(e=>{r(e)}),i.shadowRoot!==null&&i.shadowRoot.mode===`open`&&r(i.shadowRoot)}for(let e of i.children)r(e)}return r(e),n.sort((e,t)=>{let n=Number(e.getAttribute(`tabindex`))||0;return(Number(t.getAttribute(`tabindex`))||0)-n})}var Pa=[],Fa=class{constructor(e){this.tabDirection=`forward`,this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=e=>{var t;if(e.key!==`Tab`||this.isExternalActivated||!this.isActive())return;let n=Ta();if(this.previousFocus=n,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;e.shiftKey?this.tabDirection=`backward`:this.tabDirection=`forward`;let r=Na(this.element),i=r.findIndex(e=>e===n);this.previousFocus=this.currentFocus;let a=this.tabDirection===`forward`?1:-1;for(;;){i+a>=r.length?i=0:i+a<0?i=r.length-1:i+=a,this.previousFocus=this.currentFocus;let n=r[i];if(this.tabDirection===`backward`&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||n&&this.possiblyHasTabbableChildren(n))return;e.preventDefault(),this.currentFocus=n,(t=this.currentFocus)==null||t.focus({preventScroll:!1});let o=[...wa()];if(o.includes(this.currentFocus)||!o.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection=`forward`},this.element=e,this.elementsWithTabbableControls=[`iframe`]}activate(){Pa.push(this.element),document.addEventListener(`focusin`,this.handleFocusIn),document.addEventListener(`keydown`,this.handleKeyDown),document.addEventListener(`keyup`,this.handleKeyUp)}deactivate(){Pa=Pa.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener(`focusin`,this.handleFocusIn),document.removeEventListener(`keydown`,this.handleKeyDown),document.removeEventListener(`keyup`,this.handleKeyUp)}isActive(){return Pa[Pa.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){let e=Na(this.element);if(!this.element.matches(`:focus-within`)){let t=e[0],n=e[e.length-1],r=this.tabDirection===`forward`?t:n;typeof r?.focus==`function`&&(this.currentFocus=r,r.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute(`controls`)}};function Ia(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}var La=new Set;function Ra(){let e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}function za(){let e=Number(getComputedStyle(document.body).paddingRight.replace(/px/,``));return isNaN(e)||!e?0:e}function Ba(e){if(La.add(e),!document.documentElement.classList.contains(`sl-scroll-lock`)){let e=Ra()+za(),t=getComputedStyle(document.documentElement).scrollbarGutter;(!t||t===`auto`)&&(t=`stable`),e<2&&(t=``),document.documentElement.style.setProperty(`--sl-scroll-lock-gutter`,t),document.documentElement.classList.add(`sl-scroll-lock`),document.documentElement.style.setProperty(`--sl-scroll-lock-size`,`${e}px`)}}function Va(e){La.delete(e),La.size===0&&(document.documentElement.classList.remove(`sl-scroll-lock`),document.documentElement.style.removeProperty(`--sl-scroll-lock-size`))}function Ha(e,t,n=`vertical`,r=`smooth`){let i=Ia(e,t),a=i.top+t.scrollTop,o=i.left+t.scrollLeft,s=t.scrollLeft,c=t.scrollLeft+t.offsetWidth,l=t.scrollTop,u=t.scrollTop+t.offsetHeight;(n===`horizontal`||n===`both`)&&(o<s?t.scrollTo({left:o,behavior:r}):o+e.clientWidth>c&&t.scrollTo({left:o-t.offsetWidth+e.clientWidth,behavior:r})),(n===`vertical`||n===`both`)&&(a<l?t.scrollTo({top:a,behavior:r}):a+e.clientHeight>u&&t.scrollTo({top:a-t.offsetHeight+e.clientHeight,behavior:r}))}var Ua=e=>{var t;let{activeElement:n}=document;n&&e.contains(n)&&((t=document.activeElement)==null||t.blur())},Wa=class{constructor(e,...t){this.slotNames=[],this.handleSlotChange=e=>{let t=e.target;(this.slotNames.includes(`[default]`)&&!t.name||t.name&&this.slotNames.includes(t.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!==``)return!0;if(e.nodeType===e.ELEMENT_NODE){let t=e;if(t.tagName.toLowerCase()===`sl-visually-hidden`)return!1;if(!t.hasAttribute(`slot`))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e===`[default]`?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener(`slotchange`,this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener(`slotchange`,this.handleSlotChange)}};function Ga(e){if(!e)return``;let t=e.assignedNodes({flatten:!0}),n=``;return[...t].forEach(e=>{e.nodeType===Node.TEXT_NODE&&(n+=e.textContent)}),n}function Ka(e){return e.charAt(0).toUpperCase()+e.slice(1)}var qa=class extends N{constructor(){super(...arguments),this.hasSlotController=new Wa(this,`footer`),this.localize=new L(this),this.modal=new Fa(this),this.open=!1,this.label=``,this.placement=`end`,this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key===`Escape`&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose(`keyboard`))}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),Ba(this)))}disconnectedCallback(){super.disconnectedCallback(),Va(this),this.removeOpenListeners()}requestClose(e){if(this.emit(`sl-request-close`,{cancelable:!0,detail:{source:e}}).defaultPrevented){let e=B(this,`drawer.denyClose`,{dir:this.localize.dir()});V(this.panel,e.keyframes,e.options);return}this.hide()}addOpenListeners(){var e;`CloseWatcher`in window?((e=this.closeWatcher)==null||e.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose(`keyboard`))):document.addEventListener(`keydown`,this.handleDocumentKeyDown)}removeOpenListeners(){var e;document.removeEventListener(`keydown`,this.handleDocumentKeyDown),(e=this.closeWatcher)==null||e.destroy()}async handleOpenChange(){if(this.open){this.emit(`sl-show`),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),Ba(this));let e=this.querySelector(`[autofocus]`);e&&e.removeAttribute(`autofocus`),await Promise.all([H(this.drawer),H(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit(`sl-initial-focus`,{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute(`autofocus`,``)});let t=B(this,`drawer.show${Ka(this.placement)}`,{dir:this.localize.dir()}),n=B(this,`drawer.overlay.show`,{dir:this.localize.dir()});await Promise.all([V(this.panel,t.keyframes,t.options),V(this.overlay,n.keyframes,n.options)]),this.emit(`sl-after-show`)}else{Ua(this),this.emit(`sl-hide`),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),Va(this)),await Promise.all([H(this.drawer),H(this.overlay)]);let e=B(this,`drawer.hide${Ka(this.placement)}`,{dir:this.localize.dir()}),t=B(this,`drawer.overlay.hide`,{dir:this.localize.dir()});await Promise.all([V(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),V(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;let n=this.originalTrigger;typeof n?.focus==`function`&&setTimeout(()=>n.focus()),this.emit(`sl-after-hide`)}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),Ba(this)),this.open&&this.contained&&(this.modal.deactivate(),Va(this))}async show(){if(!this.open)return this.open=!0,ma(this,`sl-after-show`)}async hide(){if(this.open)return this.open=!1,ma(this,`sl-after-hide`)}render(){return C`
      <div
        part="base"
    ...
    `}};qa.styles=[O,Ca],qa.dependencies={"sl-icon-button":I},E([M(`.drawer`)],qa.prototype,`drawer`,2),E([M(`.drawer__panel`)],qa.prototype,`panel`,2),E([M(`.drawer__overlay`)],qa.prototype,`overlay`,2),E([A({type:Boolean,reflect:!0})],qa.prototype,`open`,2),E([A({reflect:!0})],qa.prototype,`label`,2),E([A({reflect:!0})],qa.prototype,`placement`,2),E([A({type:Boolean,reflect:!0})],qa.prototype,`contained`,2),E([A({attribute:`no-header`,type:Boolean,reflect:!0})],qa.prototype,`noHeader`,2),E([D(`open`,{waitUntilFirstUpdate:!0})],qa.prototype,`handleOpenChange`,1),E([D(`contained`,{waitUntilFirstUpdate:!0})],qa.prototype,`handleNoModalChange`,1),z(`drawer.showTop`,{keyframes:[{opacity:0,translate:`0 -100%`},{opacity:1,translate:`0 0`}],options:{duration:250,easing:`ease`}}),z(`drawer.hideTop`,{keyframes:[{opacity:1,translate:`0 0`},{opacity:0,translate:`0 -100%`}],options:{duration:250,easing:`ease`}}),z(`drawer.showEnd`,{keyframes:[{opacity:0,translate:`100%`},{opacity:1,translate:`0`}],rtlKeyframes:[{opacity:0,translate:`-100%`},{opacity:1,translate:`0`}],options:{duration:250,easing:`ease`}}),z(`drawer.hideEnd`,{keyframes:[{opacity:1,translate:`0`},{opacity:0,translate:`100%`}],rtlKeyframes:[{opacity:1,translate:`0`},{opacity:0,translate:`-100%`}],options:{duration:250,easing:`ease`}}),z(`drawer.showBottom`,{keyframes:[{opacity:0,translate:`0 100%`},{opacity:1,translate:`0 0`}],options:{duration:250,easing:`ease`}}),z(`drawer.hideBottom`,{keyframes:[{opacity:1,translate:`0 0`},{opacity:0,translate:`0 100%`}],options:{duration:250,easing:`ease`}}),z(`drawer.showStart`,{keyframes:[{opacity:0,translate:`-100%`},{opacity:1,translate:`0`}],rtlKeyframes:[{opacity:0,translate:`100%`},{opacity:1,translate:`0`}],options:{duration:250,easing:`ease`}}),z(`drawer.hideStart`,{keyframes:[{opacity:1,translate:`0`},{opacity:0,translate:`-100%`}],rtlKeyframes:[{opacity:1,translate:`0`},{opacity:0,translate:`100%`}],options:{duration:250,easing:`ease`}}),z(`drawer.denyClose`,{keyframes:[{scale:1},{scale:1.01},{scale:1}],options:{duration:250}}),z(`drawer.overlay.show`,{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}}),z(`drawer.overlay.hide`,{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}}),qa.define(`sl-drawer`);var Ja=S`
  :host {
    display: block;
  }
...
`,Za=class extends N{constructor(){super(...arguments),this.localize=new L(this),this.separatorDir=this.localize.dir(),this.label=``}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll(`[id]`)].forEach(e=>e.removeAttribute(`id`)),e.setAttribute(`data-default`,``),e.slot=`separator`,e}handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()===`sl-breadcrumb-item`);e.forEach((t,n)=>{let r=t.querySelector(`[slot="separator"]`);r===null?t.append(this.getSeparator()):r.hasAttribute(`data-default`)&&r.replaceWith(this.getSeparator()),n===e.length-1?t.setAttribute(`aria-current`,`page`):t.removeAttribute(`aria-current`)})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),C`
    ...
    `}};Za.styles=[O,Xa],Za.dependencies={"sl-icon":Gn},E([M(`slot`)],Za.prototype,`defaultSlot`,2),E([M(`slot[name="separator"]`)],Za.prototype,`separatorSlot`,2),E([A()],Za.prototype,`label`,2),Za.define(`sl-breadcrumb`);var Qa=S`
  :host {
    display: inline-flex;
  }
...
`,$a=class extends N{constructor(){super(...arguments),this.hasSlotController=new Wa(this,`prefix`,`suffix`),this.renderType=`button`,this.rel=`noreferrer noopener`}setRenderType(){let e=this.defaultSlot.assignedElements({flatten:!0}).filter(e=>e.tagName.toLowerCase()===`sl-dropdown`).length>0;if(this.href){this.renderType=`link`;return}if(e){this.renderType=`dropdown`;return}this.renderType=`button`}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return C`
    ...
    `}};$a.styles=[O,Qa],E([M(`slot:not([name])`)],$a.prototype,`defaultSlot`,2),E([j()],$a.prototype,`renderType`,2),E([A()],$a.prototype,`href`,2),E([A()],$a.prototype,`target`,2),E([A()],$a.prototype,`rel`,2),E([D(`href`,{waitUntilFirstUpdate:!0})],$a.prototype,`hrefChanged`,1),$a.define(`sl-breadcrumb-item`);var eo=S`
  :host {
    --track-width: 2px;
...
`,W=class extends N{constructor(){super(...arguments),this.formControlController=new so(this,{assumeInteractionOn:[`click`]}),this.hasSlotController=new Wa(this,`[default]`,`prefix`,`suffix`),this.localize=new L(this),this.hasFocus=!1,this.invalid=!1,this.title=``,this.variant=`default`,this.size=`medium`,this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type=`button`,this.name=``,this.value=``,this.href=``,this.rel=`noreferrer noopener`}get validity(){return this.isButton()?this.button.validity:co}get validationMessage(){return this.isButton()?this.button.validationMessage:``}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`sl-blur`)}handleFocus(){this.hasFocus=!0,this.emit(`sl-focus`)}handleClick(){this.type===`submit`&&this.formControlController.submit(this),this.type===`reset`&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){let e=this.isLink(),t=e?Qn`a`:Qn`button`;return er`
    ...
    `}};W.styles=[O,lo],W.dependencies={"sl-icon":Gn,"sl-spinner":to},E([M(`.button`)],W.prototype,`button`,2),E([j()],W.prototype,`hasFocus`,2),E([j()],W.prototype,`invalid`,2),E([A()],W.prototype,`title`,2),E([A({reflect:!0})],W.prototype,`variant`,2),E([A({reflect:!0})],W.prototype,`size`,2),E([A({type:Boolean,reflect:!0})],W.prototype,`caret`,2),E([A({type:Boolean,reflect:!0})],W.prototype,`disabled`,2),E([A({type:Boolean,reflect:!0})],W.prototype,`loading`,2),E([A({type:Boolean,reflect:!0})],W.prototype,`outline`,2),E([A({type:Boolean,reflect:!0})],W.prototype,`pill`,2),E([A({type:Boolean,reflect:!0})],W.prototype,`circle`,2),E([A()],W.prototype,`type`,2),E([A()],W.prototype,`name`,2),E([A()],W.prototype,`value`,2),E([A()],W.prototype,`href`,2),E([A()],W.prototype,`target`,2),E([A()],W.prototype,`rel`,2),E([A()],W.prototype,`download`,2),E([A()],W.prototype,`form`,2),E([A({attribute:`formaction`})],W.prototype,`formAction`,2),E([A({attribute:`formenctype`})],W.prototype,`formEnctype`,2),E([A({attribute:`formmethod`})],W.prototype,`formMethod`,2),E([A({attribute:`formnovalidate`,type:Boolean})],W.prototype,`formNoValidate`,2),E([A({attribute:`formtarget`})],W.prototype,`formTarget`,2),E([D(`disabled`,{waitUntilFirstUpdate:!0})],W.prototype,`handleDisabledChange`,1),W.define(`sl-button`);var uo=S`
  :host {
    --width: 31rem;
    --header-spacing: var(--sl-spacing-large);
    --body-spacing: var(--sl-spacing-large);
...
`,fo=class extends N{constructor(){super(...arguments),this.hasSlotController=new Wa(this,`footer`),this.localize=new L(this),this.modal=new Fa(this),this.open=!1,this.label=``,this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key===`Escape`&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose(`keyboard`))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),Ba(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Va(this),this.removeOpenListeners()}requestClose(e){if(this.emit(`sl-request-close`,{cancelable:!0,detail:{source:e}}).defaultPrevented){let e=B(this,`dialog.denyClose`,{dir:this.localize.dir()});V(this.panel,e.keyframes,e.options);return}this.hide()}addOpenListeners(){var e;`CloseWatcher`in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose(`keyboard`)):document.addEventListener(`keydown`,this.handleDocumentKeyDown)}removeOpenListeners(){var e;(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit(`sl-show`),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),Ba(this);let e=this.querySelector(`[autofocus]`);e&&e.removeAttribute(`autofocus`),await Promise.all([H(this.dialog),H(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit(`sl-initial-focus`,{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute(`autofocus`,``)});let t=B(this,`dialog.show`,{dir:this.localize.dir()}),n=B(this,`dialog.overlay.show`,{dir:this.localize.dir()});await Promise.all([V(this.panel,t.keyframes,t.options),V(this.overlay,n.keyframes,n.options)]),this.emit(`sl-after-show`)}else{Ua(this),this.emit(`sl-hide`),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([H(this.dialog),H(this.overlay)]);let e=B(this,`dialog.hide`,{dir:this.localize.dir()}),t=B(this,`dialog.overlay.hide`,{dir:this.localize.dir()});await Promise.all([V(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),V(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Va(this);let n=this.originalTrigger;typeof n?.focus==`function`&&setTimeout(()=>n.focus()),this.emit(`sl-after-hide`)}}async show(){if(!this.open)return this.open=!0,ma(this,`sl-after-show`)}async hide(){if(this.open)return this.open=!1,ma(this,`sl-after-hide`)}render(){return C`
    ...
    `}};fo.styles=[O,uo],fo.dependencies={"sl-icon-button":I},E([M(`.dialog`)],fo.prototype,`dialog`,2),E([M(`.dialog__panel`)],fo.prototype,`panel`,2),E([M(`.dialog__overlay`)],fo.prototype,`overlay`,2),E([A({type:Boolean,reflect:!0})],fo.prototype,`open`,2),E([A({reflect:!0})],fo.prototype,`label`,2),E([A({attribute:`no-header`,type:Boolean,reflect:!0})],fo.prototype,`noHeader`,2),E([D(`open`,{waitUntilFirstUpdate:!0})],fo.prototype,`handleOpenChange`,1),z(`dialog.show`,{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:`ease`}}),z(`dialog.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:`ease`}}),z(`dialog.denyClose`,{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}}),z(`dialog.overlay.show`,{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}}),z(`dialog.overlay.hide`,{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}}),fo.define(`sl-dialog`);var po=S`
  :host {
    display: contents;
...
`,mo=class e extends N{constructor(){super(...arguments),this.hasSlotController=new Wa(this,`icon`,`suffix`),this.localize=new L(this),this.open=!1,this.closable=!1,this.variant=`primary`,this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||=Object.assign(document.createElement(`div`),{className:`sl-toast-stack`}),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var e;(e=this.countdownAnimation)==null||e.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var e;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(e=this.countdownAnimation)==null||e.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){let{countdownElement:e}=this;this.countdownAnimation=e.animate([{width:`100%`},{width:`0`}],{duration:this.duration,easing:`linear`})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit(`sl-show`),this.duration<1/0&&this.restartAutoHide(),await H(this.base),this.base.hidden=!1;let{keyframes:e,options:t}=B(this,`alert.show`,{dir:this.localize.dir()});await V(this.base,e,t),this.emit(`sl-after-show`)}else{Ua(this),this.emit(`sl-hide`),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await H(this.base);let{keyframes:e,options:t}=B(this,`alert.hide`,{dir:this.localize.dir()});await V(this.base,e,t),this.base.hidden=!0,this.emit(`sl-after-hide`)}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,ma(this,`sl-after-show`)}async hide(){if(this.open)return this.open=!1,ma(this,`sl-after-hide`)}async toast(){return new Promise(t=>{this.handleCountdownChange(),e.toastStack.parentElement===null&&document.body.append(e.toastStack),e.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener(`sl-after-hide`,()=>{e.toastStack.removeChild(this),t(),e.toastStack.querySelector(`sl-alert`)===null&&e.toastStack.remove()},{once:!0})})}render(){return C`
    ...
    `}};mo.styles=[O,po],mo.dependencies={"sl-icon-button":I},E([M(`[part~="base"]`)],mo.prototype,`base`,2),E([M(`.alert__countdown-elapsed`)],mo.prototype,`countdownElement`,2),E([A({type:Boolean,reflect:!0})],mo.prototype,`open`,2),E([A({type:Boolean,reflect:!0})],mo.prototype,`closable`,2),E([A({reflect:!0})],mo.prototype,`variant`,2),E([A({type:Number})],mo.prototype,`duration`,2),E([A({type:String,reflect:!0})],mo.prototype,`countdown`,2),E([j()],mo.prototype,`remainingTime`,2),E([D(`open`,{waitUntilFirstUpdate:!0})],mo.prototype,`handleOpenChange`,1),E([D(`duration`)],mo.prototype,`handleDurationChange`,1);var ho=mo;z(`alert.show`,{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:`ease`}}),z(`alert.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:`ease`}}),ho.define(`sl-alert`);var go=S`
  :host {
    display: inline-flex;
  }
...
`,_o=class extends N{constructor(){super(...arguments),this.variant=`primary`,this.pill=!1,this.pulse=!1}render(){return C`
      <span
        part="base"
    ...
    `}};_o.styles=[O,go],E([A({reflect:!0})],_o.prototype,`variant`,2),E([A({type:Boolean,reflect:!0})],_o.prototype,`pill`,2),E([A({type:Boolean,reflect:!0})],_o.prototype,`pulse`,2),_o.define(`sl-badge`);var vo=class extends N{constructor(){super(...arguments),this.localize=new L(this),this.value=0,this.type=`decimal`,this.noGrouping=!1,this.currency=`USD`,this.currencyDisplay=`symbol`}render(){return isNaN(this.value)?``:this.localize.number(this.value,{style:this.type,currency:this.currency,currencyDisplay:this.currencyDisplay,useGrouping:!this.noGrouping,minimumIntegerDigits:this.minimumIntegerDigits,minimumFractionDigits:this.minimumFractionDigits,maximumFractionDigits:this.maximumFractionDigits,minimumSignificantDigits:this.minimumSignificantDigits,maximumSignificantDigits:this.maximumSignificantDigits})}};E([A({type:Number})],vo.prototype,`value`,2),E([A()],vo.prototype,`type`,2),E([A({attribute:`no-grouping`,type:Boolean})],vo.prototype,`noGrouping`,2),E([A()],vo.prototype,`currency`,2),E([A({attribute:`currency-display`})],vo.prototype,`currencyDisplay`,2),E([A({attribute:`minimum-integer-digits`,type:Number})],vo.prototype,`minimumIntegerDigits`,2),E([A({attribute:`minimum-fraction-digits`,type:Number})],vo.prototype,`minimumFractionDigits`,2),E([A({attribute:`maximum-fraction-digits`,type:Number})],vo.prototype,`maximumFractionDigits`,2),E([A({attribute:`minimum-significant-digits`,type:Number})],vo.prototype,`minimumSignificantDigits`,2),E([A({attribute:`maximum-significant-digits`,type:Number})],vo.prototype,`maximumSignificantDigits`,2),vo.define(`sl-format-number`);function yo(e){switch(e.toLowerCase()){case`get`:return`success`;case`post`:return`primary`;case`put`:return`primary`;case`delete`:return`danger`;case`patch`:return`warning`;case`query`:return`primary`;default:return`neutral`}}var bo=S`
    :host {
...
`,xo=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},So={GET:`GET`,POST:`POST`,PUT:`PUT`,DELETE:`DEL`,PATCH:`PAT`,OPTIONS:`OPT`,HEAD:`HEAD`,TRACE:`TRC`,QUERY:`QRY`},Co=class extends T{constructor(){super(),this.mode=``,this.lower=!1,this.method=`GET`}render(){if(this.mode===`nav-naked`){let e=this.method.toUpperCase(),t=So[e]??e;return C`<span class="method-naked ${this.method.toLowerCase()}">${t}</span>`}let e=`medium`;this.large&&(e=`large`),this.tiny&&(e=`small`),this.micro&&(e=`small`);let t=this.method.toLowerCase(),n=this.micro?`method ${e} micro ${t}`:`method ${e} ${t}`;return C`
            <sl-tag variant="${yo(this.method)}" class="${n}"
                    size="${e}">
                ${this.lower?this.method.toLowerCase():this.method.toUpperCase()}</sl-tag>
        `}};Co.styles=bo,xo([A()],Co.prototype,`method`,void 0),xo([A({type:Boolean})],Co.prototype,`lower`,void 0),xo([A({type:Boolean})],Co.prototype,`large`,void 0),xo([A({type:Boolean})],Co.prototype,`tiny`,void 0),xo([A({type:Boolean})],Co.prototype,`micro`,void 0),xo([A({reflect:!0})],Co.prototype,`mode`,void 0),Co=xo([k(`pb33f-http-method`)],Co);var wo=class extends Jn{constructor(e){if(super(e),this.it=w,e.type!==Kn.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===w||e==null)return this._t=void 0,this.it=e;if(e===Mt)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};wo.directiveName=`unsafeHTML`,wo.resultType=1;var To=qn(wo),Eo=S`
    :host {
...
`,Do=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Oo=class extends T{constructor(){super(),this.path=`/`,this.nowrap=!1}replaceBrackets(){let e=/\{([\w$.#/]+)\}/g,t=this.nowrap?` nowrap`:``,n=this.formatSlashes(this.path).replace(e,(e,n)=>`<span class="bracket${t}">{</span><span class="param${t}">${n}</span><span class="bracket${t}">}</span>`);return this.nowrap?C`<div style="white-space: nowrap;">${To(n)}</div>`:C`${To(n)}`}formatSlashes(e){return e.replaceAll(`/`,`<span class="slash">/</span>`)}render(){return C`${this.replaceBrackets()}`}};Oo.styles=Eo,Do([A()],Oo.prototype,`path`,void 0),Do([A({type:Boolean})],Oo.prototype,`nowrap`,void 0),Oo=Do([k(`pb33f-render-operation-path`)],Oo);var ko=S`
    ...
    @keyframes cursor {
        ...
        to {
    ...
    }`,Ao=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},jo=class extends T{constructor(){super(),this.name=`pb33f`,this.url=`https://pb33f.io`,this.wide=!1,this.fluid=!1}render(){return C`
            ...
            </header>`}};jo.styles=ko,Ao([A()],jo.prototype,`name`,void 0),Ao([A()],jo.prototype,`url`,void 0),Ao([A({type:Boolean})],jo.prototype,`wide`,void 0),Ao([A({type:Boolean})],jo.prototype,`fluid`,void 0),jo=Ao([k(`pb33f-header`)],jo);var Mo=S`
...
`,No=S`
 ...
 `,Po=`pb33f-theme-change`,Fo=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Io=`tektronix`,Lo=`pb33f-theme`,Ro=`pb33f-base-theme`,zo=class extends T{constructor(){super(...arguments),this.baseTheme=`dark`,this.tektronixActive=!1}get activeTheme(){return this.tektronixActive?Io:this.baseTheme}connectedCallback(){super.connectedCallback();let e=localStorage.getItem(Lo);e===`tektronix`?(this.tektronixActive=!0,this.baseTheme=localStorage.getItem(Ro)===`light`?`light`:`dark`):(this.tektronixActive=!1,this.baseTheme=e===`light`?`light`:`dark`),this.applyTheme()}applyTheme(){let e=this.activeTheme;localStorage.setItem(Lo,e),localStorage.setItem(Ro,this.baseTheme);let t=document.querySelector(`html`);t&&(t.setAttribute(`theme`,e),e===`light`?t.classList.remove(`sl-theme-dark`):t.classList.add(`sl-theme-dark`))}dispatchThemeChange(){window.dispatchEvent(new CustomEvent(Po,{detail:{theme:this.activeTheme}}))}toggleTheme(){this.baseTheme=this.baseTheme===`dark`?`light`:`dark`,this.tektronixActive&&=!1,this.applyTheme(),this.dispatchThemeChange()}toggleTektronix(){this.tektronixActive=!this.tektronixActive,this.applyTheme(),this.dispatchThemeChange()}render(){let e=this.baseTheme===`dark`?`sun`:`moon`,t=this.baseTheme===`dark`?`Switch to Roger Mode (light)`:`Switch to PB33F Mode (dark)`,n=this.tektronixActive?`Disable Tektronix 4010 Mode`:`Enable Tektronix 4010 Mode`;return C`
        ...
        `}};zo.styles=[Mo,No],Fo([j()],zo.prototype,`baseTheme`,void 0),Fo([j()],zo.prototype,`tektronixActive`,void 0),zo=Fo([k(`pb33f-theme-switcher`)],zo);var Bo=S`
...
`,Xo=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Zo;(function(e){e.Context=`context`,e.Info=`info`,e.Success=`success`,e.Question=`question`,e.Warning=`warning`,e.Error=`error`,e.Danger=`danger`})(Zo||={});var Qo=class extends T{constructor(){super(),this.type=Zo.Context,this.closeable=!1}hide(){this.alert.hide()}show(){this.alert.show()}getIcon(){switch(this.type){case Zo.Context:return`braces-asterisk`;case Zo.Info:return`info-square`;case Zo.Warning:return`exclamation-triangle`;case Zo.Error:return`exclamation-square`;case Zo.Danger:return`exclamation-square`;case Zo.Success:return`check-square`;case Zo.Question:return`question-square`}}render(){this.type||=Zo.Context,this.type===Zo.Danger&&(this.type=Zo.Error);let e=C``;this.headerText?.length>0&&(e=C`<strong>${this.headerText}</strong>`);let t=C`
            <sl-alert class="${this.type}" open>
                    <sl-icon slot="icon" name="${this.getIcon()}" class="${this.headerText?``:`noheader`}"></sl-icon>
                    ${e}
                    <slot></slot>
                </sl-alert>`;return this.closeable&&(t=C`
        ...
        `}};Qo.styles=[Yo,Jo],Xo([A()],Qo.prototype,`type`,void 0),Xo([A()],Qo.prototype,`headerText`,void 0),Xo([A({type:Boolean})],Qo.prototype,`closeable`,void 0),Xo([M(`sl-alert`)],Qo.prototype,`alert`,void 0),Qo=Xo([k(`pb33f-attention-box`)],Qo);var $o=S`
...
`,es=`paginatorFirstPage`,ts=`paginatorLastPage`,ns=`paginatorNextPage`,rs=`paginatorPreviousPage`,is=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},as=class extends T{get hide(){return this.totalItems<=this.itemsPerPage}constructor(){super(),this.currentPage=1,this.totalPages=0,this.totalItems=0,this.itemsPerPage=20,this.label=`Problems`}getRangeStart(){let e=this.currentPage*this.itemsPerPage-this.itemsPerPage;return e==0?0:e>0?e:0}getPagesRemaining(){let e=this.totalItems-this.currentPage*this.itemsPerPage;return e>0?e:0}getRangeEnd(){let e=this.getRangeStart();e==1&&(e=0);let t=e+this.itemsPerPage;return t>this.totalItems?this.totalItems:t>=0?t:0}nextPage(){this.currentPage<this.totalPages&&this.dispatchEvent(new CustomEvent(ns,{composed:!0}))}previousPage(){this.currentPage>1&&this.dispatchEvent(new CustomEvent(rs,{composed:!0}))}lastPage(){this.currentPage<this.totalPages&&this.dispatchEvent(new CustomEvent(ts,{composed:!0}))}firstPage(){this.currentPage>1&&this.dispatchEvent(new CustomEvent(es,{composed:!0}))}togglePrev(e){this.homeButton&&(this.prevButton.disabled=e,this.homeButton.disabled=e)}toggleNext(e){this.endButton&&(this.nextButton.disabled=e,this.endButton.disabled=e)}updated(){this.togglePrev(this.currentPage===1),this.toggleNext(this.currentPage===this.totalPages)}render(){return this.totalItems==0?C``:C`
        ...
        `}};as.styles=[$o],is([j()],as.prototype,`currentPage`,void 0),is([j()],as.prototype,`totalPages`,void 0),is([j()],as.prototype,`totalItems`,void 0),is([j()],as.prototype,`itemsPerPage`,void 0),is([M(`.home`)],as.prototype,`homeButton`,void 0),is([M(`.previous`)],as.prototype,`prevButton`,void 0),is([M(`.next`)],as.prototype,`nextButton`,void 0),is([M(`.end`)],as.prototype,`endButton`,void 0),is([A()],as.prototype,`label`,void 0),as=is([k(`pb33f-paginator`)],as);var os=S`
...
`,ss={size:15,family:`BerkeleyMono-Regular, Roboto Mono, Monaco, Menlo, Helvetica Neue,Helvetica,Verdana,Tahoma, Arial`,lineHeight:2,weight:`normal`,style:`normal`},cs={size:10,family:`BerkeleyMono-Regular, Roboto Mono, Monaco, Menlo, Helvetica Neue,Helvetica,Verdana,Tahoma, Arial`,lineHeight:2,weight:`normal`,style:`normal`},ls={size:12,family:`BerkeleyMono-Regular, Roboto Mono, Monaco, Menlo, Helvetica Neue,Helvetica,Verdana,Tahoma, Arial`,lineHeight:2,weight:`normal`,style:`normal`},us={size:15,family:`BerkeleyMono-Bold, Roboto Mono, Monaco, Menlo, Helvetica Neue,Helvetica,Verdana,Tahoma, Arial`,lineHeight:2,weight:`bold`,style:`normal`},ds={size:25,family:`BerkeleyMono-Bold, Roboto Mono, Monaco, Menlo, Helvetica Neue,Helvetica,Verdana,Tahoma, Arial`,weight:`bold`,style:`normal`,lineHeight:3},fs=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},ps=class extends T{constructor(){super(),this.currentTheme=`dark`,this._themeHandler=()=>{this.readColors(),this.currentTheme=ms()}}readColors(){let e=getComputedStyle(this);this.primary=e.getPropertyValue(`--primary-color`).trim(),this.secondary=e.getPropertyValue(`--secondary-color`).trim(),this.tertiary=e.getPropertyValue(`--tertiary-color`).trim(),this.background=e.getPropertyValue(`--background-color`).trim(),this.error=e.getPropertyValue(`--error-color`).trim(),this.ok=e.getPropertyValue(`--terminal-text`).trim(),this.warn=e.getPropertyValue(`--warn-color`).trim(),this.color1=e.getPropertyValue(`--chart-color1`).trim(),this.color2=e.getPropertyValue(`--chart-color2`).trim(),this.color3=e.getPropertyValue(`--chart-color3`).trim(),this.color4=e.getPropertyValue(`--chart-color4`).trim(),this.color5=e.getPropertyValue(`--chart-color5`).trim()}firstUpdated(){this.readColors(),this.currentTheme=ms(),this.font=ss,this.smallFont=cs,this.mediumFont=ls,this.titleFont=ds,this.fontBold=us,window.addEventListener(Po,this._themeHandler)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(Po,this._themeHandler)}};fs([j()],ps.prototype,`currentTheme`,void 0);function ms(){let e=document.documentElement.getAttribute(`theme`);return e===`light`?`light`:e===`tektronix`?`tektronix`:`dark`}var hs=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},gs=class extends T{constructor(){super(),this.animationFrameId=null,this._currentTheme=`dark`,this._themeHandler=()=>{this._currentTheme=ms()},this.sparkArray=[],this.gravity=.005,this.spawnRate=50,this.isError=!1,this.animating=!1}firstUpdated(){this._currentTheme=ms(),window.addEventListener(Po,this._themeHandler);let e=this.renderRoot.querySelector(`canvas`);if(e){this.canvas=e;let t=this.canvas?.getContext(`2d`);t&&(this.ctx=t)}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(Po,this._themeHandler)}startAnimation(){this.animating||(this.animationTimer=setInterval(()=>this.spawnSpark(),1e3/this.spawnRate),this.animating=!0,this.animateSparks())}stopAnimation(){this.animating=!1,clearInterval(this.animationTimer),this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.sparkArray=[],this.ctx&&this.canvas&&this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height)}getRandomBetween(e,t){return Math.random()*(t-e)+e}spawnSpark(){if(this.animating){let e;e=this._currentTheme===`light`?this.isError?Math.random()>.5?`rgb(60, 60, 60)`:`rgb(120, 120, 120)`:Math.random()>.5?`rgb(80, 80, 80)`:`rgb(160, 160, 160)`:this._currentTheme===`tektronix`?this.isError?Math.random()>.5?`rgb(102, 255, 102)`:`rgb(34, 204, 34)`:Math.random()>.5?`rgb(51, 255, 51)`:`rgb(26, 153, 26)`:this.isError?Math.random()>.5?`rgb(255, 60, 116)`:`rgb(157, 26, 65)`:Math.random()>.5?`rgb(248, 58, 255)`:`rgb(98, 196, 255)`,this.sparkArray.push({x:Math.random()*this.canvas.width,y:-2,size:1,color:e,velocityY:this.getRandomBetween(.05,.3),lifetime:150,initialLifetime:150,opacity:1})}}animateSparks(){if(this.animating){this.ctx?.clearRect(0,0,this.canvas?.width,this.canvas?.height),this.sparkArray=this.sparkArray.filter(e=>e.lifetime>0);for(let e of this.sparkArray)this.drawSpark(e),e.y+=e.velocityY,e.velocityY+=this.gravity,e.lifetime--,e.opacity=e.lifetime/e.initialLifetime;this.animationFrameId=requestAnimationFrame(()=>this.animateSparks())}}drawSpark(e){this.ctx.globalAlpha=e.opacity,this.ctx.fillStyle=e.color,/Safari/.test(navigator.userAgent)||(this.ctx.shadowColor=e.color,this.ctx.shadowBlur=8),this.ctx.fillRect(e.x,e.y,e.size,e.size),this.ctx.globalAlpha=1}render(){return C`
    ...
    `,hs([A({type:Boolean})],gs.prototype,`isError`,void 0),gs=hs([k(`pb33f-pixel-sparks`)],gs);function _s(e){return e}var vs=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},ys=class extends T{constructor(){super(),this.sparks=new gs,this.currentPage=1,this.totalPages=1,this.totalItems=0,this.itemsPerPage=20,this.activeIndex=0,this.invalid=!1,this.hideSparks=!1,this.paginatorNavigator=new as,this.paginatorNavigator.currentPage=this.currentPage,this.paginatorNavigator.totalPages=this.totalPages,this.paginatorNavigator.totalItems=this.totalItems,this.paginatorNavigator.itemsPerPage=this.itemsPerPage,this.addEventListener(es,_s(this.firstPage.bind(this))),this.addEventListener(ts,_s(this.lastPage.bind(this))),this.addEventListener(ns,_s(this.nextPage.bind(this))),this.addEventListener(rs,_s(this.previousPage.bind(this)))}nextPage(e){e.stopPropagation(),this.currentPage<this.totalPages&&this.currentPage++}lastPage(e){e.stopPropagation(),this.currentPage<this.totalPages&&(this.currentPage=this.totalPages)}firstPage(e){e.stopPropagation(),this.currentPage>1&&(this.currentPage=1)}setPage(e){this.currentPage=Math.ceil(e/this.itemsPerPage),this.activeIndex=e}previousPage(e){e.stopPropagation(),this.currentPage>1&&this.currentPage--}calcTotalPages(){return Math.ceil(this.totalItems/this.itemsPerPage)}willUpdate(){this.totalItems=this.values?.length,this.totalPages=this.calcTotalPages(),this.currentPage>this.totalPages&&(this.currentPage=Math.max(1,this.totalPages)),this.sparks.isError=this.invalid,this.paginatorNavigator.currentPage=this.currentPage,this.paginatorNavigator.totalItems=this.values?.length,this.paginatorNavigator.itemsPerPage=this.itemsPerPage,this.paginatorNavigator.totalPages=this.totalPages,this.label&&(this.paginatorNavigator.label=this.label),this.renderValues=this.values?.slice(this.paginatorNavigator.getRangeStart(),this.paginatorNavigator.getRangeEnd())}startSparks(){this.sparks.startAnimation()}stopSparks(){this.sparks.stopAnimation()}render(){return this.renderValues?.length===0||!this.renderValues?this.hideSparks?C`
        ...
        `}};ys.styles=[os],vs([A({type:T})],ys.prototype,`values`,void 0),vs([A({type:Number})],ys.prototype,`currentPage`,void 0),vs([A({type:Number})],ys.prototype,`totalPages`,void 0),vs([A({type:Number})],ys.prototype,`totalItems`,void 0),vs([A({type:Number})],ys.prototype,`itemsPerPage`,void 0),vs([A()],ys.prototype,`label`,void 0),vs([A()],ys.prototype,`activeIndex`,void 0),vs([A({type:Boolean})],ys.prototype,`invalid`,void 0),vs([A({type:Boolean})],ys.prototype,`hideSparks`,void 0),ys=vs([k(`pb33f-paginator-navigation`)],ys);var bs=S`
    :host {
        display: flex;
        column-gap: 10px;
        position: relative;
...
`,xs=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Ss=class extends T{getValue(){let e=(this.shadowRoot?.querySelector(`slot.command`))?.assignedNodes({flatten:!0});return e&&e[0]?e[0].data?.trim()??``:``}copyToClipboard(){navigator.clipboard.writeText(this.getValue())}render(){return C`
            <sl-button class="copy" size="small" @click=${this.copyToClipboard}>copy</sl-button>
            <pre><slot class="command"></slot></pre>
        `}};Ss.styles=bs,Ss=xs([k(`terminal-example`)],Ss);var Cs=S`
    footer {
...
`,Ts=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Es=`https://github.com/pb33f/printing-press`,Ds=`documentation generated by the printing press`,Os=class extends T{constructor(){super(),this.url=Es,this.linkTitle=Ds,this.build=``,this.fluid=!1}render(){let e=this.linkTitle||`documentation generated by the printing press`;return C`
            <footer>
                <a href="${this.url}" title="${e}">${e}</a>
                ${this.build?C`<span class="generated-timestamp">${this.build}</span>`:``}
            </footer>`}};Os.styles=[Cs,ws],Ts([A()],Os.prototype,`build`,void 0),Ts([A()],Os.prototype,`url`,void 0),Ts([A({attribute:`link-title`})],Os.prototype,`linkTitle`,void 0),Ts([A({type:Boolean,reflect:!0})],Os.prototype,`fluid`,void 0),Os=Ts([k(`pb33f-footer`)],Os);var ks=S`
    sl-button::part(base) {
        border: 1px solid var(--primary-color);
        border-radius: 0;
        font-family: var(--font-stack), monospace;
...
`,Ms=/^[a-zA-Z][a-zA-Z\d+.-]*:/;function Ns(e){return!e||e.startsWith(`/`)||e.startsWith(`#`)||e.startsWith(`data:`)||Ms.test(e)}function Ps(){let e=document.body?.dataset.ppBaseUrl;if(!e)return document.baseURI;try{return new URL(e,window.location.href).toString()}catch{return document.baseURI}}function Fs(e){if(Ns(e))return e;try{return new URL(e,Ps()).toString()}catch{return e}}function Is(){let e=document.body?.dataset.ppOverviewHref;return Fs(e||`index.html`)}function Ls(){let e=document.body?.dataset.ppCatalogHref;return e?Fs(e):Is()}function Rs(e){return Fs(`operations/${e}.html`)}function zs(e,t){return Fs(`models/${e}/${t}.html`)}var Bs=S`
  :host {
    display: inline-block;
  }
...
`,K=class extends N{constructor(){super(...arguments),this.localize=new L(this),this.open=!1,this.placement=`bottom-start`,this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=e=>{this.open&&e.key===`Escape`&&(e.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=e=>{if(e.key===`Escape`&&this.open&&!this.closeWatcher){e.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(e.key===`Tab`){if(this.open&&document.activeElement?.tagName.toLowerCase()===`sl-menu-item`){e.preventDefault(),this.hide(),this.focusOnTrigger();return}let t=(e,n)=>{if(!e)return null;let r=e.closest(n);if(r)return r;let i=e.getRootNode();return i instanceof ShadowRoot?t(i.host,n):null};setTimeout(()=>{let e=this.containingElement?.getRootNode()instanceof ShadowRoot?Ta():document.activeElement;(!this.containingElement||t(e,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=e=>{let t=e.composedPath();this.containingElement&&!t.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=e=>{let t=e.target;!this.stayOpenOnSelect&&t.tagName.toLowerCase()===`sl-menu`&&(this.hide(),this.focusOnTrigger())}}connectedCallback(){super.connectedCallback(),this.containingElement||=this}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){let e=this.trigger.assignedElements({flatten:!0})[0];typeof e?.focus==`function`&&e.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(e=>e.tagName.toLowerCase()===`sl-menu`)}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(e){if([` `,`Enter`].includes(e.key)){e.preventDefault(),this.handleTriggerClick();return}let t=this.getMenu();if(t){let n=t.getAllItems(),r=n[0],i=n[n.length-1];[`ArrowDown`,`ArrowUp`,`Home`,`End`].includes(e.key)&&(e.preventDefault(),this.open||(this.show(),await this.updateComplete),n.length>0&&this.updateComplete.then(()=>{(e.key===`ArrowDown`||e.key===`Home`)&&(t.setCurrentItem(r),r.focus()),(e.key===`ArrowUp`||e.key===`End`)&&(t.setCurrentItem(i),i.focus())}))}}handleTriggerKeyUp(e){e.key===` `&&e.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){let e=this.trigger.assignedElements({flatten:!0}).find(e=>ja(e).start),t;if(e){switch(e.tagName.toLowerCase()){case`sl-button`:case`sl-icon-button`:t=e.button;break;default:t=e}t.setAttribute(`aria-haspopup`,`true`),t.setAttribute(`aria-expanded`,this.open?`true`:`false`)}}async show(){if(!this.open)return this.open=!0,ma(this,`sl-after-show`)}async hide(){if(this.open)return this.open=!1,ma(this,`sl-after-hide`)}reposition(){this.popup.reposition()}addOpenListeners(){var e;this.panel.addEventListener(`sl-select`,this.handlePanelSelect),`CloseWatcher`in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener(`keydown`,this.handleKeyDown),document.addEventListener(`keydown`,this.handleDocumentKeyDown),document.addEventListener(`mousedown`,this.handleDocumentMouseDown)}removeOpenListeners(){var e;this.panel&&(this.panel.removeEventListener(`sl-select`,this.handlePanelSelect),this.panel.removeEventListener(`keydown`,this.handleKeyDown)),document.removeEventListener(`keydown`,this.handleDocumentKeyDown),document.removeEventListener(`mousedown`,this.handleDocumentMouseDown),(e=this.closeWatcher)==null||e.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit(`sl-show`),this.addOpenListeners(),await H(this),this.panel.hidden=!1,this.popup.active=!0;let{keyframes:e,options:t}=B(this,`dropdown.show`,{dir:this.localize.dir()});await V(this.popup.popup,e,t),this.emit(`sl-after-show`)}else{this.emit(`sl-hide`),this.removeOpenListeners(),await H(this);let{keyframes:e,options:t}=B(this,`dropdown.hide`,{dir:this.localize.dir()});await V(this.popup.popup,e,t),this.panel.hidden=!0,this.popup.active=!1,this.emit(`sl-after-hide`)}}render(){return C`
      <sl-popup
        part="base"
    ...
    `}};K.styles=[O,Bs],K.dependencies={"sl-popup":R},E([M(`.dropdown`)],K.prototype,`popup`,2),E([M(`.dropdown__trigger`)],K.prototype,`trigger`,2),E([M(`.dropdown__panel`)],K.prototype,`panel`,2),E([A({type:Boolean,reflect:!0})],K.prototype,`open`,2),E([A({reflect:!0})],K.prototype,`placement`,2),E([A({type:Boolean,reflect:!0})],K.prototype,`disabled`,2),E([A({attribute:`stay-open-on-select`,type:Boolean,reflect:!0})],K.prototype,`stayOpenOnSelect`,2),E([A({attribute:!1})],K.prototype,`containingElement`,2),E([A({type:Number})],K.prototype,`distance`,2),E([A({type:Number})],K.prototype,`skidding`,2),E([A({type:Boolean})],K.prototype,`hoist`,2),E([A({reflect:!0})],K.prototype,`sync`,2),E([D(`open`,{waitUntilFirstUpdate:!0})],K.prototype,`handleOpenChange`,1),z(`dropdown.show`,{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:`ease`}}),z(`dropdown.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:`ease`}}),K.define(`sl-dropdown`);var Vs=S`
  :host {
    display: block;
    position: relative;
...
`,Hs=class extends N{connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`menu`)}handleClick(e){let t=[`menuitem`,`menuitemcheckbox`],n=e.composedPath(),r=n.find(e=>t.includes((e?.getAttribute)?.call(e,`role`)||``));if(!r||n.find(e=>(e?.getAttribute)?.call(e,`role`)===`menu`)!==this)return;let i=r;i.type===`checkbox`&&(i.checked=!i.checked),this.emit(`sl-select`,{detail:{item:i}})}handleKeyDown(e){if(e.key===`Enter`||e.key===` `){let t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t?.click()}else if([`ArrowDown`,`ArrowUp`,`Home`,`End`].includes(e.key)){let t=this.getAllItems(),n=this.getCurrentItem(),r=n?t.indexOf(n):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key===`ArrowDown`?r++:e.key===`ArrowUp`?r--:e.key===`Home`?r=0:e.key===`End`&&(r=t.length-1),r<0&&(r=t.length-1),r>t.length-1&&(r=0),this.setCurrentItem(t[r]),t[r].focus())}}handleMouseDown(e){let t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){let e=this.getAllItems();e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){return e.tagName.toLowerCase()===`sl-menu-item`||[`menuitem`,`menuitemcheckbox`,`menuitemradio`].includes(e.getAttribute(`role`)??``)}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute(`tabindex`)===`0`)}setCurrentItem(e){this.getAllItems().forEach(t=>{t.setAttribute(`tabindex`,t===e?`0`:`-1`)})}render(){return C`
      ...
      ></slot>
    `}};Hs.styles=[O,Vs],E([M(`slot`)],Hs.prototype,`defaultSlot`,2),Hs.define(`sl-menu`);var Us=S`
  :host {
    --submenu-offset: -2px;
...
`,Ws=(e,t)=>{let n=e._$AN;if(n===void 0)return!1;for(let e of n)e._$AO?.(t,!1),Ws(e,t);return!0},Gs=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},Ks=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),Ys(t)}};function qs(e){this._$AN===void 0?this._$AM=e:(Gs(this),this._$AM=e,Ks(this))}function Js(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(r))for(let e=n;e<r.length;e++)Ws(r[e],!1),Gs(r[e]);else r!=null&&(Ws(r,!1),Gs(r));else Ws(this,e)}var Ys=e=>{e.type==Kn.CHILD&&(e._$AP??=Js,e._$AQ??=qs)},Xs=class extends Jn{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),Ks(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Ws(this,e),Gs(this))}setValue(e){if(Rn(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},Zs=()=>new Qs,Qs=class{},$s=new WeakMap,ec=qn(class extends Xs{render(e){return w}update(e,[t]){let n=t!==this.G;return n&&this.G!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),w}rt(e){if(this.isConnected||(e=void 0),typeof this.G==`function`){let t=this.ht??globalThis,n=$s.get(t);n===void 0&&(n=new WeakMap,$s.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return typeof this.G==`function`?$s.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),tc=class{constructor(e,t){this.popupRef=Zs(),this.enableSubmenuTimer=-1,this.isConnected=!1,this.isPopupConnected=!1,this.skidding=0,this.submenuOpenDelay=100,this.handleMouseMove=e=>{this.host.style.setProperty(`--safe-triangle-cursor-x`,`${e.clientX}px`),this.host.style.setProperty(`--safe-triangle-cursor-y`,`${e.clientY}px`)},this.handleMouseOver=()=>{this.hasSlotController.test(`submenu`)&&this.enableSubmenu()},this.handleKeyDown=e=>{switch(e.key){case`Escape`:case`Tab`:this.disableSubmenu();break;case`ArrowLeft`:e.target!==this.host&&(e.preventDefault(),e.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case`ArrowRight`:case`Enter`:case` `:this.handleSubmenuEntry(e);break;default:break}},this.handleClick=e=>{e.target===this.host?(e.preventDefault(),e.stopPropagation()):e.target instanceof Element&&(e.target.tagName===`sl-menu-item`||e.target.role?.startsWith(`menuitem`))&&this.disableSubmenu()},this.handleFocusOut=e=>{e.relatedTarget&&e.relatedTarget instanceof Element&&this.host.contains(e.relatedTarget)||this.disableSubmenu()},this.handlePopupMouseover=e=>{e.stopPropagation()},this.handlePopupReposition=()=>{let e=this.host.renderRoot.querySelector(`slot[name='submenu']`)?.assignedElements({flatten:!0}).filter(e=>e.localName===`sl-menu`)[0],t=getComputedStyle(this.host).direction===`rtl`;if(!e)return;let{left:n,top:r,width:i,height:a}=e.getBoundingClientRect();this.host.style.setProperty(`--safe-triangle-submenu-start-x`,`${t?n+i:n}px`),this.host.style.setProperty(`--safe-triangle-submenu-start-y`,`${r}px`),this.host.style.setProperty(`--safe-triangle-submenu-end-x`,`${t?n+i:n}px`),this.host.style.setProperty(`--safe-triangle-submenu-end-y`,`${r+a}px`)},(this.host=e).addController(this),this.hasSlotController=t}hostConnected(){this.hasSlotController.test(`submenu`)&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test(`submenu`)&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||=(this.host.addEventListener(`mousemove`,this.handleMouseMove),this.host.addEventListener(`mouseover`,this.handleMouseOver),this.host.addEventListener(`keydown`,this.handleKeyDown),this.host.addEventListener(`click`,this.handleClick),this.host.addEventListener(`focusout`,this.handleFocusOut),!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener(`mouseover`,this.handlePopupMouseover),this.popupRef.value.addEventListener(`sl-reposition`,this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&=(this.host.removeEventListener(`mousemove`,this.handleMouseMove),this.host.removeEventListener(`mouseover`,this.handleMouseOver),this.host.removeEventListener(`keydown`,this.handleKeyDown),this.host.removeEventListener(`click`,this.handleClick),this.host.removeEventListener(`focusout`,this.handleFocusOut),!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener(`mouseover`,this.handlePopupMouseover),this.popupRef.value.removeEventListener(`sl-reposition`,this.handlePopupReposition),this.isPopupConnected=!1)}handleSubmenuEntry(e){let t=this.host.renderRoot.querySelector(`slot[name='submenu']`);if(!t){console.error(`Cannot activate a submenu if no corresponding menuitem can be found.`,this);return}let n=null;for(let e of t.assignedElements())if(n=e.querySelectorAll(`sl-menu-item, [role^='menuitem']`),n.length!==0)break;if(!(!n||n.length===0)){n[0].setAttribute(`tabindex`,`0`);for(let e=1;e!==n.length;++e)n[e].setAttribute(`tabindex`,`-1`);this.popupRef.value&&(e.preventDefault(),e.stopPropagation(),this.popupRef.value.active?n[0]instanceof HTMLElement&&n[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{n[0]instanceof HTMLElement&&n[0].focus()}),this.host.requestUpdate()))}}setSubmenuState(e){this.popupRef.value&&this.popupRef.value.active!==e&&(this.popupRef.value.active=e,this.host.requestUpdate())}enableSubmenu(e=!0){e?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){if(!this.host.parentElement?.computedStyleMap)return;let e=this.host.parentElement.computedStyleMap();this.skidding=[`padding-top`,`border-top-width`,`margin-top`].reduce((t,n)=>{let r=e.get(n)??new CSSUnitValue(0,`px`);return t-(r instanceof CSSUnitValue?r:new CSSUnitValue(0,`px`)).to(`px`).value},0)}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){let e=getComputedStyle(this.host).direction===`rtl`;return this.isConnected?C`
    ...
    `}};nc.styles=[O,Us],nc.dependencies={"sl-icon":Gn,"sl-popup":R,"sl-spinner":to},E([M(`slot:not([name])`)],nc.prototype,`defaultSlot`,2),E([M(`.menu-item`)],nc.prototype,`menuItem`,2),E([A()],nc.prototype,`type`,2),E([A({type:Boolean,reflect:!0})],nc.prototype,`checked`,2),E([A()],nc.prototype,`value`,2),E([A({type:Boolean,reflect:!0})],nc.prototype,`loading`,2),E([A({type:Boolean,reflect:!0})],nc.prototype,`disabled`,2),E([D(`checked`)],nc.prototype,`handleCheckedChange`,1),E([D(`disabled`)],nc.prototype,`handleDisabledChange`,1),E([D(`type`)],nc.prototype,`handleTypeChange`,1),nc.define(`sl-menu-item`);function q(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var rc=`pp-split-position`,ic=20,ac=class extends T{constructor(...e){super(...e),this.title=``,this.splitPos=ic,this.currentVersion=``,this.versions=[],this.catalogHref=``}static{this.styles=[As,js]}connectedCallback(){super.connectedCallback(),this.title=this.getAttribute(`data-title`)||document.title||`API Documentation`,this.currentVersion=document.body?.dataset.ppCurrentVersion||``,this.versions=this.parseVersions(document.body?.dataset.ppVersions),this.catalogHref=document.body?.dataset.ppCatalogHref?Fs(document.body.dataset.ppCatalogHref):``;let e=sessionStorage.getItem(rc);e&&(this.splitPos=parseFloat(e))}onReposition(e){let t=e.target.position;typeof t==`number`&&(this.splitPos=t,sessionStorage.setItem(rc,String(t)))}parseVersions(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.filter(e=>!!e&&typeof e.label==`string`&&typeof e.href==`string`):[]}catch{return[]}}onVersionChange(e){let t=e.detail?.item;t?.value&&(window.location.href=t.value)}currentVersionLabel(){return this.versions.find(e=>e.active||e.label===this.currentVersion)?.label||this.currentVersion||this.versions[0]?.label||`Version`}currentVersionTriggerLabel(){return`Version: ${this.currentVersionLabel()}`}render(){return C`
      <pb33f-header name=${this.title} url=${Ls()} fluid>
        <div class="header-tools">
          ${this.catalogHref||this.versions.length?C`
                        ...
                        <div class="version-picker">
                          <sl-dropdown skidding="5" distance="5">
                            ...
                            <sl-menu @sl-select=${this.onVersionChange}>
                              ${this.versions.map(e=>C`
                                  <sl-menu-item value=${Fs(e.href)}>
                                    ${e.label}
                                  </sl-menu-item>
                                `)}
                            </sl-menu>
    ...
    `}};q([j()],ac.prototype,`title`,void 0),q([j()],ac.prototype,`splitPos`,void 0),q([j()],ac.prototype,`currentVersion`,void 0),q([j()],ac.prototype,`versions`,void 0),q([j()],ac.prototype,`catalogHref`,void 0),ac=q([k(`pp-layout`)],ac);var oc=S`
    :host {
        display: block;
        padding: var(--global-padding);
        font-family: var(--font-stack), monospace;
...
`,sc=class extends T{constructor(...e){super(...e),this.navJson=``,this.modelsJson=``,this.webhooksJson=``,this.activeSlug=``,this.tags=[],this.modelGroups=[],this.webhooks=[],this.loggedEmptyState=!1,this.loggedContentState=!1}static{this.styles=oc}logPerf(e,t){let n=globalThis.__PP_LOG;typeof n==`function`&&n(e,t)}previewHoldEnabled(){return this.getAttribute(`data-pp-preview-hold`)===`true`}developerMode(){return document.body?.dataset.ppDeveloperMode===`true`}connectedCallback(){super.connectedCallback();let e=this.querySelector(`.pp-nav-preview`);this.logPerf(`nav:connected`,{activeSlug:this.activeSlug,cached:this.hasAttribute(`data-pp-nav-cached`),preview:!!e,previewHold:this.previewHoldEnabled()})}willUpdate(e){if(e.has(`navJson`))try{this.tags=this.navJson&&JSON.parse(this.navJson)||[]}catch{this.tags=[]}if(e.has(`modelsJson`))try{this.modelGroups=this.modelsJson&&JSON.parse(this.modelsJson)||[]}catch{this.modelGroups=[]}if(e.has(`webhooksJson`))try{this.webhooks=this.webhooksJson&&JSON.parse(this.webhooksJson)||[]}catch{this.webhooks=[]}}updated(){let e=this.tags.length>0||this.modelGroups.length>0||this.webhooks.length>0;if(!e&&!this.loggedEmptyState&&(this.loggedEmptyState=!0,this.logPerf(`nav:empty-render`)),e&&!this.loggedContentState){if(this.loggedContentState=!0,this.logPerf(`nav:content-render`,{tags:this.tags.length,modelGroups:this.modelGroups.length,webhooks:this.webhooks.length}),this.previewHoldEnabled()){this.logPerf(`nav-preview:hold-active`,{source:`shadow-nav`});return}let e=this.querySelector(`.pp-nav-preview`);e&&(e.remove(),this.logPerf(`nav-preview:removed`,{source:`shadow-nav`}))}}render(){return this.previewHoldEnabled()?C`<slot></slot>`:C`
      ...
      ${this.webhooks.length?C`
          ...
          `:w}
    `}};q([A({attribute:`data-nav`})],sc.prototype,`navJson`,void 0),q([A({attribute:`data-models`})],sc.prototype,`modelsJson`,void 0),q([A({attribute:`data-webhooks`})],sc.prototype,`webhooksJson`,void 0),q([A({attribute:`data-active`})],sc.prototype,`activeSlug`,void 0),q([j()],sc.prototype,`tags`,void 0),q([j()],sc.prototype,`modelGroups`,void 0),q([j()],sc.prototype,`webhooks`,void 0),sc=q([k(`pp-nav`)],sc);var cc=S`
    :host {
        display: block;
        margin: 0;
    }
...
`;function lc(e){return e?(e.errors||0)+(e.warns||0)+(e.infos||0):0}function uc(e,t,n=`${t}s`){return e===1?t:n}function dc(e){return e===8?`err`:e===4?`warn`:`info`}function fc(e){return e===8?`exclamation-square`:e===4?`exclamation-triangle`:`info-square`}function pc(e){return e===8?`Error`:e===4?`Warning`:`Info`}function mc(e){return!e||lc(e)<=0?w:C`
    <span class="violation-badges">
      ${[{severity:`error`,count:e.errors||0,noun:`error`},{severity:`warn`,count:e.warns||0,noun:`warning`},{severity:`info`,count:e.infos||0,noun:`info`}].map(({severity:e,count:t,noun:n})=>{if(t<=0)return w;let r=t>99?`99+`:String(t),i=`${t} ${n}${t===1?``:`s`}`;return C`<sl-badge class=${`violation-badge ${e}`}>
          ${r}<span class="sr-only"> ${i}</span>
        </sl-badge>`})}
    </span>
  `}function hc(e,t){return t?!!(e.operations?.some(e=>e.slug===t)||e.children?.some(e=>hc(e,t))):!1}var gc=class extends T{constructor(...e){super(...e),this.tag={name:``,summary:``,children:null,operations:null,isNavOnly:!1},this.activeSlug=``,this.open=!1}static{this.styles=cc}willUpdate(e){(e.has(`tag`)||e.has(`activeSlug`))&&hc(this.tag,this.activeSlug)&&(this.open=!0)}toggle(){this.open=!this.open}developerMode(){return document.body?.dataset.ppDeveloperMode===`true`}render(){let{tag:e,activeSlug:t,open:n}=this,r=hc(e,t),i=this.developerMode();return C`
            ...
            ${n?C`
                        <div class="tag-body">
                            ${e.operations?.length?C`
                                        <ul>
                                            ${e.operations.map(e=>C`
                                                        <li>
                                                            <a href=${Rs(e.slug)} class="${e.deprecated?`deprecated`:``} ${e.slug===t?`active`:``} ${i?`developer`:``}">
                    ...
                    `:w}
        `}};q([A({type:Object})],gc.prototype,`tag`,void 0),q([A()],gc.prototype,`activeSlug`,void 0),q([j()],gc.prototype,`open`,void 0),gc=q([k(`pp-nav-tag`)],gc);var _c=S`
    :host {
        display: block;
        margin: 0;
    }
...
`;function vc(e,t){return t?e.models?.some(e=>e.typeSlug+`/`+e.slug===t)??!1:!1}var yc=class extends T{constructor(...e){super(...e),this.group={name:``,typeSlug:``,models:null},this.activeSlug=``,this.open=!1}static{this.styles=_c}willUpdate(e){(e.has(`group`)||e.has(`activeSlug`))&&vc(this.group,this.activeSlug)&&(this.open=!0)}updated(e){(e.has(`activeSlug`)||e.has(`group`))&&this.open&&this.activeSlug&&requestAnimationFrame(()=>{this.renderRoot.querySelector(`a.active`)?.scrollIntoView({block:`center`,behavior:`auto`})})}toggle(){this.open=!this.open}developerMode(){return document.body?.dataset.ppDeveloperMode===`true`}render(){let{group:e,activeSlug:t,open:n}=this,r=vc(e,t),i=this.developerMode();return C`
            ...
            ${n&&e.models?.length?C`
                    <div class="group-body">
                        <ul>
                            ${e.models.map(e=>{let n=e.typeSlug+`/`+e.slug;return C`
                                        <li>
                ...
                `:w}
        `}};q([A({type:Object})],yc.prototype,`group`,void 0),q([A()],yc.prototype,`activeSlug`,void 0),q([j()],yc.prototype,`open`,void 0),yc=q([k(`pp-nav-model-group`)],yc);var bc=S`
  :host {
    display: block;
  }
  a {
...
`,xc=class extends T{constructor(...e){super(...e),this.method=``,this.path=``,this.slug=``,this.deprecated=!1}static{this.styles=bc}render(){return C`
      <a
        href=${Rs(this.slug)}
    ...
    `}};q([A()],xc.prototype,`method`,void 0),q([A()],xc.prototype,`path`,void 0),q([A()],xc.prototype,`slug`,void 0),q([A({type:Boolean})],xc.prototype,`deprecated`,void 0),xc=q([k(`pp-nav-operation`)],xc);var Sc=[ks,S`
    :host {
        display: block;
        min-height: 156px;
    }
...
`],Cc=class extends T{constructor(...e){super(...e),this.curlJson=``,this.variants=[],this.selectedIndex=0}static{this.styles=[Sc]}willUpdate(e){if(e.has(`curlJson`)){try{let e=JSON.parse(this.curlJson);this.variants=Array.isArray(e)?e:[]}catch{this.variants=[]}this.selectedIndex=0}}renderSelector(){if(this.variants.length<=1)return w;let e=this.variants[this.selectedIndex]||this.variants[0];return e?C`
    ...
    `:w}handleSelect(e){let t=e.detail?.item?.value;if(t===void 0)return;let n=parseInt(t,10);n>=0&&n<this.variants.length&&(this.selectedIndex=n)}renderSkeleton(){return C`
    ...
    `}render(){if(this.variants.length===0)return this.renderSkeleton();let e=this.variants[this.selectedIndex]||this.variants[0];return e?C`
      ${this.renderSelector()}
      <terminal-example>${e.command}</terminal-example>
    `:w}};q([A({attribute:`curl-json`})],Cc.prototype,`curlJson`,void 0),q([j()],Cc.prototype,`variants`,void 0),q([j()],Cc.prototype,`selectedIndex`,void 0),Cc=q([k(`pp-curl-command`)],Cc);var wc=S`
    .constraints {
        display: grid;
...
`,Oc=`path-items`,kc={schemas:`schemas`,responses:`responses`,parameters:`parameters`,requestBodies:`request-bodies`,headers:`headers`,securitySchemes:`security`,examples:`examples`,links:`links`,callbacks:`callbacks`,pathItems:Oc};function Ac(e){let t=e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`);return t=t.toLowerCase(),t=t.replace(/[/]/g,`-`).replace(/[{}_.]/g,`-`).replace(/ /g,`-`),t=t.replace(/[^a-z0-9-]/g,``),t=t.replace(/-{2,}/g,`-`),t=t.replace(/^-|-$/g,``),t||`unnamed`}function jc(e){if(!e||!e.startsWith(`#/components/`))return null;let t=e.replace(`#/components/`,``).split(`/`);if(t.length!==2)return null;let[n,r]=t,i=kc[n];return i?{name:r,href:zs(i,Ac(r))}:null}function Mc(e,t){if(!e)return[];let n=[];return t?.includeExample&&(e.example!==void 0&&n.push({label:`example`,value:JSON.stringify(e.example)}),e.default!==void 0&&n.push({label:`default`,value:JSON.stringify(e.default)})),e.minimum!==void 0&&n.push({label:`min`,value:e.minimum}),e.maximum!==void 0&&n.push({label:`max`,value:e.maximum}),e.exclusiveMinimum!==void 0&&n.push({label:`exclusiveMin`,value:e.exclusiveMinimum}),e.exclusiveMaximum!==void 0&&n.push({label:`exclusiveMax`,value:e.exclusiveMaximum}),e.minLength!==void 0&&n.push({label:`minLength`,value:e.minLength}),e.maxLength!==void 0&&n.push({label:`maxLength`,value:e.maxLength}),e.minItems!==void 0&&n.push({label:`minItems`,value:e.minItems}),e.maxItems!==void 0&&n.push({label:`maxItems`,value:e.maxItems}),e.uniqueItems&&n.push({label:`uniqueItems`,value:`true`}),e.pattern&&n.push({label:`pattern`,value:e.pattern,isCode:!0}),e.multipleOf!==void 0&&n.push({label:`multipleOf`,value:e.multipleOf}),n}function Nc(e){if(!e)return``;if(e.type===`array`&&e.items)return`Array<${e.items.type||e.items.$ref?.split(`/`).pop()||`any`}>`;if(e.type){let t=Array.isArray(e.type)?e.type.join(` | `):e.type;return e.format&&(t+=` (${e.format})`),t}return e.oneOf?`oneOf`:e.anyOf?`anyOf`:e.allOf?`allOf`:e.$ref?e.$ref.split(`/`).pop()??``:``}function Pc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Fc=Pc();function Ic(e){Fc=e}var Lc=/[&<>"']/,Rc=new RegExp(Lc.source,`g`),zc=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Bc=new RegExp(zc.source,`g`),Vc={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Hc=e=>Vc[e];function Uc(e,t){if(t){if(Lc.test(e))return e.replace(Rc,Hc)}else if(zc.test(e))return e.replace(Bc,Hc);return e}var Wc=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function Gc(e){return e.replace(Wc,(e,t)=>(t=t.toLowerCase(),t===`colon`?`:`:t.charAt(0)===`#`?t.charAt(1)===`x`?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):``))}var Kc=/(^|[^\[])\^/g;function J(e,t){let n=typeof e==`string`?e:e.source;t||=``;let r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(Kc,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}function qc(e){try{e=encodeURI(e).replace(/%25/g,`%`)}catch{return null}return e}var Jc={exec:()=>null};function Yc(e,t){let n=e.replace(/\|/g,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(/ \|/),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n[n.length-1].trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(/\\\|/g,`|`);return n}function Xc(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function Zc(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return-1}function Qc(e,t,n,r){let i=t.href,a=t.title?Uc(t.title):null,o=e[1].replace(/\\([\[\]])/g,`$1`);if(e[0].charAt(0)!==`!`){r.state.inLink=!0;let e={type:`link`,raw:n,href:i,title:a,text:o,tokens:r.inlineTokens(o)};return r.state.inLink=!1,e}return{type:`image`,raw:n,href:i,title:a,text:Uc(o)}}function $c(e,t){let n=e.match(/^(\s+)(?:```)/);if(n===null)return t;let r=n[1];return t.split(`
`).map(e=>{let t=e.match(/^\s+/);if(t===null)return e;let[n]=t;return n.length>=r.length?e.slice(r.length):e}).join(`
`)}var el=class{options;rules;lexer;constructor(e){this.options=e||Fc}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:`space`,raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let e=t[0].replace(/^ {1,4}/gm,``);return{type:`code`,raw:t[0],codeBlockStyle:`indented`,text:this.options.pedantic?e:Xc(e,`
`)}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let e=t[0],n=$c(e,t[3]||``);return{type:`code`,raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,`$1`):t[2],text:n}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(/#$/.test(e)){let t=Xc(e,`#`);(this.options.pedantic||!t||/ $/.test(t))&&(e=t.trim())}return{type:`heading`,raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){let t=this.rules.block.hr.exec(e);if(t)return{type:`hr`,raw:t[0]}}blockquote(e){let t=this.rules.block.blockquote.exec(e);if(t){let e=Xc(t[0].replace(/^ *>[ \t]?/gm,``),`
...
`+l}!d&&!l.trim()&&(d=!0),o+=c+`
`,e=e.substring(c.length+1),r=l.slice(u)}}i.loose||(c?i.loose=!0:/\n *\n *$/.test(o)&&(c=!0));let f=null,p;this.options.gfm&&(f=/^\[[ xX]\] /.exec(s),f&&(p=f[0]!==`[ ] `,s=s.replace(/^\[[ xX]\] +/,``))),i.items.push({type:`list_item`,raw:o,task:!!f,checked:p,loose:!1,text:s,tokens:[]}),i.raw+=o}i.items[i.items.length-1].raw=o.trimEnd(),i.items[i.items.length-1].text=s.trimEnd(),i.raw=i.raw.trimEnd();for(let e=0;e<i.items.length;e++)if(this.lexer.state.top=!1,i.items[e].tokens=this.lexer.blockTokens(i.items[e].text,[]),!i.loose){let t=i.items[e].tokens.filter(e=>e.type===`space`);i.loose=t.length>0&&t.some(e=>/\n.*\n/.test(e.raw))}if(i.loose)for(let e=0;e<i.items.length;e++)i.items[e].loose=!0;return i}}html(e){let t=this.rules.block.html.exec(e);if(t)return{type:`html`,block:!0,raw:t[0],pre:t[1]===`pre`||t[1]===`script`||t[1]===`style`,text:t[0]}}def(e){let t=this.rules.block.def.exec(e);if(t){let e=t[1].toLowerCase().replace(/\s+/g,` `),n=t[2]?t[2].replace(/^<(.*)>$/,`$1`).replace(this.rules.inline.anyPunctuation,`$1`):``,r=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,`$1`):t[3];return{type:`def`,tag:e,raw:t[0],href:n,title:r}}}table(e){let t=this.rules.block.table.exec(e);if(!t||!/[:|]/.test(t[2]))return;let n=Yc(t[1]),r=t[2].replace(/^\||\| *$/g,``).split(`|`),i=t[3]&&t[3].trim()?t[3].replace(/\n[ \t]*$/,``).split(`
`):[],a={type:`table`,raw:t[0],header:[],align:[],rows:[]};if(n.length===r.length){for(let e of r)/^ *-+: *$/.test(e)?a.align.push(`right`):/^ *:-+: *$/.test(e)?a.align.push(`center`):/^ *:-+ *$/.test(e)?a.align.push(`left`):a.align.push(null);for(let e of n)a.header.push({text:e,tokens:this.lexer.inline(e)});for(let e of i)a.rows.push(Yc(e,a.header.length).map(e=>({text:e,tokens:this.lexer.inline(e)})));return a}}lheading(e){let t=this.rules.block.lheading.exec(e);if(t)return{type:`heading`,raw:t[0],depth:t[2].charAt(0)===`=`?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(e){let t=this.rules.block.paragraph.exec(e);if(t){let e=t[1].charAt(t[1].length-1)===`
`?t[1].slice(0,-1):t[1];return{type:`paragraph`,raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(e){let t=this.rules.block.text.exec(e);if(t)return{type:`text`,raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){let t=this.rules.inline.escape.exec(e);if(t)return{type:`escape`,raw:t[0],text:Uc(t[1])}}tag(e){let t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&/^<a /i.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&/^<\/a>/i.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:`html`,raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(e){let t=this.rules.inline.link.exec(e);if(t){let e=t[2].trim();if(!this.options.pedantic&&/^</.test(e)){if(!/>$/.test(e))return;let t=Xc(e.slice(0,-1),`\\`);if((e.length-t.length)%2==0)return}else{let e=Zc(t[2],`()`);if(e>-1){let n=(t[0].indexOf(`!`)===0?5:4)+t[1].length+e;t[2]=t[2].substring(0,e),t[0]=t[0].substring(0,n).trim(),t[3]=``}}let n=t[2],r=``;if(this.options.pedantic){let e=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(n);e&&(n=e[1],r=e[3])}else r=t[3]?t[3].slice(1,-1):``;return n=n.trim(),/^</.test(n)&&(n=this.options.pedantic&&!/>$/.test(e)?n.slice(1):n.slice(1,-1)),Qc(t,{href:n&&n.replace(this.rules.inline.anyPunctuation,`$1`),title:r&&r.replace(this.rules.inline.anyPunctuation,`$1`)},t[0],this.lexer)}}reflink(e,t){let n;if((n=this.rules.inline.reflink.exec(e))||(n=this.rules.inline.nolink.exec(e))){let e=t[(n[2]||n[1]).replace(/\s+/g,` `).toLowerCase()];if(!e){let e=n[0].charAt(0);return{type:`text`,raw:e,text:e}}return Qc(n,e,n[0],this.lexer)}}emStrong(e,t,n=``){let r=this.rules.inline.emStrongLDelim.exec(e);if(r&&!(r[3]&&n.match(/[\p{L}\p{N}]/u))&&(!(r[1]||r[2])||!n||this.rules.inline.punctuation.exec(n))){let n=[...r[0]].length-1,i,a,o=n,s=0,c=r[0][0]===`*`?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(c.lastIndex=0,t=t.slice(-1*e.length+n);(r=c.exec(t))!=null;){if(i=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!i)continue;if(a=[...i].length,r[3]||r[4]){o+=a;continue}else if((r[5]||r[6])&&n%3&&!((n+a)%3)){s+=a;continue}if(o-=a,o>0)continue;a=Math.min(a,a+o+s);let t=[...r[0]][0].length,c=e.slice(0,n+r.index+t+a);if(Math.min(n,a)%2){let e=c.slice(1,-1);return{type:`em`,raw:c,text:e,tokens:this.lexer.inlineTokens(e)}}let l=c.slice(2,-2);return{type:`strong`,raw:c,text:l,tokens:this.lexer.inlineTokens(l)}}}}codespan(e){let t=this.rules.inline.code.exec(e);if(t){let e=t[2].replace(/\n/g,` `),n=/[^ ]/.test(e),r=/^ /.test(e)&&/ $/.test(e);return n&&r&&(e=e.substring(1,e.length-1)),e=Uc(e,!0),{type:`codespan`,raw:t[0],text:e}}}br(e){let t=this.rules.inline.br.exec(e);if(t)return{type:`br`,raw:t[0]}}del(e){let t=this.rules.inline.del.exec(e);if(t)return{type:`del`,raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(e){let t=this.rules.inline.autolink.exec(e);if(t){let e,n;return t[2]===`@`?(e=Uc(t[1]),n=`mailto:`+e):(e=Uc(t[1]),n=e),{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}url(e){let t;if(t=this.rules.inline.url.exec(e)){let e,n;if(t[2]===`@`)e=Uc(t[0]),n=`mailto:`+e;else{let r;do r=t[0],t[0]=this.rules.inline._backpedal.exec(t[0])?.[0]??``;while(r!==t[0]);e=Uc(t[0]),n=t[1]===`www.`?`http://`+t[0]:t[0]}return{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}inlineText(e){let t=this.rules.inline.text.exec(e);if(t){let e;return e=this.lexer.state.inRawBlock?t[0]:Uc(t[0]),{type:`text`,raw:t[0],text:e}}}},tl=/^(?: *(?:\n|$))+/,nl=/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,rl=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,il=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,al=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,ol=/(?:[*+-]|\d{1,9}[.)])/,sl=J(/^(?!bull )((?:.|\n(?!\s*?\n|bull ))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,ol).getRegex(),cl=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,ll=/^[^\n]+/,ul=/(?!\s*\])(?:\\.|[^\[\]\\])+/,dl=J(/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/).replace(`label`,ul).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),fl=J(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,ol).getRegex(),pl=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,ml=/<!--(?!-?>)[\s\S]*?(?:-->|$)/,hl=J(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))`,`i`).replace(`comment`,ml).replace(`tag`,pl).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),gl=J(cl).replace(`hr`,il).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,pl).getRegex(),_l={blockquote:J(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,gl).getRegex(),code:nl,def:dl,fences:rl,heading:al,hr:il,html:hl,lheading:sl,list:fl,newline:tl,paragraph:gl,table:Jc,text:ll},vl=J(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,il).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,` {4}[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,pl).getRegex(),yl={..._l,table:vl,paragraph:J(cl).replace(`hr`,il).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,vl).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,pl).getRegex()},bl={..._l,html:J(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,ml).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Jc,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:J(cl).replace(`hr`,il).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,sl).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},xl=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Sl=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Cl=/^( {2,}|\\)\n(?!\s*$)/,wl=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Tl="\\p{P}$+<=>`^|~",El=J(/^((?![*_])[\spunctuation])/,`u`).replace(/punctuation/g,Tl).getRegex(),Dl=/\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,Ol=J(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/,`u`).replace(/punct/g,Tl).getRegex(),kl=J(`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)[punct](\\*+)(?=[\\s]|$)|[^punct\\s](\\*+)(?!\\*)(?=[punct\\s]|$)|(?!\\*)[punct\\s](\\*+)(?=[^punct\\s])|[\\s](\\*+)(?!\\*)(?=[punct])|(?!\\*)[punct](\\*+)(?!\\*)(?=[punct])|[^punct\\s](\\*+)(?=[^punct\\s])`,`gu`).replace(/punct/g,Tl).getRegex(),Al=J(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\\s]|$)|[^punct\\s](_+)(?!_)(?=[punct\\s]|$)|(?!_)[punct\\s](_+)(?=[^punct\\s])|[\\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])`,`gu`).replace(/punct/g,Tl).getRegex(),jl=J(/\\([punct])/,`gu`).replace(/punct/g,Tl).getRegex(),Ml=J(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Nl=J(ml).replace(`(?:-->|$)`,`-->`).getRegex(),Pl=J(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,Nl).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Fl=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,Il=J(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace(`label`,Fl).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Ll=J(/^!?\[(label)\]\[(ref)\]/).replace(`label`,Fl).replace(`ref`,ul).getRegex(),Rl=J(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,ul).getRegex(),zl={_backpedal:Jc,anyPunctuation:jl,autolink:Ml,blockSkip:Dl,br:Cl,code:Sl,del:Jc,emStrongLDelim:Ol,emStrongRDelimAst:kl,emStrongRDelimUnd:Al,escape:xl,link:Il,nolink:Rl,punctuation:El,reflink:Ll,reflinkSearch:J(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,Ll).replace(`nolink`,Rl).getRegex(),tag:Pl,text:wl,url:Jc},Bl={...zl,link:J(/^!?\[(label)\]\((.*?)\)/).replace(`label`,Fl).getRegex(),reflink:J(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,Fl).getRegex()},Vl={...zl,escape:J(xl).replace(`])`,`~|])`).getRegex(),url:J(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,`i`).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},Hl={...Vl,br:J(Cl).replace(`{2,}`,`*`).getRegex(),text:J(Vl.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},Ul={normal:_l,gfm:yl,pedantic:bl},Wl={normal:zl,gfm:Vl,breaks:Hl,pedantic:Bl},Gl=class e{tokens;options;state;tokenizer;inlineQueue;constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||Fc,this.options.tokenizer=this.options.tokenizer||new el,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={block:Ul.normal,inline:Wl.normal};this.options.pedantic?(t.block=Ul.pedantic,t.inline=Wl.pedantic):this.options.gfm&&(t.block=Ul.gfm,this.options.breaks?t.inline=Wl.breaks:t.inline=Wl.gfm),this.tokenizer.rules=t}static get rules(){return{block:Ul,inline:Wl}}static lex(t,n){return new e(n).lex(t)}static lexInline(t,n){return new e(n).inlineTokens(t)}lex(e){e=e.replace(/\r\n|\r/g,`
...
`+e+`</thead>
`+t+`</table>
`}tablerow(e){return`<tr>\n${e}</tr>\n`}tablecell(e,t){let n=t.header?`th`:`td`;return(t.align?`<${n} align="${t.align}">`:`<${n}>`)+e+`</${n}>\n`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return`<br>`}del(e){return`<del>${e}</del>`}link(e,t,n){let r=qc(e);if(r===null)return n;e=r;let i=`<a href="`+e+`"`;return t&&(i+=` title="`+t+`"`),i+=`>`+n+`</a>`,i}image(e,t,n){let r=qc(e);if(r===null)return n;e=r;let i=`<img src="${e}" alt="${n}"`;return t&&(i+=` title="${t}"`),i+=`>`,i}text(e){return e}},ql=class{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,t,n){return``+n}image(e,t,n){return``+n}br(){return``}},Jl=class e{options;renderer;textRenderer;constructor(e){this.options=e||Fc,this.options.renderer=this.options.renderer||new Kl,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new ql}static parse(t,n){return new e(n).parse(t)}static parseInline(t,n){return new e(n).parseInline(t)}parse(e,t=!0){let n=``;for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]){let e=i,t=this.options.extensions.renderers[e.type].call({parser:this},e);if(t!==!1||![`space`,`hr`,`heading`,`code`,`table`,`blockquote`,`list`,`html`,`paragraph`,`text`].includes(e.type)){n+=t||``;continue}}switch(i.type){case`space`:continue;case`hr`:n+=this.renderer.hr();continue;case`heading`:{let e=i;n+=this.renderer.heading(this.parseInline(e.tokens),e.depth,Gc(this.parseInline(e.tokens,this.textRenderer)));continue}case`code`:{let e=i;n+=this.renderer.code(e.text,e.lang,!!e.escaped);continue}case`table`:{let e=i,t=``,r=``;for(let t=0;t<e.header.length;t++)r+=this.renderer.tablecell(this.parseInline(e.header[t].tokens),{header:!0,align:e.align[t]});t+=this.renderer.tablerow(r);let a=``;for(let t=0;t<e.rows.length;t++){let n=e.rows[t];r=``;for(let t=0;t<n.length;t++)r+=this.renderer.tablecell(this.parseInline(n[t].tokens),{header:!1,align:e.align[t]});a+=this.renderer.tablerow(r)}n+=this.renderer.table(t,a);continue}case`blockquote`:{let e=i,t=this.parse(e.tokens);n+=this.renderer.blockquote(t);continue}case`list`:{let e=i,t=e.ordered,r=e.start,a=e.loose,o=``;for(let t=0;t<e.items.length;t++){let n=e.items[t],r=n.checked,i=n.task,s=``;if(n.task){let e=this.renderer.checkbox(!!r);a?n.tokens.length>0&&n.tokens[0].type===`paragraph`?(n.tokens[0].text=e+` `+n.tokens[0].text,n.tokens[0].tokens&&n.tokens[0].tokens.length>0&&n.tokens[0].tokens[0].type===`text`&&(n.tokens[0].tokens[0].text=e+` `+n.tokens[0].tokens[0].text)):n.tokens.unshift({type:`text`,text:e+` `}):s+=e+` `}s+=this.parse(n.tokens,a),o+=this.renderer.listitem(s,i,!!r)}n+=this.renderer.list(o,t,r);continue}case`html`:{let e=i;n+=this.renderer.html(e.text,e.block);continue}case`paragraph`:{let e=i;n+=this.renderer.paragraph(this.parseInline(e.tokens));continue}case`text`:{let a=i,o=a.tokens?this.parseInline(a.tokens):a.text;for(;r+1<e.length&&e[r+1].type===`text`;)a=e[++r],o+=`
`+(a.tokens?this.parseInline(a.tokens):a.text);n+=t?this.renderer.paragraph(o):o;continue}default:{let e=`Token with "`+i.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return n}parseInline(e,t){t||=this.renderer;let n=``;for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]){let e=this.options.extensions.renderers[i.type].call({parser:this},i);if(e!==!1||![`escape`,`html`,`link`,`image`,`strong`,`em`,`codespan`,`br`,`del`,`text`].includes(i.type)){n+=e||``;continue}}switch(i.type){case`escape`:{let e=i;n+=t.text(e.text);break}case`html`:{let e=i;n+=t.html(e.text);break}case`link`:{let e=i;n+=t.link(e.href,e.title,this.parseInline(e.tokens,t));break}case`image`:{let e=i;n+=t.image(e.href,e.title,e.text);break}case`strong`:{let e=i;n+=t.strong(this.parseInline(e.tokens,t));break}case`em`:{let e=i;n+=t.em(this.parseInline(e.tokens,t));break}case`codespan`:{let e=i;n+=t.codespan(e.text);break}case`br`:n+=t.br();break;case`del`:{let e=i;n+=t.del(this.parseInline(e.tokens,t));break}case`text`:{let e=i;n+=t.text(e.text);break}default:{let e=`Token with "`+i.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return n}},Yl=class{options;constructor(e){this.options=e||Fc}static passThroughHooks=new Set([`preprocess`,`postprocess`,`processAllTokens`]);preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}},Xl=new class{defaults=Pc();options=this.setOptions;parse=this.#e(Gl.lex,Jl.parse);parseInline=this.#e(Gl.lexInline,Jl.parseInline);Parser=Jl;Renderer=Kl;TextRenderer=ql;Lexer=Gl;Tokenizer=el;Hooks=Yl;constructor(...e){this.use(...e)}walkTokens(e,t){let n=[];for(let r of e)switch(n=n.concat(t.call(this,r)),r.type){case`table`:{let e=r;for(let r of e.header)n=n.concat(this.walkTokens(r.tokens,t));for(let r of e.rows)for(let e of r)n=n.concat(this.walkTokens(e.tokens,t));break}case`list`:{let e=r;n=n.concat(this.walkTokens(e.items,t));break}default:{let e=r;this.defaults.extensions?.childTokens?.[e.type]?this.defaults.extensions.childTokens[e.type].forEach(r=>{let i=e[r].flat(1/0);n=n.concat(this.walkTokens(i,t))}):e.tokens&&(n=n.concat(this.walkTokens(e.tokens,t)))}}return n}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(e=>{let n={...e};if(n.async=this.defaults.async||n.async||!1,e.extensions&&(e.extensions.forEach(e=>{if(!e.name)throw Error(`extension name required`);if(`renderer`in e){let n=t.renderers[e.name];n?t.renderers[e.name]=function(...t){let r=e.renderer.apply(this,t);return r===!1&&(r=n.apply(this,t)),r}:t.renderers[e.name]=e.renderer}if(`tokenizer`in e){if(!e.level||e.level!==`block`&&e.level!==`inline`)throw Error(`extension level must be 'block' or 'inline'`);let n=t[e.level];n?n.unshift(e.tokenizer):t[e.level]=[e.tokenizer],e.start&&(e.level===`block`?t.startBlock?t.startBlock.push(e.start):t.startBlock=[e.start]:e.level===`inline`&&(t.startInline?t.startInline.push(e.start):t.startInline=[e.start]))}`childTokens`in e&&e.childTokens&&(t.childTokens[e.name]=e.childTokens)}),n.extensions=t),e.renderer){let t=this.defaults.renderer||new Kl(this.defaults);for(let n in e.renderer){if(!(n in t))throw Error(`renderer '${n}' does not exist`);if(n===`options`)continue;let r=n,i=e.renderer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n||``}}n.renderer=t}if(e.tokenizer){let t=this.defaults.tokenizer||new el(this.defaults);for(let n in e.tokenizer){if(!(n in t))throw Error(`tokenizer '${n}' does not exist`);if([`options`,`rules`,`lexer`].includes(n))continue;let r=n,i=e.tokenizer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.tokenizer=t}if(e.hooks){let t=this.defaults.hooks||new Yl;for(let n in e.hooks){if(!(n in t))throw Error(`hook '${n}' does not exist`);if(n===`options`)continue;let r=n,i=e.hooks[r],a=t[r];Yl.passThroughHooks.has(n)?t[r]=e=>{if(this.defaults.async)return Promise.resolve(i.call(t,e)).then(e=>a.call(t,e));let n=i.call(t,e);return a.call(t,n)}:t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.hooks=t}if(e.walkTokens){let t=this.defaults.walkTokens,r=e.walkTokens;n.walkTokens=function(e){let n=[];return n.push(r.call(this,e)),t&&(n=n.concat(t.call(this,e))),n}}this.defaults={...this.defaults,...n}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return Gl.lex(e,t??this.defaults)}parser(e,t){return Jl.parse(e,t??this.defaults)}#e(e,t){return(n,r)=>{let i={...r},a={...this.defaults,...i};this.defaults.async===!0&&i.async===!1&&(a.silent||console.warn(`marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored.`),a.async=!0);let o=this.#t(!!a.silent,!!a.async);if(n==null)return o(Error(`marked(): input parameter is undefined or null`));if(typeof n!=`string`)return o(Error(`marked(): input parameter is of type `+Object.prototype.toString.call(n)+`, string expected`));if(a.hooks&&(a.hooks.options=a),a.async)return Promise.resolve(a.hooks?a.hooks.preprocess(n):n).then(t=>e(t,a)).then(e=>a.hooks?a.hooks.processAllTokens(e):e).then(e=>a.walkTokens?Promise.all(this.walkTokens(e,a.walkTokens)).then(()=>e):e).then(e=>t(e,a)).then(e=>a.hooks?a.hooks.postprocess(e):e).catch(o);try{a.hooks&&(n=a.hooks.preprocess(n));let r=e(n,a);a.hooks&&(r=a.hooks.processAllTokens(r)),a.walkTokens&&this.walkTokens(r,a.walkTokens);let i=t(r,a);return a.hooks&&(i=a.hooks.postprocess(i)),i}catch(e){return o(e)}}}#t(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+Uc(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function Y(e,t){return Xl.parse(e,t)}Y.options=Y.setOptions=function(e){return Xl.setOptions(e),Y.defaults=Xl.defaults,Ic(Y.defaults),Y},Y.getDefaults=Pc,Y.defaults=Fc,Y.use=function(...e){return Xl.use(...e),Y.defaults=Xl.defaults,Ic(Y.defaults),Y},Y.walkTokens=function(e,t){return Xl.walkTokens(e,t)},Y.parseInline=Xl.parseInline,Y.Parser=Jl,Y.parser=Jl.parse,Y.Renderer=Kl,Y.TextRenderer=ql,Y.Lexer=Gl,Y.lexer=Gl.lex,Y.Tokenizer=el,Y.Hooks=Yl,Y.parse=Y,Y.options,Y.setOptions,Y.use,Y.walkTokens,Y.parseInline,Jl.parse,Gl.lex,Y.use({gfm:!0,breaks:!1});function X(e,t={}){if(!e)return w;let n=t.inline?Y.parseInline(e,{async:!1}):Y.parse(e,{async:!1}),r=t.className??(t.inline?`pp-markdown-inline`:`pp-markdown`);return t.inline?C`<span class=${r}>${To(String(n))}</span>`:C`<div class=${r}>${To(String(n))}</div>`}function Zl(e,t=!1){let n=C`<a class="ref-link" href=${zs(e.typeSlug,e.slug)}>\u279c ${e.name}</a>`;return t?C`<pp-ref-popover registry-key="${e.componentType}/${e.name}">${n}</pp-ref-popover>`:n}function Ql(e,t){if(!e)return w;if(e.allOf&&Array.isArray(e.allOf)){let n=[],r=!0;for(let t of e.allOf){if(!t.$ref){r=!1;continue}let e=jc(t.$ref);e&&n.push({ref:t.$ref,link:e})}if(r&&n.length>0)return C`<span class="prop-type prop-type-link">
                ${n.map((e,n)=>C`
                    ${n>0?C` <span class="composition-separator">+</span> `:w}
                    ${t(e.ref,e.link)}
                `)}
            </span>`}if(e.type===`array`&&e.items?.allOf&&Array.isArray(e.items.allOf)){let n=[],r=!0;for(let t of e.items.allOf){if(!t.$ref){r=!1;continue}let e=jc(t.$ref);e&&n.push({ref:t.$ref,link:e})}if(r&&n.length>0)return C`<span class="prop-type prop-type-link">Array&lt;${n.map((e,n)=>C`
                ${n>0?C` <span class="composition-separator">+</span> `:w}
                ${t(e.ref,e.link)}
            `)}&gt;</span>`}if(e.type===`array`&&e.items?.$ref){let n=jc(e.items.$ref);if(n)return C`<span class="prop-type prop-type-link">Array&lt;${t(e.items.$ref,n)}&gt;</span>`}let n=e.oneOf??e.anyOf;if(n&&Array.isArray(n)){let e=[],r=!0;for(let t of n){if(!t.$ref){r=!1;break}let n=jc(t.$ref);n&&e.push({ref:t.$ref,link:n})}if(r&&e.length>0)return C`<span class="prop-type prop-type-link">
                ${e.map((e,n)=>C`
                    ${n>0?C` <span class="composition-separator">|</span> `:w}
                    ${t(e.ref,e.link)}
                `)}
            </span>`;let i=n.map(e=>e.title).filter(Boolean);if(i.length===n.length)return C`<span class="prop-type">${i.join(` | `)}</span>`}if(e.$ref){let n=jc(e.$ref);if(n)return C`<span class="prop-type prop-type-link">${t(e.$ref,n)}</span>`}let r=Nc(e);return r?C`<span class="prop-type">${r}</span>`:w}function $l(e,t){if(!e)return w;let n=Mc(e,{includeExample:t?.includeExample});if(!n.length&&!e.enum?.length)return w;let r=t?.labelSuffix??``;return C`
        <div class="constraints">
            ${n.map(e=>C`
                <span class="constraint-label">${e.label}${r}</span>
                <span class="constraint-value">${e.isCode?C`<code>${e.value}</code>`:e.value}</span>
            `)}
            ${e.enum?.length?C`
                <div class="enum-section">
                    <span class="constraint-label">enum${r}</span>
                    <div class="enum-grid">${e.enum.map(e=>C`<span class="enum-value">${JSON.stringify(e)}</span>`)}</div>
                </div>
            `:w}
        </div>
    `}var eu=S`
...
`,ru=class extends N{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit(`sl-resize`,{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){let e=this.shadowRoot.querySelector(`slot`);if(e!==null){let t=e.assignedElements({flatten:!0});this.observedElements.forEach(e=>this.resizeObserver.unobserve(e)),this.observedElements=[],t.forEach(e=>{this.resizeObserver.observe(e),this.observedElements.push(e)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return C` <slot @slotchange=${this.handleSlotChange}></slot> `}};ru.styles=[O,nu],E([A({type:Boolean,reflect:!0})],ru.prototype,`disabled`,2),E([D(`disabled`,{waitUntilFirstUpdate:!0})],ru.prototype,`handleDisabledChange`,1);var Z=class extends N{constructor(){super(...arguments),this.tabs=[],this.focusableTabs=[],this.panels=[],this.localize=new L(this),this.hasScrollControls=!1,this.shouldHideScrollStartButton=!1,this.shouldHideScrollEndButton=!1,this.placement=`top`,this.activation=`auto`,this.noScrollControls=!1,this.fixedScrollControls=!1,this.scrollOffset=1}connectedCallback(){let e=Promise.all([customElements.whenDefined(`sl-tab`),customElements.whenDefined(`sl-tab-panel`)]);super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.repositionIndicator(),this.updateScrollControls()}),this.mutationObserver=new MutationObserver(e=>{let t=e.filter(({target:e})=>{if(e===this)return!0;if(e.closest(`sl-tab-group`)!==this)return!1;let t=e.tagName.toLowerCase();return t===`sl-tab`||t===`sl-tab-panel`});if(t.length!==0){if(t.some(e=>![`aria-labelledby`,`aria-controls`].includes(e.attributeName))&&setTimeout(()=>this.setAriaLabels()),t.some(e=>e.attributeName===`disabled`))this.syncTabsAndPanels();else if(t.some(e=>e.attributeName===`active`)){let e=t.filter(e=>e.attributeName===`active`&&e.target.tagName.toLowerCase()===`sl-tab`).map(e=>e.target).find(e=>e.active);e&&this.setActiveTab(e)}}}),this.updateComplete.then(()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,attributeFilter:[`active`,`disabled`,`name`,`panel`],childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),e.then(()=>{new IntersectionObserver((e,t)=>{e[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab(this.getActiveTab()??this.tabs[0],{emitEvents:!1}),t.unobserve(e[0].target))}).observe(this.tabGroup)})})}disconnectedCallback(){var e,t;super.disconnectedCallback(),(e=this.mutationObserver)==null||e.disconnect(),this.nav&&((t=this.resizeObserver)==null||t.unobserve(this.nav))}getAllTabs(){return this.shadowRoot.querySelector(`slot[name="nav"]`).assignedElements()}getAllPanels(){return[...this.body.assignedElements()].filter(e=>e.tagName.toLowerCase()===`sl-tab-panel`)}getActiveTab(){return this.tabs.find(e=>e.active)}handleClick(e){let t=e.target.closest(`sl-tab`);t?.closest(`sl-tab-group`)===this&&t!==null&&this.setActiveTab(t,{scrollBehavior:`smooth`})}handleKeyDown(e){let t=e.target.closest(`sl-tab`);if(t?.closest(`sl-tab-group`)===this&&([`Enter`,` `].includes(e.key)&&t!==null&&(this.setActiveTab(t,{scrollBehavior:`smooth`}),e.preventDefault()),[`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`].includes(e.key))){let t=this.tabs.find(e=>e.matches(`:focus`)),n=this.localize.dir()===`rtl`,r=null;if(t?.tagName.toLowerCase()===`sl-tab`){if(e.key===`Home`)r=this.focusableTabs[0];else if(e.key===`End`)r=this.focusableTabs[this.focusableTabs.length-1];else if([`top`,`bottom`].includes(this.placement)&&e.key===(n?`ArrowRight`:`ArrowLeft`)||[`start`,`end`].includes(this.placement)&&e.key===`ArrowUp`){let e=this.tabs.findIndex(e=>e===t);r=this.findNextFocusableTab(e,`backward`)}else if([`top`,`bottom`].includes(this.placement)&&e.key===(n?`ArrowLeft`:`ArrowRight`)||[`start`,`end`].includes(this.placement)&&e.key===`ArrowDown`){let e=this.tabs.findIndex(e=>e===t);r=this.findNextFocusableTab(e,`forward`)}if(!r)return;r.tabIndex=0,r.focus({preventScroll:!0}),this.activation===`auto`?this.setActiveTab(r,{scrollBehavior:`smooth`}):this.tabs.forEach(e=>{e.tabIndex=e===r?0:-1}),[`top`,`bottom`].includes(this.placement)&&Ha(r,this.nav,`horizontal`),e.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.localize.dir()===`rtl`?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:`smooth`})}handleScrollToEnd(){this.nav.scroll({left:this.localize.dir()===`rtl`?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:`smooth`})}setActiveTab(e,t){if(t=Cn({emitEvents:!0,scrollBehavior:`auto`},t),e!==this.activeTab&&!e.disabled){let n=this.activeTab;this.activeTab=e,this.tabs.forEach(e=>{e.active=e===this.activeTab,e.tabIndex=e===this.activeTab?0:-1}),this.panels.forEach(e=>e.active=e.name===this.activeTab?.panel),this.syncIndicator(),[`top`,`bottom`].includes(this.placement)&&Ha(this.activeTab,this.nav,`horizontal`,t.scrollBehavior),t.emitEvents&&(n&&this.emit(`sl-tab-hide`,{detail:{name:n.panel}}),this.emit(`sl-tab-show`,{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach(e=>{let t=this.panels.find(t=>t.name===e.panel);t&&(e.setAttribute(`aria-controls`,t.getAttribute(`id`)),t.setAttribute(`aria-labelledby`,e.getAttribute(`id`)))})}repositionIndicator(){let e=this.getActiveTab();if(!e)return;let t=e.clientWidth,n=e.clientHeight,r=this.localize.dir()===`rtl`,i=this.getAllTabs(),a=i.slice(0,i.indexOf(e)).reduce((e,t)=>({left:e.left+t.clientWidth,top:e.top+t.clientHeight}),{left:0,top:0});switch(this.placement){case`top`:case`bottom`:this.indicator.style.width=`${t}px`,this.indicator.style.height=`auto`,this.indicator.style.translate=r?`${-1*a.left}px`:`${a.left}px`;break;case`start`:case`end`:this.indicator.style.width=`auto`,this.indicator.style.height=`${n}px`,this.indicator.style.translate=`0 ${a.top}px`;break}}syncTabsAndPanels(){this.tabs=this.getAllTabs(),this.focusableTabs=this.tabs.filter(e=>!e.disabled),this.panels=this.getAllPanels(),this.syncIndicator(),this.updateComplete.then(()=>this.updateScrollControls())}findNextFocusableTab(e,t){let n=null,r=t===`forward`?1:-1,i=e+r;for(;e<this.tabs.length;){if(n=this.tabs[i]||null,n===null){n=t===`forward`?this.focusableTabs[0]:this.focusableTabs[this.focusableTabs.length-1];break}if(!n.disabled)break;i+=r}return n}updateScrollButtons(){this.hasScrollControls&&!this.fixedScrollControls&&(this.shouldHideScrollStartButton=this.scrollFromStart()<=this.scrollOffset,this.shouldHideScrollEndButton=this.isScrolledToEnd())}isScrolledToEnd(){return this.scrollFromStart()+this.nav.clientWidth>=this.nav.scrollWidth-this.scrollOffset}scrollFromStart(){return this.localize.dir()===`rtl`?-this.nav.scrollLeft:this.nav.scrollLeft}updateScrollControls(){this.noScrollControls?this.hasScrollControls=!1:this.hasScrollControls=[`top`,`bottom`].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth+1,this.updateScrollButtons()}syncIndicator(){this.getActiveTab()?(this.indicator.style.display=`block`,this.repositionIndicator()):this.indicator.style.display=`none`}show(e){let t=this.tabs.find(t=>t.panel===e);t&&this.setActiveTab(t,{scrollBehavior:`smooth`})}render(){let e=this.localize.dir()===`rtl`;return C`
    ...
    `}};Z.styles=[O,tu],Z.dependencies={"sl-icon-button":I,"sl-resize-observer":ru},E([M(`.tab-group`)],Z.prototype,`tabGroup`,2),E([M(`.tab-group__body`)],Z.prototype,`body`,2),E([M(`.tab-group__nav`)],Z.prototype,`nav`,2),E([M(`.tab-group__indicator`)],Z.prototype,`indicator`,2),E([j()],Z.prototype,`hasScrollControls`,2),E([j()],Z.prototype,`shouldHideScrollStartButton`,2),E([j()],Z.prototype,`shouldHideScrollEndButton`,2),E([A()],Z.prototype,`placement`,2),E([A()],Z.prototype,`activation`,2),E([A({attribute:`no-scroll-controls`,type:Boolean})],Z.prototype,`noScrollControls`,2),E([A({attribute:`fixed-scroll-controls`,type:Boolean})],Z.prototype,`fixedScrollControls`,2),E([Nn({passive:!0})],Z.prototype,`updateScrollButtons`,1),E([D(`noScrollControls`,{waitUntilFirstUpdate:!0})],Z.prototype,`updateScrollControls`,1),E([D(`placement`,{waitUntilFirstUpdate:!0})],Z.prototype,`syncIndicator`,1),Z.define(`sl-tab-group`);var iu=(e,t)=>{let n=0;return function(...r){window.clearTimeout(n),n=window.setTimeout(()=>{e.call(this,...r)},t)}},au=(e,t,n)=>{let r=e[t];e[t]=function(...e){r.call(this,...e),n.call(this,r,...e)}};(()=>{if(!(typeof window>`u`)&&!(`onscrollend`in window)){let e=new Set,t=new WeakMap,n=t=>{for(let n of t.changedTouches)e.add(n.identifier)},r=t=>{for(let n of t.changedTouches)e.delete(n.identifier)};document.addEventListener(`touchstart`,n,!0),document.addEventListener(`touchend`,r,!0),document.addEventListener(`touchcancel`,r,!0),au(EventTarget.prototype,`addEventListener`,function(n,r){if(r!==`scrollend`)return;let i=iu(()=>{e.size?i():this.dispatchEvent(new Event(`scrollend`))},100);n.call(this,`scroll`,i,{passive:!0}),t.set(this,i)}),au(EventTarget.prototype,`removeEventListener`,function(e,n){if(n!==`scrollend`)return;let r=t.get(this);r&&e.call(this,`scroll`,r,{passive:!0})})}})();var ou=S`
  :host {
    display: inline-block;
  }
...
`,su=0,cu=class extends N{constructor(){super(...arguments),this.localize=new L(this),this.attrId=++su,this.componentId=`sl-tab-${this.attrId}`,this.panel=``,this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`tab`)}handleCloseClick(e){e.stopPropagation(),this.emit(`sl-close`)}handleActiveChange(){this.setAttribute(`aria-selected`,this.active?`true`:`false`)}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,C`
      <div
        part="base"
    ...
    `}};cu.styles=[O,ou],cu.dependencies={"sl-icon-button":I},E([M(`.tab`)],cu.prototype,`tab`,2),E([A({reflect:!0})],cu.prototype,`panel`,2),E([A({type:Boolean,reflect:!0})],cu.prototype,`active`,2),E([A({type:Boolean,reflect:!0})],cu.prototype,`closable`,2),E([A({type:Boolean,reflect:!0})],cu.prototype,`disabled`,2),E([A({type:Number,reflect:!0})],cu.prototype,`tabIndex`,2),E([D(`active`)],cu.prototype,`handleActiveChange`,1),E([D(`disabled`)],cu.prototype,`handleDisabledChange`,1),cu.define(`sl-tab`);var lu=S`
  :host {
    --padding: 0;
...
`,uu=0,du=class extends N{constructor(){super(...arguments),this.attrId=++uu,this.componentId=`sl-tab-panel-${this.attrId}`,this.name=``,this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute(`role`,`tabpanel`)}handleActiveChange(){this.setAttribute(`aria-hidden`,this.active?`false`:`true`)}render(){return C`
      <slot
        part="base"
        class=${P({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};du.styles=[O,lu],E([A({reflect:!0})],du.prototype,`name`,2),E([A({type:Boolean,reflect:!0})],du.prototype,`active`,2),E([D(`active`)],du.prototype,`handleActiveChange`,1),du.define(`sl-tab-panel`);var fu=[ks,S`
    :host {
        display: block;
        margin-top: var(--global-padding);
...
`],pu=class extends T{constructor(...e){super(...e),this.schemaJson=``,this.compact=!1,this.condensed=!1,this.schema=null}static{this.styles=[wc,Tc,...fu]}willUpdate(e){if(e.has(`schemaJson`)&&this.schemaJson)try{this.schema=JSON.parse(this.schemaJson),this.computeNameColumnWidth(),this.primeReferencedSchemas(this.schema)}catch{this.schema=null}}async primeReferencedSchemas(e){await ie(e),this.requestUpdate()}parseRegistrySchema(e,t){if(t.has(e))return null;let n=v(e);if(!n?.schemaJson)return null;try{return t.add(e),JSON.parse(n.schemaJson)}catch{return null}}resolveRenderableTarget(e,t=new Set){return e?.$ref?this.parseRegistrySchema(e.$ref,t)??e:e}collectRenderedNameMetrics(e,t=new Set){if(!e||typeof e!=`object`)return{maxLen:0,hasRequired:!1};let n=0,r=!1,i=e.properties,a=new Set(e.required??[]);if(i&&typeof i==`object`)for(let[e,o]of Object.entries(i)){n=Math.max(n,e.length),a.has(e)&&(r=!0);let i=this.collectRenderedNameMetrics(o,t);n=Math.max(n,i.maxLen),r||=i.hasRequired}for(let i of[`allOf`,`oneOf`,`anyOf`]){let a=e[i];if(Array.isArray(a))for(let e of a){if(e?.$ref){let i=this.parseRegistrySchema(e.$ref,t);if(!i)continue;let a=this.collectRenderedNameMetrics(i,t);n=Math.max(n,a.maxLen),r||=a.hasRequired;continue}let i=this.collectRenderedNameMetrics(e,t);n=Math.max(n,i.maxLen),r||=i.hasRequired}}if(e.items){let i=e.items;if(i.$ref){let e=this.parseRegistrySchema(i.$ref,t);if(e){let i=this.collectRenderedNameMetrics(e,t);n=Math.max(n,i.maxLen),r||=i.hasRequired}}else{let e=this.collectRenderedNameMetrics(i,t);n=Math.max(n,e.maxLen),r||=e.hasRequired}}return{maxLen:n,hasRequired:r}}computeNameColumnWidth(){if(!this.schema)return;let{maxLen:e}=this.collectRenderedNameMetrics(this.schema),t=e*10.5,n=Math.max(180,62+t+20);this.style.setProperty(`--compact-name-width`,`${Math.round(n)}px`)}renderRefAnchor(e,t){return C`
        ...
        `}renderPropertyTable(e,t){let n=Object.entries(e);return n.length?n.map(([e,n])=>{let r=n.oneOf??n.anyOf;return r&&Array.isArray(r)?C`
                    <div class="property-oneof">
                        ${this.renderOneOf(r,e,n.description,t.has(e),`polymorphic`)}
                    </div>
                `:this.renderPropertyRow(e,n,t)}):w}renderCompositionRefs(e){return C`
            <div class="composition-refs">
                <span class="composition-label">Composed from</span>
                ${e.map(e=>{let t=jc(e.$ref);if(!t)return w;let n=ne(e.$ref)?.description??``;return C`
                        <div class="composition-ref-entry">
                            <span class="composition-ref-link">${this.renderRefAnchor(e.$ref,t)}</span>
                            ${n?X(n,{className:`composition-ref-desc pp-markdown`}):w}
                        </div>
                    `})}
            </div>
        `}mergePropertyMaps(e,t){for(let[n,r]of Object.entries(t))e[n]=r}collectCompositionData(e,t=new Set){let n=[],r=new Set(e?.required||[]),i={};e?.properties&&this.mergePropertyMaps(i,e.properties);let a=Array.isArray(e?.allOf)?e.allOf:[];for(let e of a){if(e?.$ref){n.push(e);let a=this.parseRegistrySchema(e.$ref,t);if(!a)continue;let o=this.collectCompositionData(a,t);o.refEntries.length&&n.push(...o.refEntries),this.mergePropertyMaps(i,o.mergedProperties);for(let e of o.mergedRequired)r.add(e);continue}if(e?.allOf&&Array.isArray(e.allOf)){let a=this.collectCompositionData(e,t);a.refEntries.length&&n.push(...a.refEntries),this.mergePropertyMaps(i,a.mergedProperties);for(let e of a.mergedRequired)r.add(e);continue}if(e?.properties&&this.mergePropertyMaps(i,e.properties),e?.required)for(let t of e.required)r.add(t)}return{refEntries:n,mergedRequired:r,mergedProperties:i}}renderComposition(e){let{refEntries:t,mergedRequired:n,mergedProperties:r}=this.collectCompositionData(e),i=t.filter((e,n)=>e?.$ref&&t.findIndex(t=>t?.$ref===e.$ref)===n);return C`
            ${i.length?this.renderCompositionRefs(i):w}
            ${Object.keys(r).length?this.renderPropertyTable(r,n):w}
        `}renderOneOf(e,t,n,r,i){return e.length?C`
            <div class="oneof-property">
                <div class="oneof-left">
                    ${t?C`
                        <div class="oneof-prop-name">
                            ${r?C`<span class="required-badge">req</span>`:w}
                            <span class="prop-name">${t}</span>
                            ${i?C`<div class="composition-label polymorphic">(${i})</div>`:w}
                        </div>
                    `:w}
                    ${n?X(n,{className:`oneof-prop-desc pp-markdown`}):w}
                </div>
        ...
        `:w}renderOneOfOption(e){if(e.$ref){let t=jc(e.$ref);if(!t)return w;let n=ne(e.$ref);return C`
                <div class="oneof-option-header">
                    ${this.renderRefAnchor(e.$ref,t)}
                    ${n?.description?X(n.description,{className:`oneof-option-desc pp-markdown`}):w}
                </div>
            `}let t=new Set(e.required||[]),n=Nc(e);return C`
            ${e.description?X(e.description,{className:`oneof-option-desc pp-markdown`}):w}
            ${e.properties?this.renderPropertyTable(e.properties,t):n?C`<div class="oneof-option-scalar"><span class="prop-type">${n}</span>${$l(e,{labelSuffix:`:`})}</div>`:w}
        `}render(){if(!this.schema)return w;let e=this.schema.type===`array`&&(this.schema.items?.properties||this.schema.items?.allOf||this.schema.items?.oneOf||this.schema.items?.anyOf)?this.schema.items:this.schema,t=this.resolveRenderableTarget(e);if(t.allOf&&Array.isArray(t.allOf))return this.renderComposition(t);if(t.oneOf&&Array.isArray(t.oneOf))return this.renderOneOf(t.oneOf,`ONE OF`,void 0,void 0,`polymorphic`);if(t.anyOf&&Array.isArray(t.anyOf))return this.renderOneOf(t.anyOf,`ANY OF`,void 0,void 0,`polymorphic`);let n=t.properties||{},r=new Set(t.required||[]);if(!Object.entries(n).length){let e=Nc(t);return!e&&!t.description?w:C`
                <div class="property scalar">
                    <div class="prop-type-col">
                        ${e?C`<span class="prop-type">${e}</span>`:w}
                        ${$l(t,{labelSuffix:`:`})}
                    </div>
                    <div class="prop-desc-col">
                        ${X(t.description)}
...
`;mu.default.manual=!0,mu.default.languages.mermaid&&!mu.default.languages.mermaid[`class-declaration`]&&(mu.default.languages.insertBefore(`mermaid`,`keyword`,{"class-declaration":{pattern:/(^[ \t]*)class[ \t]+[\w$-]+/m,lookbehind:!0,inside:{keyword:/^class/,"class-name":/[\w$-]+$/}}}),mu.default.languages.insertBefore(`mermaid`,`punctuation`,{"class-member":{pattern:/^[ \t]*[+\-#~][\w$-]+\??(?:[ \t]+[\w$-]+)?/m,inside:{builtin:{pattern:/(^[ \t]*[+\-#~])[\w$-]+\??/,lookbehind:!0},property:{pattern:/(\s)[\w$-]+$/,lookbehind:!0},operator:/^[ \t]*[+\-#~]/}},annotation:{pattern:/<<[^>\r\n]+>>/,alias:`comment`}}));var gu=class extends T{constructor(...e){super(...e),this.code=``,this.language=`json`,this.pretty=!1,this.lineNumbers=!1,this.highlightLines=``,this.startLine=1,this.location=``,this.embedded=!1,this.reserveLocation=!1,this.selectedLines=new Set,this.lastClickedLine=null,this._segmentCache={code:``,language:``,segments:[]},this._highlightCache={spec:``,parsed:new Set}}static{this.styles=[hu]}get displayCode(){if(!this.code)return``;if(this.pretty&&this.language===`json`)try{return JSON.stringify(JSON.parse(this.code),null,2)}catch{return this.code}return this.code}parseHighlightSpec(e){let t=new Set;if(!e)return t;for(let n of e.split(`,`)){let e=n.trim().match(/^(\d+)(?:-(\d+))?$/);if(!e)continue;let r=parseInt(e[1],10),i=e[2]?parseInt(e[2],10):r;for(let e=Math.min(r,i);e<=Math.max(r,i);e++)t.add(e)}return t}highlightCode(){let e=this.displayCode;if(!e)return``;try{let t=this.language===`xml`?`markup`:this.language;return mu.default.highlight(e,mu.default.languages[t],t)}catch{return e}}splitHighlightedLines(e){let t=[],n=``,r=[],i=0;for(;i<e.length;)if(e[i]===`
`){for(let e=r.length-1;e>=0;e--)n+=`</span>`;t.push(n),n=r.join(``),i++}else if(e[i]===`<`)if(e.startsWith(`</span>`,i))n+=`</span>`,r.pop(),i+=7;else{let t=e.indexOf(`>`,i);if(t===-1){n+=e[i],i++;continue}let a=e.slice(i,t+1);n+=a,a.startsWith(`</`)||r.push(a),i=t+1}else n+=e[i],i++;for(let e=r.length-1;e>=0;e--)n+=`</span>`;return n&&t.push(n),t}getLineSegments(){let e=this.displayCode;if(e===this._segmentCache.code&&this.language===this._segmentCache.language)return this._segmentCache.segments;let t=this.highlightCode(),n=t?this.splitHighlightedLines(t):[];return this._segmentCache={code:e,language:this.language,segments:n},n}get parsedHighlights(){return this._highlightCache.spec!==this.highlightLines&&(this._highlightCache={spec:this.highlightLines,parsed:this.parseHighlightSpec(this.highlightLines)}),this._highlightCache.parsed}get effectiveHighlights(){let e=this.parsedHighlights;return e.size>0?e:this.selectedLines}get isLocked(){return this.parsedHighlights.size>0}scrollToLine(e){this.renderRoot.querySelector(`[data-line="${e}"]`)?.scrollIntoView({block:`center`,behavior:`auto`})}handleLineClick(e,t){if(this.isLocked)return;let n=new Set;if(t.shiftKey&&this.lastClickedLine!==null){let t=Math.min(this.lastClickedLine,e),r=Math.max(this.lastClickedLine,e);for(let e=t;e<=r;e++)n.add(e)}else this.selectedLines.size===1&&this.selectedLines.has(e)||n.add(e);this.selectedLines=n,this.lastClickedLine=e}willUpdate(e){(e.has(`code`)||e.has(`language`))&&(this.selectedLines=new Set,this.lastClickedLine=null)}renderLocation(){return!this.location&&!this.reserveLocation?w:C`<div class="location ${this.location?``:`empty`}">${this.location||`\xA0`}</div>`}render(){if(!this.lineNumbers)return C`
              ${this.renderLocation()}
              <pre class="language-${this.language}"><code>${To(this.highlightCode())}</code></pre>
            `;let e=this.getLineSegments(),t=Math.max(this.startLine,1),n=t+e.length-1,r=n>0?Math.floor(Math.log10(n))+1:1,i=this.effectiveHighlights,a=this.isLocked;return C`
          ${this.renderLocation()}
          <div class="lined-code${a?` locked`:``}" style="--gutter-digits: ${r}">
            <pre class="language-${this.language}"><code>${e.map((e,n)=>{let r=t+n;return C`<span class="line${i.has(r)?` highlighted`:``}" data-line=${r}
                ><span class="line-number"
                       @click=${e=>this.handleLineClick(r,e)}
                >${r}</span><span class="line-content">${To(e||` `)}</span>
</span>`})}</code></pre>
          </div>
        `}};q([A()],gu.prototype,`code`,void 0),q([A()],gu.prototype,`language`,void 0),q([A({type:Boolean})],gu.prototype,`pretty`,void 0),q([A({attribute:`line-numbers`,type:Boolean})],gu.prototype,`lineNumbers`,void 0),q([A({attribute:`highlight-lines`})],gu.prototype,`highlightLines`,void 0),q([A({attribute:`start-line`,type:Number})],gu.prototype,`startLine`,void 0),q([A()],gu.prototype,`location`,void 0),q([A({type:Boolean,reflect:!0})],gu.prototype,`embedded`,void 0),q([A({attribute:`reserve-location`,type:Boolean})],gu.prototype,`reserveLocation`,void 0),q([j()],gu.prototype,`selectedLines`,void 0),q([j()],gu.prototype,`lastClickedLine`,void 0),gu=q([k(`pp-code-viewer`)],gu);var _u=S`
    :host {
        display: flex;
        align-items: flex-start;
        gap: var(--global-padding);
...
`,vu=class extends T{constructor(...e){super(...e),this.icon=``,this.heading=``,this.level=1,this.size=`huge`}static{this.styles=[_u]}render(){if(!this.heading)return w;let e=Zn(`h${Math.min(Math.max(this.level,1),6)}`);return er`
        ...
        `}};q([A()],vu.prototype,`icon`,void 0),q([A()],vu.prototype,`heading`,void 0),q([A({type:Number})],vu.prototype,`level`,void 0),q([A()],vu.prototype,`size`,void 0),vu=q([k(`pp-icon-title`)],vu);var yu,bu=class extends T{static{yu=this}constructor(...e){super(...e),this.registryKey=``,this.schemaRef=``,this.active=!1,this.entry=null,this.model=null,this.parsedData=null,this.triggerTargets=new Set,this.pointerWithinTrigger=!1,this.pointerWithinPopup=!1,this.focusWithinPopup=!1,this.onTriggerEnter=()=>{this.pointerWithinTrigger=!0,this.show()},this.onTriggerLeave=e=>{this.pointerWithinTrigger=!1;let t=e.relatedTarget;this.containsInteractiveNode(t)||this.scheduleHide()},this.onSlotChange=()=>{this.syncTriggerTargets()},this.onPopupEnter=()=>{this.pointerWithinPopup=!0,this.cancelHide()},this.onPopupLeave=e=>{this.pointerWithinPopup=!1;let t=e.relatedTarget;this.containsInteractiveNode(t)||this.scheduleHide()},this.onPopupFocusIn=()=>{this.focusWithinPopup=!0,this.cancelHide()},this.onPopupFocusOut=e=>{let t=e.relatedTarget;this.containsInteractiveNode(t)||(this.focusWithinPopup=!1,this.scheduleHide())},this.onPopupInteraction=()=>{this.pointerWithinPopup=!0,this.cancelHide()}}static{this.styles=eu}static{this.showDelayMs=300}static{this.hideDelayMs=400}firstUpdated(){this.syncTriggerTargets(),this.triggerSlot?.addEventListener(`slotchange`,this.onSlotChange)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.showTimeout),clearTimeout(this.hideTimeout),this.triggerSlot?.removeEventListener(`slotchange`,this.onSlotChange),this.clearTriggerTargets(),this.pointerWithinTrigger=!1,this.pointerWithinPopup=!1,this.focusWithinPopup=!1,this.active=!1}containsInteractiveNode(e){return e?this.contains(e)||this.renderRoot.contains(e):!1}isInteractivelyActive(){return this.pointerWithinTrigger||this.pointerWithinPopup||this.focusWithinPopup}clearTriggerTargets(){for(let e of this.triggerTargets)e.removeEventListener(`mouseenter`,this.onTriggerEnter),e.removeEventListener(`mouseleave`,this.onTriggerLeave),e.removeEventListener(`focusin`,this.onTriggerEnter),e.removeEventListener(`focusout`,this.onTriggerLeave);this.triggerTargets.clear()}syncTriggerTargets(){this.clearTriggerTargets();let e=new Set;this.trigger&&e.add(this.trigger);for(let t of this.triggerSlot?.assignedElements({flatten:!0})??[])t instanceof HTMLElement&&e.add(t);for(let t of e)t.addEventListener(`mouseenter`,this.onTriggerEnter),t.addEventListener(`mouseleave`,this.onTriggerLeave),t.addEventListener(`focusin`,this.onTriggerEnter),t.addEventListener(`focusout`,this.onTriggerLeave),this.triggerTargets.add(t)}show(){clearTimeout(this.hideTimeout),this.showTimeout=window.setTimeout(async()=>{if(this.entry=(this.registryKey?_(this.registryKey):ne(this.schemaRef))??null,this.entry&&(this.model=(this.registryKey?await y(this.registryKey):await b(this.schemaRef))??null,this.model)){try{this.parsedData=JSON.parse(this.model.schemaJson)}catch{this.parsedData=null}this.active=!0}},yu.showDelayMs)}scheduleHide(){clearTimeout(this.showTimeout),this.hideTimeout=window.setTimeout(()=>{this.isInteractivelyActive()||(this.active=!1)},yu.hideDelayMs)}cancelHide(){clearTimeout(this.hideTimeout)}resolveExample(){if(this.model?.mockJson)return this.model.mockJson;let e=this.parsedData;return e?e.schema?.example===void 0?e.example===void 0?Array.isArray(e.examples)&&e.examples.length>0?JSON.stringify(e.examples[0]):null:JSON.stringify(e.example):JSON.stringify(e.schema.example):null}getSchemaJson(){if(!this.model)return``;let e=this.parsedData;return e&&e.schema?JSON.stringify(e.schema):this.model.schemaJson}formatJson(e){try{return JSON.stringify(JSON.parse(e),null,2)}catch{return e}}render(){let e=this.resolveExample(),t=this.getSchemaJson();return C`
            ...
            `:w}
        `}};q([A({attribute:`registry-key`})],bu.prototype,`registryKey`,void 0),q([A({attribute:`schema-ref`})],bu.prototype,`schemaRef`,void 0),q([j()],bu.prototype,`active`,void 0),q([j()],bu.prototype,`entry`,void 0),q([j()],bu.prototype,`model`,void 0),q([j()],bu.prototype,`parsedData`,void 0),q([M(`.trigger`)],bu.prototype,`trigger`,void 0),q([M(`slot`)],bu.prototype,`triggerSlot`,void 0),bu=yu=q([k(`pp-ref-popover`)],bu);var xu=S`
    :host {
        display: block;
    }
...
`,Su=class extends T{constructor(...e){super(...e),this.extensionsJson=``,this.extensions=[]}static{this.styles=xu}willUpdate(e){if(e.has(`extensionsJson`))if(this.extensionsJson)try{this.extensions=JSON.parse(this.extensionsJson)}catch{this.extensions=[]}else this.extensions=[]}renderValue(e){return e==null?w:typeof e==`object`?C`<pp-code-viewer code=${JSON.stringify(e,null,2)} language="json"></pp-code-viewer>`:C`<span class="ext-scalar">${String(e)}</span>`}render(){return this.extensions.length?C`<div class="ext-grid">
      ${this.extensions.map(e=>C`
        <div class="ext-key">${e.key}</div>
        <div class="ext-value">${this.renderValue(e.value)}</div>
      `)}
    </div>`:w}};q([A({attribute:`extensions-json`})],Su.prototype,`extensionsJson`,void 0),q([j()],Su.prototype,`extensions`,void 0),Su=q([k(`pp-extensions`)],Su);var Cu=class extends T{constructor(...e){super(...e),this.parametersJson=``,this.params=[]}static{this.styles=[js,wc,Tc,Ec,Dc]}willUpdate(e){if(e.has(`parametersJson`)&&this.parametersJson)try{this.params=JSON.parse(this.parametersJson)}catch{this.params=[]}}inIcon(e){switch(e){case`cookie`:return`cookie`;case`header`:return`envelope`;case`path`:return`signpost`;case`query`:return`question-diamond`;default:return`question-diamond`}}parseSchema(e){if(!e)return null;try{return JSON.parse(e)}catch{return null}}render(){return this.params.length?C`
      ${this.params.map(e=>{let t=this.parseSchema(e.schemaJson),n=Nc(t);return C`
          <div class="parameter">
            <div class="param-name-col">
              ${e.required?C`<span class="required-badge">req</span>`:w}
              ${e.ref?C`
              ...
              ${e.deprecated?C`<span class="deprecated-badge">deprecated</span>`:w}
            </div>
            <div class="param-type-col">
              ${n?C`<span class="param-type">${n}</span>`:w}
              ${$l(t,{labelSuffix:`:`})}
            </div>
            ...
            ${!e.ref&&(e.rawJson||e.rawYaml)||e.mockJson||e.examples&&Object.keys(e.examples).length>0?C`
                  <div class="param-extras">
                    ${e.mockJson||e.examples&&Object.keys(e.examples).length>0?C`
                          ...
                          </pp-example-selector>`:w}
                  </div>
                `:w}
          </div>
          ${e.extensions?.length?C`
        ...
        `})}
    `:w}};q([A({attribute:`parameters-json`})],Cu.prototype,`parametersJson`,void 0),q([j()],Cu.prototype,`params`,void 0),Cu=q([k(`pp-operation-parameters`)],Cu);var wu=S`
    .status-ok {
        color: var(--primary-color);
        font-family: var(--font-stack-bold), monospace;
    }
...
`;function Du(e){let t=parseInt(e,10);return t>=500?`status-error`:t>=400?`status-warn`:`status-ok`}var Ou={100:`Continue`,101:`Switching Protocols`,102:`Processing`,103:`Early Hints`,200:`OK`,201:`Created`,202:`Accepted`,203:`Non-Authoritative Information`,204:`No Content`,205:`Reset Content`,206:`Partial Content`,207:`Multi-Status`,208:`Already Reported`,226:`IM Used`,300:`Multiple Choices`,301:`Moved Permanently`,302:`Found`,303:`See Other`,304:`Not Modified`,305:`Use Proxy`,307:`Temporary Redirect`,308:`Permanent Redirect`,400:`Bad Request`,401:`Unauthorized`,402:`Payment Required`,403:`Forbidden`,404:`Not Found`,405:`Method Not Allowed`,406:`Not Acceptable`,407:`Proxy Authentication Required`,408:`Request Timeout`,409:`Conflict`,410:`Gone`,411:`Length Required`,412:`Precondition Failed`,413:`Content Too Large`,414:`URI Too Long`,415:`Unsupported Media Type`,416:`Range Not Satisfiable`,417:`Expectation Failed`,418:`I'm a Teapot`,421:`Misdirected Request`,422:`Unprocessable Entity`,423:`Locked`,424:`Failed Dependency`,425:`Too Early`,426:`Upgrade Required`,428:`Precondition Required`,429:`Too Many Requests`,431:`Request Header Fields Too Large`,451:`Unavailable For Legal Reasons`,500:`Internal Server Error`,501:`Not Implemented`,502:`Bad Gateway`,503:`Service Unavailable`,504:`Gateway Timeout`,505:`HTTP Version Not Supported`,506:`Variant Also Negotiates`,507:`Insufficient Storage`,508:`Loop Detected`,510:`Not Extended`,511:`Network Authentication Required`},ku=S`
    .code-container {
        position: relative;
    }
...
`,Mu=class extends T{constructor(...e){super(...e),this.examplesData=``,this.mockJson=``,this.examplesJson=``,this.descriptionsJson=``,this.mode=`drawer`,this.codeLanguage=`json`,this.hideLabel=!1,this.showExpand=!1,this.showVisibilityToggle=!1,this.exampleTitle=`Example`,this.entries=[],this.descriptions={},this.selectedIndex=0}static{this.styles=[...Au,Tc,ju]}willUpdate(e){(e.has(`examplesData`)||e.has(`mockJson`)||e.has(`examplesJson`)||e.has(`descriptionsJson`))&&this.buildEntries()}buildEntries(){let e=[],t=this.mockJson,n={};if(this.examplesData)try{let e=JSON.parse(this.examplesData);e.mockJson&&(t=e.mockJson),e.examples&&(n=e.examples)}catch{}if(this.examplesJson)try{n={...n,...JSON.parse(this.examplesJson)}}catch{}for(let[t,r]of Object.entries(n))r&&e.push({key:t,json:r});if(t&&e.push({key:``,json:t}),this.entries=e,this.selectedIndex=0,this.descriptionsJson)try{this.descriptions=JSON.parse(this.descriptionsJson)}catch{this.descriptions={}}else this.descriptions={}}showExample(e){let t=e.json;if(this.codeLanguage===`json`)try{t=JSON.stringify(JSON.parse(e.json),null,2)}catch{}let n=new CustomEvent(`pp-show-example`,{bubbles:!0,composed:!0,detail:{title:e.key,json:t,language:this.codeLanguage}});this.dispatchEvent(n)}handleSelect(e){let t=e.detail?.item?.value;if(t===void 0)return;let n=parseInt(t,10);n>=0&&n<this.entries.length&&this.showExample(this.entries[n])}render(){if(!this.entries.length)return w;if(this.mode===`inline`)return this.renderInline();if(this.entries.length===1){let e=this.entries[0];return C`
    ...
    `}renderInline(){let e=this.entries[this.selectedIndex];if(this.entries.length===1)return C`
        ${this.hideLabel?w:C`<div class="inline-example-label">${this.inlineLabel(e.key)}</div>`}
        ${this.renderCodeBlock(e.json)}
      `;let t=this.descriptions[e.key];return C`
      ${this.hideLabel?w:C`<div class="inline-example-label">Example</div>`}
      ${this.renderCodeBlock(e.json)}
      <div class="inline-selector-row">
        ...
        ${t?X(t,{className:`inline-example-desc pp-markdown`}):w}
      </div>
    `}handleInlineSelect(e){let t=e.detail?.item?.value;t!==void 0&&(this.selectedIndex=parseInt(t,10))}};q([A({attribute:`examples-data`})],Mu.prototype,`examplesData`,void 0),q([A({attribute:`mock-json`})],Mu.prototype,`mockJson`,void 0),q([A({attribute:`examples-json`})],Mu.prototype,`examplesJson`,void 0),q([A({attribute:`descriptions-json`})],Mu.prototype,`descriptionsJson`,void 0),q([A()],Mu.prototype,`mode`,void 0),q([A({attribute:`code-language`})],Mu.prototype,`codeLanguage`,void 0),q([A({type:Boolean,attribute:`hide-label`})],Mu.prototype,`hideLabel`,void 0),q([A({type:Boolean,attribute:`show-expand`})],Mu.prototype,`showExpand`,void 0),q([A({type:Boolean,attribute:`show-visibility-toggle`})],Mu.prototype,`showVisibilityToggle`,void 0),q([A({attribute:`example-title`})],Mu.prototype,`exampleTitle`,void 0),q([j()],Mu.prototype,`entries`,void 0),q([j()],Mu.prototype,`descriptions`,void 0),q([j()],Mu.prototype,`selectedIndex`,void 0),Mu=q([k(`pp-example-selector`)],Mu);var Nu=[ks,S`
    :host {
        display: block;
    }
...
`],Pu=class extends T{constructor(...e){super(...e),this.contentJson=``,this.hideRefLinks=!1,this.mediaTypes=[],this.selectedIndex=0,this.schemasIdentical=!1,this.wide=!1,this.exampleHidden=!1,this.resizeObserver=null,this.paneResizeObserver=null,this._sizePending=!1,this._rafId=0,this._splitRepositioning=!1,this._splitRepositionTimer=0,this.observedPropsPane=null,this.observedExamplePane=null,this.observedPropsContent=null,this.observedExampleContent=null}static{this.styles=[js,Ec,Nu]}connectedCallback(){super.connectedCallback(),setTimeout(()=>{this.wide=this.offsetWidth>=900,!(typeof ResizeObserver>`u`)&&(this.resizeObserver=new ResizeObserver(e=>{for(let t of e)this.wide=t.contentRect.width>=900}),this.resizeObserver.observe(this),this.paneResizeObserver=new ResizeObserver(()=>{this.sizeSplitPanel()}))},0)}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId),window.clearTimeout(this._splitRepositionTimer),this.resizeObserver?.disconnect(),this.resizeObserver=null,this.paneResizeObserver?.disconnect(),this.paneResizeObserver=null,this.observedPropsPane=null,this.observedExamplePane=null,this.observedPropsContent=null,this.observedExampleContent=null}updated(e){(e.has(`wide`)||e.has(`selectedIndex`)||e.has(`mediaTypes`)||e.has(`exampleHidden`))&&this.sizeSplitPanel(),this.syncPaneObservers()}sizeSplitPanel(){!this.splitPanel||!this.propsPane||!this.examplePane||this._sizePending||this._splitRepositioning||(this._sizePending=!0,this._rafId=requestAnimationFrame(()=>{if(this._sizePending=!1,!this.splitPanel||!this.propsPane||!this.examplePane||this._splitRepositioning)return;let e=this.measurePaneContentHeight(this.propsPane),t=this.exampleHidden?0:this.measurePaneContentHeight(this.examplePane),n=document.documentElement.clientHeight||800,r=this.mediaTypes[this.selectedIndex],i=this.getPropCount(r),a=this.exampleHidden?e:Math.max(e,t),o=i>=6?300:220,s=n*.75,c=Math.max(o,Math.min(a,s)),l=getComputedStyle(this.splitPanel),u=parseFloat(l.paddingTop)+parseFloat(l.paddingBottom),d=Math.round(c+u),f=parseFloat(this.splitPanel.style.height);(!Number.isFinite(f)||Math.abs(f-d)>=1)&&(this.splitPanel.style.height=`${d}px`)}))}handleSplitReposition(){this._splitRepositioning=!0,this._rafId&&(cancelAnimationFrame(this._rafId),this._rafId=0,this._sizePending=!1),window.clearTimeout(this._splitRepositionTimer),this._splitRepositionTimer=window.setTimeout(()=>{this._splitRepositioning=!1,this.sizeSplitPanel()},120)}measurePaneContentHeight(e){let t=Array.from(e.children).reduce((e,t)=>e+Math.max(t.offsetHeight,t.scrollHeight),0),n=getComputedStyle(e);return t+(parseFloat(n.paddingTop)+parseFloat(n.paddingBottom))}syncPaneObservers(){if(!this.paneResizeObserver||typeof ResizeObserver>`u`)return;let e=this.propsPane??null,t=this.examplePane??null,n=e?.firstElementChild??null,r=t?.firstElementChild??null;this.observedPropsPane!==e&&(this.observedPropsPane&&this.paneResizeObserver.unobserve(this.observedPropsPane),e&&this.paneResizeObserver.observe(e),this.observedPropsPane=e),this.observedExamplePane!==t&&(this.observedExamplePane&&this.paneResizeObserver.unobserve(this.observedExamplePane),t&&this.paneResizeObserver.observe(t),this.observedExamplePane=t),this.observedPropsContent!==n&&(this.observedPropsContent&&this.paneResizeObserver.unobserve(this.observedPropsContent),n instanceof Element&&this.paneResizeObserver.observe(n),this.observedPropsContent=n),this.observedExampleContent!==r&&(this.observedExampleContent&&this.paneResizeObserver.unobserve(this.observedExampleContent),r instanceof Element&&this.paneResizeObserver.observe(r),this.observedExampleContent=r)}getPropCount(e){let t=e?.isArray&&e?.itemsSchemaJson?e.itemsSchemaJson:e?.schemaJson;if(!t)return 0;try{let e=JSON.parse(t);return e.properties?Object.keys(e.properties).length:0}catch{return 0}}isComplexWithExample(e){if(!e.schemaJson&&!(e.isArray&&e.itemsSchemaJson))return!1;let t=e.isArray&&e.itemsSchemaJson?e.itemsSchemaJson:e.schemaJson;if(!t)return!1;try{let n=JSON.parse(t),r=n.properties||n.allOf||n.oneOf||n.anyOf,i=!!(e.mockJson||e.mockYaml||e.mockXml||e.examples&&Object.keys(e.examples).length);return!!r&&i}catch{return!1}}willUpdate(e){if(e.has(`contentJson`)&&this.contentJson){try{this.mediaTypes=JSON.parse(this.contentJson)}catch{this.mediaTypes=[]}let e=this.mediaTypes.findIndex(e=>e.mediaType.toLowerCase()===`application/json`);this.selectedIndex=e>=0?e:0,this.schemasIdentical=this.mediaTypes.length>1&&new Set(this.mediaTypes.map(e=>this.schemaFingerprint(e))).size===1}}schemaFingerprint(e){return e.isArray&&e.itemsRef?`array:${e.itemsRef.slug}:${e.itemsSchemaJson||e.schemaJson}`:e.schemaRef?`ref:${e.schemaRef.componentType}/${e.schemaRef.slug}`:`inline:${e.schemaJson}`}getMockAndLanguage(e){let t=e.mediaType.toLowerCase();return(t.includes(`yaml`)||t.includes(`x-yaml`))&&e.mockYaml?{mock:e.mockYaml,language:`yaml`}:t.includes(`xml`)&&e.mockXml?{mock:e.mockXml,language:`xml`}:{mock:e.mockJson||``,language:`json`}}renderSchemaHeader(e){return e.isArray&&e.itemsRef?C`
        ...
        `}handleSelect(e){let t=e.detail?.item?.value;if(t===void 0)return;let n=parseInt(t,10);n>=0&&n<this.mediaTypes.length&&(this.selectedIndex=n)}renderSplit(e){let t=e.isArray&&e.itemsSchemaJson?e.itemsSchemaJson:e.schemaJson,{mock:n,language:r}=this.getMockAndLanguage(e),i=e.examples&&Object.keys(e.examples).length>0,a=e.mediaType||`Example`;return C`
            <sl-split-panel class=${this.exampleHidden?`schema-split example-hidden`:`schema-split`} position=${this.exampleHidden?`100`:`60`} @sl-reposition=${this.handleSplitReposition}>
                ...
                <div slot="end" class="split-pane schema-example-pane">
                    ${this.exampleHidden?this.renderExampleRestore():C`
        ...
        `}hideExamplePane(){this.exampleHidden=!0}showExamplePane(){this.exampleHidden=!1}renderExampleRestore(){return C`
        ...
        `}render(){if(!this.mediaTypes.length)return w;if(this.mediaTypes.length===1){let e=this.mediaTypes[0];if(this.wide&&this.isComplexWithExample(e))return C`
                    ${this.renderSchemaHeader(e)}
                    ${this.renderSplit(e)}
                    ${this.renderExtensions(e)}
                `;let{mock:t,language:n}=this.getMockAndLanguage(e);return C`
                ${this.renderSchemaHeader(e)}
                ${this.renderInlineExamples(e,n,t)}
                ${this.renderSchemaProperties(e)}
                ${this.renderExtensions(e)}
            `}let e=this.mediaTypes[this.selectedIndex];if(this.schemasIdentical){let t=this.mediaTypes[0];if(this.wide&&this.isComplexWithExample(e))return C`
                    ${this.renderDropdown(e)}
                    ${this.renderSplit(e)}
                    ${this.renderExtensions(e)}
                `;let{mock:n,language:r}=this.getMockAndLanguage(e);return C`
                ${this.renderDropdown(e)}
                ${this.renderInlineExamples(e,r,n)}
                ${this.renderSchemaProperties(t)}
                ${this.renderExtensions(e)}
            `}if(this.wide&&this.isComplexWithExample(e))return C`
                ${this.renderDropdown(e)}
                ${this.renderSplit(e)}
                ${this.renderExtensions(e)}
            `;let{mock:t,language:n}=this.getMockAndLanguage(e);return C`
            ...
            ${this.renderSchemaProperties(e)}
            ${this.renderExtensions(e)}
        `}};q([A({attribute:`content-json`})],Pu.prototype,`contentJson`,void 0),q([A({attribute:`hide-ref-links`,type:Boolean})],Pu.prototype,`hideRefLinks`,void 0),q([j()],Pu.prototype,`mediaTypes`,void 0),q([j()],Pu.prototype,`selectedIndex`,void 0),q([j()],Pu.prototype,`schemasIdentical`,void 0),q([j()],Pu.prototype,`wide`,void 0),q([j()],Pu.prototype,`exampleHidden`,void 0),q([M(`.schema-split`)],Pu.prototype,`splitPanel`,void 0),q([M(`.schema-props-pane`)],Pu.prototype,`propsPane`,void 0),q([M(`.schema-example-pane`)],Pu.prototype,`examplePane`,void 0),Pu=q([k(`pp-media-type-selector`)],Pu);var Fu=class extends T{constructor(...e){super(...e),this.responsesJson=``,this.commonHeadersJson=``,this.responses=[],this.commonResponseHeaders=[],this.commonHeaderNames=new Set,this.commonErrorKeys=new Set,this.commonErrorResponses=new Map,this.successResponses=[],this.redirectResponses=[],this.errorResponses=[]}static{this.styles=[js,wc,Tc,Ec,wu,Tu,Eu]}willUpdate(e){if(e.has(`responsesJson`)&&this.responsesJson){try{this.responses=JSON.parse(this.responsesJson)}catch{this.responses=[]}let e=[...this.responses].sort((e,t)=>parseInt(e.statusCode,10)-parseInt(t.statusCode,10)),t=[],n=[],r=[];for(let i of e){let e=parseInt(i.statusCode,10);e>=400?r.push(i):e>=300?n.push(i):t.push(i)}this.successResponses=t,this.redirectResponses=n,this.errorResponses=r;let{commonKeys:i,commonResponses:a}=this.computeCommonErrors(r);this.commonErrorKeys=i,this.commonErrorResponses=a}if(e.has(`commonHeadersJson`)&&this.commonHeadersJson){try{this.commonResponseHeaders=JSON.parse(this.commonHeadersJson)}catch{this.commonResponseHeaders=[]}this.commonHeaderNames=new Set(this.commonResponseHeaders.map(e=>e.name))}}getResponseNavItems(){let e=[];for(let t of[...this.successResponses,...this.redirectResponses,...this.errorResponses])e.push({label:`${t.statusCode} ${Ou[t.statusCode]||``}`.trim(),id:`response-${t.statusCode}`});return e}scrollToHeader(e){let t=this.shadowRoot?.getElementById(`header-`+e);if(!t)return;let n=t.closest(`sl-details`);n&&!n.open?(n.open=!0,n.updateComplete?.then(()=>{t.scrollIntoView({behavior:`auto`,block:`center`})})):t.scrollIntoView({behavior:`auto`,block:`center`})}renderHeaderEntry(e){return C`
            <div class="header-entry">
                ...
                <div class="header-type-col">
                    ${e.schemaType?C`<span class="header-type">${e.schemaType}</span>`:w}
                    ${$l(e,{includeExample:!0})}
                </div>
            ...
            `:w}
        `}renderHeaders(e,t){if(!e||!e.length)return w;let n=e.filter(e=>!t.has(e.name)),r=e.filter(e=>t.has(e.name));return!n.length&&!r.length?w:C`
        ...
        `:w}errorRefKey(e){if(e.ref)return`ref:${e.ref.slug}`;if(e.content?.length){let t=e.content[0];if(t.schemaRef)return`schema:${t.schemaRef.slug}`;if(t.isArray&&t.itemsRef)return`items:${t.itemsRef.slug}`}return null}computeCommonErrors(e){let t=new Map;for(let n of e){let e=this.errorRefKey(n);if(!e)continue;let r=t.get(e);r?r.codeDescs.push({code:n.statusCode,description:n.description}):t.set(e,{resp:n,codeDescs:[{code:n.statusCode,description:n.description}]})}let n=new Set,r=new Map;for(let[e,i]of t)i.codeDescs.length>=2&&(n.add(e),r.set(e,i));return{commonKeys:n,commonResponses:r}}scrollToCommonError(e){(this.shadowRoot?.getElementById(`common-error-`+e))?.scrollIntoView({behavior:`auto`,block:`nearest`})}renderResponse(e,t,n){let r=n?this.errorRefKey(e):null,i=r!=null&&n?.has(r);return C`
            <div class="response" id="response-${e.statusCode}">
                    ...
                    ${e.descHtml?C`<div class="response-desc">${To(e.descHtml)}</div>`:X(e.description,{className:`response-desc pp-markdown`})}
              
                ${i?C`
                            <div class="common-error-link">
                                ${e.ref?Zl(e.ref,!0):w}
                                ${!e.ref&&e.content?.length?this.renderMediaTypeHeader(e.content[0]):w}
                                <a class="error-anchor" @click=${e=>{e.preventDefault(),this.scrollToCommonError(r)}}>\u2191 see common example</a>
                            </div>`:e.ref?Zl(e.ref,!0):e.content?.length?C`<pp-media-type-selector content-json=${JSON.stringify(e.content)}></pp-media-type-selector>`:w}
        ...
        `}renderMediaTypeHeader(e){return e.isArray&&e.itemsRef?C`
                <span class="media-type-label">${e.mediaType}</span>
                <span class="array-type">Array&lt;${Zl(e.itemsRef)}&gt;</span>
            `:e.schemaRef?C`
                <span class="media-type-label">${e.mediaType}</span>
                ${Zl(e.schemaRef)}
            `:w}renderCommonErrors(e,t){return e.size?C`
            <div class="response-group-heading"><h4>Common Error Responses</h4></div>
            ${[...e.entries()].map(([e,{resp:n,codeDescs:r}])=>C`
                <div class="response common-error-response" id="common-error-${e}">
                    <div class="common-error-grid">
                        ${r.map(({code:e,description:t})=>C`
                            <div class="common-error-code"><span class="${Du(e)}">${e}</span> ${Ou[e]||``}</div>
                            ${X(t,{className:`common-error-desc pp-markdown`})}
                        `)}
                    </div>
                    ${n.ref?Zl(n.ref,!0):n.content?.length?C`<pp-media-type-selector content-json=${JSON.stringify(n.content)}></pp-media-type-selector>`:w}
                    ${this.renderHeaders(n.headers??[],t)}
                </div>
            `)}
        `:w}render(){if(!this.responses.length)return w;let e=this.commonHeaderNames,t=this.commonErrorKeys,n=this.commonErrorResponses;return C`
            <h2>Responses</h2>
            ...
            ${this.commonResponseHeaders.length?C`
                <sl-details class="pp-details">
                    ...
                    <div class="property-box">
                        ${this.commonResponseHeaders.map(e=>C`
                            <div id="header-${e.name}">${this.renderHeaderEntry(e)}</div>
                        `)}
                    </div>
                </sl-details>
            `:w}
            ${this.errorResponses.length||n.size?C`
                <sl-details class="pp-details">
            ...
            `:w}
        `}};q([A({attribute:`responses-json`})],Fu.prototype,`responsesJson`,void 0),q([A({attribute:`common-headers-json`})],Fu.prototype,`commonHeadersJson`,void 0),q([j()],Fu.prototype,`responses`,void 0),q([j()],Fu.prototype,`commonResponseHeaders`,void 0),q([j()],Fu.prototype,`commonHeaderNames`,void 0),q([j()],Fu.prototype,`commonErrorKeys`,void 0),q([j()],Fu.prototype,`commonErrorResponses`,void 0),q([j()],Fu.prototype,`successResponses`,void 0),q([j()],Fu.prototype,`redirectResponses`,void 0),q([j()],Fu.prototype,`errorResponses`,void 0),Fu=q([k(`pp-operation-responses`)],Fu);var Iu=S`
    :host {
        display: block;
    }
...
`,Lu=class extends T{constructor(...e){super(...e),this.callbacksJson=``,this.callbacks=[]}static{this.styles=[js,Tc,Ec,wu,Iu]}willUpdate(e){if(e.has(`callbacksJson`)&&this.callbacksJson)try{this.callbacks=JSON.parse(this.callbacksJson)}catch{this.callbacks=[]}}renderRequestBody(e){return e.ref?C`<div class="callback-section-label">Request Body</div>${Zl(e.ref,!0)}`:e.content?.length?C`
            <div class="callback-section-label">Request Body${e.required?` (required)`:``}</div>
            ${e.descHtml?C`<div class="callback-desc">${To(e.descHtml)}</div>`:X(e.description,{className:`callback-desc pp-markdown`})}
            <pp-media-type-selector content-json=${JSON.stringify(e.content)}></pp-media-type-selector>
        `:w}renderResponses(e){return e?.length?C`
            <div class="callback-section-label">Responses</div>
            ${e.map(e=>C`
                <div class="callback-response">
                    <span class="callback-response-code ${Du(e.statusCode)}">${e.statusCode}</span>
                    <span class="callback-response-code">${Ou[e.statusCode]||``}</span>
                    ${e.descHtml?C`<span class="callback-response-desc">${To(e.descHtml)}</span>`:e.description?X(e.description,{className:`callback-response-desc pp-markdown-inline`,inline:!0}):w}
                </div>
                ${e.ref?Zl(e.ref,!0):w}
                ${!e.ref&&e.content?.length?C`<pp-media-type-selector content-json=${JSON.stringify(e.content)}></pp-media-type-selector>`:w}
            `)}
        `:w}renderCallbackOperation(e){return C`
            <div class="callback-operation">
                ...
                ${e.descHtml?C`<div class="callback-desc">${To(e.descHtml)}</div>`:X(e.description,{className:`callback-desc pp-markdown`})}
                ${e.requestBody?this.renderRequestBody(e.requestBody):w}
        ...
        `}render(){return this.callbacks.length?C`
            ...
            `)}
        `:w}};q([A({attribute:`callbacks-json`})],Lu.prototype,`callbacksJson`,void 0),q([j()],Lu.prototype,`callbacks`,void 0),Lu=q([k(`pp-operation-callbacks`)],Lu);var Ru=S`
    :host {
        display: block;
        margin-top: var(--global-padding-double);
    }
...
`],Bu=class extends T{constructor(...e){super(...e),this.rawJson=``,this.rawYaml=``,this.startLine=1,this.title=`Schema`,this.location=``,this.noLineNumbers=!1,this.mode=`yaml`}static{this.styles=[zu,ju]}connectedCallback(){super.connectedCallback();let e=document.body.getAttribute(`data-spec-format`);(e===`json`||e===`yaml`)&&(this.mode=e)}render(){if(!this.rawJson&&!this.rawYaml)return w;let e=!!this.rawJson,t=!!this.rawYaml,n=this.mode===`yaml`&&t?this.rawYaml:this.rawJson,r=this.mode===`yaml`&&t?`yaml`:`json`,i=e&&t;return C`
      ${this.title||i?C`
      <div class="toolbar">
        ${this.title?C`<h3>${this.title}</h3>`:w}
        ${i?C`
...
`)!==-1)}
    ...
    `}renderSchemaStacked(e){return C`
      <div class="schema-stacked" style=${this.estimatedBodyHeight>0?`min-height: ${this.estimatedBodyHeight}px;`:``}>
        ${this.exampleJson?C`<pp-example-selector mode="inline" mock-json=${this.exampleJson}></pp-example-selector>`:w}
        <h2>${e}</h2>
        <pp-schema-properties schema-json=${this.modelJson}></pp-schema-properties>
      </div>
    `}getReservedHeight(){return this.wide&&this.layoutMode===`split`&&this.estimatedSplitHeight>0?this.estimatedSplitHeight:this.estimatedBodyHeight>0?this.estimatedBodyHeight:this.propertyCount>0?Math.min(640,Math.max(220,160+this.propertyCount*40)):this.hasExample?360:240}renderSkeletonRows(e){return Array.from({length:Math.max(3,e||4)},(e,t)=>C`
      <div class="skeleton-row" style=${`width: ${100-Math.min(t*7,28)}%;`}></div>
    `)}renderSkeleton(){let e=`min-height: ${this.getReservedHeight()}px;`;return this.wide&&this.layoutMode===`split`?C`
    ...
    `}render(){if(!this.parsed)return this.renderSkeleton();let e=this.parsed;return e.in?this.renderParameter(e):e.schema&&!e.properties&&!e.in?this.renderHeader(e):e.value!==void 0||e.externalValue!==void 0?this.renderExampleModel(e):e.content?this.renderContent(e):this.renderSchema(e)}};q([A({attribute:`model-json`})],Q.prototype,`modelJson`,void 0),q([A()],Q.prototype,`name`,void 0),q([A({attribute:`layout-mode`})],Q.prototype,`layoutMode`,void 0),q([A({attribute:`estimated-body-height`,type:Number})],Q.prototype,`estimatedBodyHeight`,void 0),q([A({attribute:`estimated-split-height`,type:Number})],Q.prototype,`estimatedSplitHeight`,void 0),q([A({attribute:`property-count`,type:Number})],Q.prototype,`propertyCount`,void 0),q([A({attribute:`required-count`,type:Number})],Q.prototype,`requiredCount`,void 0),q([A({attribute:`has-example`,type:Boolean})],Q.prototype,`hasExample`,void 0),q([A({attribute:`raw-yaml`})],Q.prototype,`rawYaml`,void 0),q([A({attribute:`schema-raw-yaml`})],Q.prototype,`schemaRawYaml`,void 0),q([A({attribute:`schema-raw-json`})],Q.prototype,`schemaRawJson`,void 0),q([A({attribute:`schema-start-line`,type:Number})],Q.prototype,`schemaStartLine`,void 0),q([A({attribute:`start-line`,type:Number})],Q.prototype,`startLine`,void 0),q([A()],Q.prototype,`location`,void 0),q([A({attribute:`mock-json`})],Q.prototype,`mockJson`,void 0),q([j()],Q.prototype,`parsed`,void 0),q([j()],Q.prototype,`wide`,void 0),q([j()],Q.prototype,`exampleJson`,void 0),q([j()],Q.prototype,`exampleHidden`,void 0),q([M(`.schema-split`)],Q.prototype,`splitPanel`,void 0),q([M(`.schema-props-pane`)],Q.prototype,`propsPane`,void 0),q([M(`.schema-example-pane`)],Q.prototype,`examplePane`,void 0),Q=q([k(`pp-model-page`)],Q);var Hu=S`
  :host {
    display: block;
  }
  a {
...
`,Uu=class extends T{constructor(...e){super(...e),this.name=``,this.href=``,this.description=``}static{this.styles=[Tc,Hu]}render(){return C`
      <a href=${this.href}>
        <strong>${this.name}</strong>
        ${X(this.description)}
      </a>
    `}};q([A()],Uu.prototype,`name`,void 0),q([A()],Uu.prototype,`href`,void 0),q([A()],Uu.prototype,`description`,void 0),Uu=q([k(`pp-model-card`)],Uu);var Wu=S`
    :host {
        display: block;
        margin-top: var(--global-padding);
        padding-top: var(--global-padding);
...
`,qu=(e=`value`)=>(t,n)=>{let r=t.constructor,i=r.prototype.attributeChangedCallback;r.prototype.attributeChangedCallback=function(t,a,o){let s=r.getPropertyOptions(e);if(t===(typeof s.attribute==`string`?s.attribute:e)){let t=s.converter||st,r=(typeof t==`function`?t:t?.fromAttribute??st.fromAttribute)(o,s.type);this[e]!==r&&(this[n]=r)}i.call(this,t,a,o)}},Ju=S`
...
`,Yu=qn(class extends Jn{constructor(e){if(super(e),e.type!==Kn.PROPERTY&&e.type!==Kn.ATTRIBUTE&&e.type!==Kn.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Rn(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Mt||t===w)return t;let n=e.element,r=e.name;if(e.type===Kn.PROPERTY){if(t===n[r])return Mt}else if(e.type===Kn.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return Mt}else if(e.type===Kn.ATTRIBUTE&&n.getAttribute(r)===t+``)return Mt;return Bn(e),t}}),$=class extends N{constructor(){super(...arguments),this.formControlController=new so(this,{assumeInteractionOn:[`sl-blur`,`sl-input`]}),this.hasSlotController=new Wa(this,`help-text`,`label`),this.localize=new L(this),this.hasFocus=!1,this.title=``,this.__numberInput=Object.assign(document.createElement(`input`),{type:`number`}),this.__dateInput=Object.assign(document.createElement(`input`),{type:`date`}),this.type=`text`,this.name=``,this.value=``,this.defaultValue=``,this.size=`medium`,this.filled=!1,this.pill=!1,this.label=``,this.helpText=``,this.clearable=!1,this.disabled=!1,this.placeholder=``,this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form=``,this.required=!1,this.spellcheck=!0}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`sl-blur`)}handleChange(){this.value=this.input.value,this.emit(`sl-change`)}handleClearClick(e){e.preventDefault(),this.value!==``&&(this.value=``,this.emit(`sl-clear`),this.emit(`sl-input`),this.emit(`sl-change`)),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit(`sl-focus`)}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit(`sl-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleKeyDown(e){let t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key===`Enter`&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){this.input.step=String(this.step),this.formControlController.updateValidity()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){`showPicker`in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t,i=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value==`number`||this.value.length>0);return C`
    ...
    `}};$.styles=[O,Ju,Ku],$.dependencies={"sl-icon":Gn},E([M(`.input__control`)],$.prototype,`input`,2),E([j()],$.prototype,`hasFocus`,2),E([A()],$.prototype,`title`,2),E([A({reflect:!0})],$.prototype,`type`,2),E([A()],$.prototype,`name`,2),E([A()],$.prototype,`value`,2),E([qu()],$.prototype,`defaultValue`,2),E([A({reflect:!0})],$.prototype,`size`,2),E([A({type:Boolean,reflect:!0})],$.prototype,`filled`,2),E([A({type:Boolean,reflect:!0})],$.prototype,`pill`,2),E([A()],$.prototype,`label`,2),E([A({attribute:`help-text`})],$.prototype,`helpText`,2),E([A({type:Boolean})],$.prototype,`clearable`,2),E([A({type:Boolean,reflect:!0})],$.prototype,`disabled`,2),E([A()],$.prototype,`placeholder`,2),E([A({type:Boolean,reflect:!0})],$.prototype,`readonly`,2),E([A({attribute:`password-toggle`,type:Boolean})],$.prototype,`passwordToggle`,2),E([A({attribute:`password-visible`,type:Boolean})],$.prototype,`passwordVisible`,2),E([A({attribute:`no-spin-buttons`,type:Boolean})],$.prototype,`noSpinButtons`,2),E([A({reflect:!0})],$.prototype,`form`,2),E([A({type:Boolean,reflect:!0})],$.prototype,`required`,2),E([A()],$.prototype,`pattern`,2),E([A({type:Number})],$.prototype,`minlength`,2),E([A({type:Number})],$.prototype,`maxlength`,2),E([A()],$.prototype,`min`,2),E([A()],$.prototype,`max`,2),E([A()],$.prototype,`step`,2),E([A()],$.prototype,`autocapitalize`,2),E([A()],$.prototype,`autocorrect`,2),E([A()],$.prototype,`autocomplete`,2),E([A({type:Boolean})],$.prototype,`autofocus`,2),E([A()],$.prototype,`enterkeyhint`,2),E([A({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],$.prototype,`spellcheck`,2),E([A()],$.prototype,`inputmode`,2),E([D(`disabled`,{waitUntilFirstUpdate:!0})],$.prototype,`handleDisabledChange`,1),E([D(`step`,{waitUntilFirstUpdate:!0})],$.prototype,`handleStepChange`,1),E([D(`value`,{waitUntilFirstUpdate:!0})],$.prototype,`handleValueChange`,1),$.define(`sl-input`);var Xu={schemas:`Schemas`,responses:`Responses`,parameters:`Parameters`,requestBodies:`Request Bodies`,headers:`Headers`,securitySchemes:`Security Schemes`,examples:`Examples`,links:`Links`,callbacks:`Callbacks`},Zu=[`GET`,`POST`,`PUT`,`DELETE`,`PATCH`,`OPTIONS`,`HEAD`,`QUERY`],Qu=class extends T{constructor(...e){super(...e),this.type=`operations`,this.heading=``,this.items=[],this.filterValue=``,this.searchTerm=``,this.filteredItems=[],this.filterOptions=[],this.handleClear=()=>{clearTimeout(this.searchTimeout),this.searchTerm=``}}static{this.styles=Gu}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.searchTimeout)}willUpdate(e){e.has(`items`)&&this.type===`components`&&(this.filterOptions=[...new Set(this.items.map(e=>e.componentType))].sort()),(e.has(`items`)||e.has(`filterValue`)||e.has(`searchTerm`))&&(this.filteredItems=this.computeFiltered())}computeFiltered(){let e=this.searchTerm.toLowerCase();if(this.type===`operations`){let t=this.items;return this.filterValue&&(t=t.filter(e=>e.method.toUpperCase()===this.filterValue)),e&&(t=t.filter(t=>t.path.toLowerCase().includes(e))),t}else{let t=this.items;return this.filterValue&&(t=t.filter(e=>e.componentType===this.filterValue)),e&&(t=t.filter(t=>t.name.toLowerCase().includes(e))),t}}handleSearch(e){clearTimeout(this.searchTimeout);let t=e.target.value;this.searchTimeout=window.setTimeout(()=>{this.searchTerm=t},150)}handleFilter(e){this.filterValue=e.detail?.item?.value??``}renderToolbar(){let e=this.type===`operations`?this.filterValue||`ALL METHODS`:Xu[this.filterValue]?.toUpperCase()||this.filterValue?.toUpperCase()||`ALL TYPES`;return C`
            <div class="toolbar">
                <sl-dropdown>
                    <sl-button slot="trigger" class="filter-btn" caret size="small">
                        ${this.type===`operations`&&this.filterValue?C`<pb33f-http-method method=${this.filterValue} tiny></pb33f-http-method>`:e}
                    </sl-button>
                    <sl-menu @sl-select=${this.handleFilter}>
                        <sl-menu-item value="">
                            ${this.type===`operations`?`ALL METHODS`:`ALL TYPES`}
                        </sl-menu-item>
                        ${this.type===`operations`?Zu.map(e=>C`
                                <sl-menu-item value=${e}><pb33f-http-method method=${e}></pb33f-http-method></sl-menu-item>`):this.filterOptions.map(e=>C`
        ...
        `}renderOperationItem(e){return C`
        ...
        `}renderComponentItem(e){return C`
        ...
        `}render(){if(!this.items.length)return w;let e=this.type===`operations`?this.filteredItems.map(e=>this.renderOperationItem(e)):this.filteredItems.map(e=>this.renderComponentItem(e)),t=this.items.length>20;return C`
            <h2>${this.heading}</h2>
            ${t?this.renderToolbar():w}
            ${this.filteredItems.length?C`<pb33f-paginator-navigation
                            .values=${e}
                            .label=${this.heading}
                            hideSparks>
                        </pb33f-paginator-navigation>`:C`<div class="empty-state">No matching references</div>`}
        `}};q([A()],Qu.prototype,`type`,void 0),q([A()],Qu.prototype,`heading`,void 0),q([A({type:Array})],Qu.prototype,`items`,void 0),q([j()],Qu.prototype,`filterValue`,void 0),q([j()],Qu.prototype,`searchTerm`,void 0),q([j()],Qu.prototype,`filteredItems`,void 0),q([j()],Qu.prototype,`filterOptions`,void 0),Qu=q([k(`pp-ref-list`)],Qu);var $u=class extends T{constructor(...e){super(...e),this.refsJson=``,this.refs={}}static{this.styles=Wu}willUpdate(e){if(e.has(`refsJson`)&&this.refsJson)try{this.refs=JSON.parse(this.refsJson)}catch{this.refs={}}}render(){let{refs:e}=this,t=(e.usedByOperations?.length??0)>0,n=(e.usedByModels?.length??0)>0,r=(e.usesModels?.length??0)>0;return!t&&!n&&!r?w:C`
            ${t?C`
                <pp-ref-list
                    type="operations"
                    heading="Consumed By"
        ...
        `}};q([A({attribute:`refs-json`})],$u.prototype,`refsJson`,void 0),q([j()],$u.prototype,`refs`,void 0),$u=q([k(`pp-cross-refs`)],$u);var ed=[ku,S`
    :host {
        display: block;
    }
...
`],td=class extends T{constructor(...e){super(...e),this.title=``,this.json=``,this.yaml=``,this.format=`json`,this.rawMode=!1,this.highlightLines=``,this.startLine=1,this.location=``,this.method=``,this.path=``,this.componentType=``,this.handleShowExample=e=>{let t=e.detail;if((document.querySelector(`pp-problems-drawer`)?.shadowRoot?.querySelector(`sl-drawer`))?.hide?.(),this.title=t.title,this.json=t.json,this.yaml=t.yaml||``,this.rawMode=t.rawMode??!1,this.highlightLines=t.highlightLines||``,this.startLine=t.startLine??1,this.location=t.location||``,this.method=t.method||``,this.path=t.path||``,this.componentType=t.componentType||``,t.language)this.format=t.language;else{let e=document.body.getAttribute(`data-spec-format`);e===`yaml`&&t.yaml?this.format=`yaml`:e===`json`&&t.json?this.format=`json`:this.format=t.yaml?`yaml`:`json`}this.updateComplete.then(()=>{let e=this.drawer;e&&typeof e.show==`function`&&(e.updateComplete?e.updateComplete.then(()=>e.show()):e.show())})}}static{this.styles=[ed,ju]}connectedCallback(){super.connectedCallback(),document.addEventListener(`pp-show-example`,this.handleShowExample)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`pp-show-example`,this.handleShowExample)}get copyText(){let e=this.shadowRoot?.querySelector(`pp-code-viewer`);return e?e.displayCode:this.format===`yaml`&&this.yaml?this.yaml:this.json}async copyCurrentCode(){let e=this.copyText;e&&await navigator.clipboard.writeText(e)}renderHeader(){return this.method&&this.path?C`
      ...
      `:C`<h3 class="drawer-title">${this.title||`Example`}</h3>`}render(){let e=this.format===`yaml`&&this.yaml?this.yaml:this.json,t=this.format;return C`
    ...
    `}};q([j()],td.prototype,`title`,void 0),q([j()],td.prototype,`json`,void 0),q([j()],td.prototype,`yaml`,void 0),q([j()],td.prototype,`format`,void 0),q([j()],td.prototype,`rawMode`,void 0),q([j()],td.prototype,`highlightLines`,void 0),q([j()],td.prototype,`startLine`,void 0),q([j()],td.prototype,`location`,void 0),q([j()],td.prototype,`method`,void 0),q([j()],td.prototype,`path`,void 0),q([j()],td.prototype,`componentType`,void 0),q([M(`sl-drawer`)],td.prototype,`drawer`,void 0),td=q([k(`pp-example-drawer`)],td);var nd=S`
    :host {
        display: inline-block;
    }
...
`,rd=class extends T{constructor(...e){super(...e),this.btnTitle=``,this.rawJson=``,this.rawYaml=``,this.highlightLines=``,this.startLine=1,this.location=``,this.method=``,this.path=``,this.componentType=``,this.showTextLabel=!1}static{this.styles=[nd,ju]}showRaw(){let e=new CustomEvent(`pp-show-example`,{bubbles:!0,composed:!0,detail:{title:this.btnTitle||`Raw Object`,json:this.rawJson,yaml:this.rawYaml,rawMode:!0,highlightLines:this.highlightLines||void 0,startLine:this.startLine>1?this.startLine:void 0,location:this.location||void 0,method:this.method||void 0,path:this.path||void 0,componentType:this.componentType||void 0}});this.dispatchEvent(e)}render(){return!this.rawJson&&!this.rawYaml?w:C`
            ...
            </sl-tooltip>`}};q([A({attribute:`title`})],rd.prototype,`btnTitle`,void 0),q([A({attribute:`raw-json`})],rd.prototype,`rawJson`,void 0),q([A({attribute:`raw-yaml`})],rd.prototype,`rawYaml`,void 0),q([A({attribute:`highlight-lines`})],rd.prototype,`highlightLines`,void 0),q([A({attribute:`start-line`,type:Number})],rd.prototype,`startLine`,void 0),q([A()],rd.prototype,`location`,void 0),q([A()],rd.prototype,`method`,void 0),q([A()],rd.prototype,`path`,void 0),q([A({attribute:`component-type`})],rd.prototype,`componentType`,void 0),q([A({type:Boolean})],rd.prototype,`showTextLabel`,void 0),rd=q([k(`pp-raw-viewer-btn`)],rd);var id=S`
  :host {
    display: block;
  }
...
`,ad=class extends T{constructor(...e){super(...e),this.scopeLabel=`Diagnostics`,this.method=``,this.path=``,this.componentType=``,this.problems=[],this.slices={},this.metadata={},this.selectedID=``,this.handleShowProblems=async e=>{let t=e.detail||{};this.scopeLabel=t.title||t.scopeLabel||`Diagnostics`,this.method=t.method||``,this.path=t.path||``,this.componentType=t.componentType||``,this.problems=t.problems||[],this.slices=t.slices||{},this.metadata=t.metadata||{},this.selectedID=this.problems[0]?.id||``,await this.updateComplete,this.closeExampleDrawer(),this.drawer?.show&&(this.drawer.show(),await this.waitForDrawerShown(),this.scrollSelectedIntoView())}}static{this.styles=[Tc,id]}connectedCallback(){super.connectedCallback(),window.addEventListener(`pp-show-problems`,this.handleShowProblems)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`pp-show-problems`,this.handleShowProblems)}closeExampleDrawer(){(document.querySelector(`pp-example-drawer`)?.shadowRoot?.querySelector(`sl-drawer`))?.hide?.()}waitForDrawerShown(){return new Promise(e=>{let t=this.drawer;if(!t){e();return}t.addEventListener(`sl-after-show`,()=>e(),{once:!0})})}selectProblem(e){this.selectedID=e.id,this.updateComplete.then(()=>this.scrollSelectedIntoView())}scrollSelectedIntoView(){let e=this.selectedProblem;e&&this.viewer?.scrollToLine(e.startLineNumber)}get selectedProblem(){return this.problems.find(e=>e.id===this.selectedID)||this.problems[0]}get selectedSlice(){let e=this.selectedProblem;if(!e)return;let t=this.metadata[e.id]?.sliceKey||e.sliceKey||``;return t?this.slices[t]:void 0}highlightLines(e){let t=e.startLineNumber,n=e.endLineNumber||t;return t<=0?``:n>t?`${t}-${n}`:`${t}`}sliceLanguage(e){return e.file.toLowerCase().endsWith(`.json`)?`json`:`yaml`}displayLocation(e){return e.split(/[\\/]/).pop()||e}renderHeaderContext(){return this.method&&this.path?C`
      ...
      `:C`<h3>${this.scopeLabel}</h3>`}render(){let e=this.selectedProblem,t=this.selectedSlice;return C`
      <sl-drawer placement="bottom" no-header label="Diagnostics" style="--size: 50vh">
        ...
        <sl-split-panel position="35" class="split">
          <div slot="start" class="problem-list">
            ${this.problems.map(t=>C`
              <button
                class="problem ${dc(t.severity)} ${t.id===e?.id?`active`:``}"
          ...
          <div slot="end" class="slice-panel">
            ${t&&e?C`
                ...
                ></pp-code-viewer>
              `:C`<div class="empty">No source slice available</div>`}
          </div>
        </sl-split-panel>
      </sl-drawer>
    `}};q([M(`sl-drawer`)],ad.prototype,`drawer`,void 0),q([M(`pp-code-viewer`)],ad.prototype,`viewer`,void 0),q([j()],ad.prototype,`scopeLabel`,void 0),q([j()],ad.prototype,`method`,void 0),q([j()],ad.prototype,`path`,void 0),q([j()],ad.prototype,`componentType`,void 0),q([j()],ad.prototype,`problems`,void 0),q([j()],ad.prototype,`slices`,void 0),q([j()],ad.prototype,`metadata`,void 0),q([j()],ad.prototype,`selectedID`,void 0),ad=q([k(`pp-problems-drawer`)],ad);function od(){return globalThis.__PP_BOOTSTRAP__?.page||null}function sd(e){return e?{counts:e.counts||{errors:0,warns:0,infos:0},siteCounts:e.siteCounts,problems:e.problems||[],slices:e.slices||{},metadata:e.metadata||{},orphanCount:e.orphanCount||0}:null}async function cd(){if(u(`ppDeveloperMode`)!==`true`)return null;let e=od();return e?sd(e.developer):(await new Promise(e=>{document.addEventListener(`pp:hydrated`,()=>e(),{once:!0})}),sd(od()?.developer))}var ld=S`
    :host {
        display: block;
...
`,ud=class extends T{constructor(...e){super(...e),this.scopeLabel=``,this.drawerTitle=``,this.method=``,this.path=``,this.componentType=``,this.payload=null}static{this.styles=ld}async firstUpdated(){this.payload=await cd()}resolveDrawerContext(){let e=this.getRootNode(),t=e.querySelector?.(`#pp-operation-raw, #pp-model-raw`),n=e.querySelector?.(`pp-icon-title[icon][heading]`),r=this.scopeLabel.trim(),i=/^(GET|PUT|POST|DELETE|PATCH|OPTIONS|HEAD|TRACE)\s+(.+)$/i.exec(r),a=this.method||t?.getAttribute(`method`)||i?.[1]||``,o=this.path||t?.getAttribute(`path`)||i?.[2]||``,s=this.componentType||t?.getAttribute(`component-type`)||n?.getAttribute(`icon`)||``;return{title:this.drawerTitle||t?.getAttribute(`title`)||n?.getAttribute(`heading`)||r||`Diagnostics`,method:a,path:o,componentType:s}}showDetails(){if(!this.payload||!this.payload.problems.length)return;let e=this.resolveDrawerContext();window.dispatchEvent(new CustomEvent(`pp-show-problems`,{detail:{scopeLabel:e.title,title:e.title,method:e.method,path:e.path,componentType:e.componentType,problems:this.payload.problems,slices:this.payload.slices,metadata:this.payload.metadata}}))}renderStat(e,t,n,r,i){let a=e||0;return a<=0?w:C`
      <div class="stat ${t}">
        <sl-icon name=${n} aria-hidden="true"></sl-icon>
        <span class="label">${a}</span>
        <span class="violation">${uc(a,r,i)}</span>
      </div>
    `}render(){let e=this.payload?.counts;return!this.payload||!e||lc(e)===0?w:C`
    ...
    `}};q([A({attribute:`data-scope-label`})],ud.prototype,`scopeLabel`,void 0),q([A({attribute:`data-title`})],ud.prototype,`drawerTitle`,void 0),q([A({attribute:`data-method`})],ud.prototype,`method`,void 0),q([A({attribute:`data-path`})],ud.prototype,`path`,void 0),q([A({attribute:`data-component-type`})],ud.prototype,`componentType`,void 0),q([j()],ud.prototype,`payload`,void 0),ud=q([k(`pp-violation-stats`)],ud);var dd=S`
    :host {
        display: block;
        margin-top: var(--global-padding);
    }
...
`,fd={implicit:`IMPLICIT`,authorizationCode:`AUTHORIZATION CODE`,clientCredentials:`CLIENT CREDENTIALS`,password:`PASSWORD`};function pd(e,t,n){switch(e){case`apiKey`:switch(t){case`cookie`:return`cookie`;case`header`:return`envelope`;case`query`:return`signpost`;default:return`key`}case`http`:switch(n){case`bearer`:return`shield-lock`;case`basic`:return`person-lock`;default:return`lock`}case`oauth2`:return`key`;case`openIdConnect`:return`fingerprint`;default:return`lock`}}var md=class extends T{constructor(...e){super(...e),this.schemeJson=``,this.scheme=null}static{this.styles=[js,dd]}willUpdate(e){if(e.has(`schemeJson`)&&this.schemeJson)try{this.scheme=JSON.parse(this.schemeJson)}catch{this.scheme=null}}renderProperty(e,t){return C`
            <div class="property">
                <div class="prop-name-col"><span class="prop-name">${e}</span></div>
                <div class="prop-type-col"><span class="prop-type">${t}</span></div>
            </div>
        `}renderTypeProperty(e,t){return C`
            <div class="property">
        ...
        `}renderUrlProperty(e,t){return C`
            <div class="property">
                <div class="prop-name-col"><span class="prop-name">${e}</span></div>
                <div class="prop-type-col">
        ...
        `}renderScopes(e){let t=Object.entries(e);return t.length===0?w:C`
        ...
        `}renderFlow(e,t){return t?C`
            <div class="flow-section">
                <div class="flow-heading">${fd[e]||e.toUpperCase()}</div>
                ${t.authorizationUrl?this.renderUrlProperty(`authorizationUrl`,t.authorizationUrl):w}
                ${t.tokenUrl?this.renderUrlProperty(`tokenUrl`,t.tokenUrl):w}
                ${t.refreshUrl?this.renderUrlProperty(`refreshUrl`,t.refreshUrl):w}
                ${t.scopes&&Object.keys(t.scopes).length>0?this.renderScopes(t.scopes):w}
            </div>
        `:w}renderFlows(e){if(!e||typeof e!=`object`)return w;let t=Object.keys(e);return t.length===0?w:t.map(t=>this.renderFlow(t,e[t]))}render(){if(!this.scheme)return w;let{type:e,name:t,scheme:n,bearerFormat:r,openIdConnectUrl:i,flows:a}=this.scheme,o=pd(e,this.scheme.in,n);return C`
            <div class="scheme-properties">
                ${e?this.renderTypeProperty(e,o):w}
                ${t?this.renderProperty(`name`,t):w}
                ${this.scheme.in?this.renderProperty(`in`,this.scheme.in):w}
                ${n?this.renderProperty(`scheme`,n):w}
                ${r?this.renderProperty(`bearerFormat`,r):w}
                ${i?this.renderUrlProperty(`openIdConnectUrl`,i):w}
                ${e===`oauth2`?this.renderFlows(a):w}
            </div>
        `}};q([A({attribute:`scheme-json`})],md.prototype,`schemeJson`,void 0),q([j()],md.prototype,`scheme`,void 0),md=q([k(`pp-security-scheme`)],md);var hd=S`
    :host {
        display: block;
        position: fixed;
...
`,gd=`pp-page-nav-collapsed`,_d=`pp-page-nav-hidden`,vd=class extends T{constructor(...e){super(...e),this.pageTitle=``,this.sectionsJson=``,this.sections=[],this.collapsed=!1,this.navHidden=!1,this.activeId=``,this.scrollContainer=null,this.rafId=0,this.scrollSpySuppressed=!1,this.suppressionTimerId=0,this.boundScrollHandler=()=>this.onScroll(),this.boundHydrationHandler=()=>this.handleHydrationComplete()}static{this.styles=[hd]}connectedCallback(){super.connectedCallback(),this.collapsed=localStorage.getItem(gd)===`true`,this.navHidden=localStorage.getItem(_d)===`true`,document.addEventListener(`pp:hydrated`,this.boundHydrationHandler)}disconnectedCallback(){super.disconnectedCallback(),this.scrollContainer?.removeEventListener(`scroll`,this.boundScrollHandler),this.clearSuppressionTimer(),document.removeEventListener(`pp:hydrated`,this.boundHydrationHandler)}clearSuppressionTimer(){this.suppressionTimerId&&=(window.clearTimeout(this.suppressionTimerId),0)}updated(e){e.has(`navHidden`)&&this.toggleAttribute(`nav-hidden`,this.navHidden)}willUpdate(e){if(e.has(`sectionsJson`)&&this.sectionsJson){try{this.sections=JSON.parse(this.sectionsJson)}catch{this.sections=[]}this.loadResponseChildren(),requestAnimationFrame(()=>this.setupScrollSpy())}}loadResponseChildren(){let e=this.sections.find(e=>e.id===`section-responses`);if(!e)return;let t=()=>{let t=document.getElementById(`section-responses`);t&&typeof t.getResponseNavItems==`function`&&(e.children=t.getResponseNavItems(),this.requestUpdate())};t(),e.children?.length||customElements.whenDefined(`pp-operation-responses`).then(()=>{requestAnimationFrame(()=>{requestAnimationFrame(()=>t())})})}setupScrollSpy(){this.scrollContainer?.removeEventListener(`scroll`,this.boundScrollHandler),this.scrollContainer=document.querySelector(`pp-layout`)?.shadowRoot?.querySelector(`.content-panel`)||null,this.scrollContainer&&this.scrollContainer.addEventListener(`scroll`,this.boundScrollHandler,{passive:!0})}handleHydrationComplete(){this.loadResponseChildren(),requestAnimationFrame(()=>this.setupScrollSpy())}suppressScrollSpy(){this.scrollSpySuppressed=!0,this.clearSuppressionTimer()}scheduleScrollSpyResume(){this.clearSuppressionTimer(),this.suppressionTimerId=window.setTimeout(()=>{this.scrollSpySuppressed=!1,this.suppressionTimerId=0},150)}onScroll(){if(this.scrollSpySuppressed){this.scheduleScrollSpyResume();return}this.rafId||=requestAnimationFrame(()=>{this.rafId=0,this.updateActiveSection()})}updateActiveSection(){let e=``;for(let t of this.sections){let n=this.findElement(t.id);if(n&&n.getBoundingClientRect().top<=100&&(e=t.id),t.children)for(let n of t.children){let t=this.findElement(n.id);t&&t.getBoundingClientRect().top<=100&&(e=n.id)}}e&&e!==this.activeId&&(this.activeId=e)}findElement(e){let t=document.getElementById(e);if(t)return t;let n=document.getElementById(`section-responses`);return n?.shadowRoot?n.shadowRoot.getElementById(e):null}navigateTo(e){this.suppressScrollSpy(),this.activeId=e;let t=this.findElement(e);if(!t)return;let n=t.closest(`sl-details`);n&&!n.open?(n.addEventListener(`sl-after-show`,()=>{t.scrollIntoView({behavior:`auto`,block:`center`})},{once:!0}),n.open=!0):t.scrollIntoView({behavior:`auto`,block:`center`})}toggleCollapsed(){this.collapsed=!this.collapsed,localStorage.setItem(gd,String(this.collapsed))}toggleNavHidden(){let e=this.shadowRoot?.querySelector(`.collapse-tab`);e&&(e.addEventListener(`animationend`,()=>e.classList.remove(`flashing`),{once:!0}),e.classList.add(`flashing`));let t=this.shadowRoot?.querySelector(`.nav-container`);!this.navHidden&&t?t.style.height=t.offsetHeight+`px`:this.navHidden&&t&&(t.style.height=``),this.navHidden=!this.navHidden,localStorage.setItem(_d,String(this.navHidden))}handleTabKeydown(e){(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),this.toggleNavHidden())}statusColorClass(e){let t=e.substring(0,1);return t===`2`?`status-2xx`:t===`3`?`status-3xx`:t===`4`?`status-4xx`:t===`5`?`status-5xx`:``}render(){return C`
                ...
                <nav aria-label="Page sections">
                    ...
                    ${this.collapsed?w:C`
                        <ul class="nav-sections">
                            ${this.sections.map(e=>C`
                                <li>
                                    <a href="#${e.id}"
                                       class=${e.id===this.activeId?`active`:``}
                                       aria-current=${e.id===this.activeId?`true`:w}
        ...
        `}};q([A({attribute:`page-title`})],vd.prototype,`pageTitle`,void 0),q([A({attribute:`sections-json`})],vd.prototype,`sectionsJson`,void 0),q([j()],vd.prototype,`sections`,void 0),q([j()],vd.prototype,`collapsed`,void 0),q([j()],vd.prototype,`navHidden`,void 0),q([j()],vd.prototype,`activeId`,void 0),vd=q([k(`pp-page-nav`)],vd);var yd=S`
    :host {
        display: block;
        margin-top: var(--global-padding-double);
    }
...
`,bd=function(e){return e.LineNumber=`Line Number`,e.Severity=`Severity`,e}(bd||{}),xd=Object.values(bd),Sd={operations:`Operations`,schemas:`Schemas`,parameters:`Parameters`,responses:`Responses`,requestBodies:`Request Bodies`,headers:`Headers`,securitySchemes:`Security Schemes`,examples:`Examples`,links:`Links`,callbacks:`Callbacks`,pathItems:`Path Items`},Cd={operations:10,schemas:20,parameters:30,responses:40,requestBodies:50,headers:60,securitySchemes:70,examples:80,links:90,callbacks:100,pathItems:110,overview:900,unlinked:1e3},wd=class extends T{constructor(...e){super(...e),this.payload=null,this.selectedSort=bd.Severity,this.currentPage=1,this.groupPages={},this.groupSorts={},this.activePanel=`list-view`,this.itemsPerPage=20,this.sortCache=new Map,this.groupCache=null}static{this.styles=[Tc,yd]}async firstUpdated(){this.payload=await cd()}handleSortSelect(e){let t=e.detail?.item?.value;xd.includes(t)&&(this.selectedSort=t,this.currentPage=1)}handleGroupSortSelect(e,t){let n=t.detail?.item?.value;xd.includes(n)&&(this.groupSorts={...this.groupSorts,[e.key]:n},this.setGroupPage(e.key,1,e.problems.length))}handleTabShow(e){let t=e.detail?.name;(t===`list-view`||t===`grouped-view`)&&(this.activePanel=t)}totalPages(e){return Math.max(1,Math.ceil(e/this.itemsPerPage))}handleFirstPage(e){e.stopPropagation(),this.currentPage=1}handlePreviousPage(e){e.stopPropagation(),this.currentPage=Math.max(1,this.currentPage-1)}handleNextPage(e){e.stopPropagation(),this.currentPage=Math.min(this.totalPages(this.payload?.problems.length||0),this.currentPage+1)}handleLastPage(e){e.stopPropagation(),this.currentPage=this.totalPages(this.payload?.problems.length||0)}groupCurrentPage(e,t){return Math.min(this.groupPages[e]||1,this.totalPages(t))}groupSort(e){return this.groupSorts[e]||bd.Severity}setGroupPage(e,t,n){this.groupPages={...this.groupPages,[e]:Math.min(Math.max(1,t),this.totalPages(n))}}handleGroupFirstPage(e,t){t.stopPropagation(),this.setGroupPage(e.key,1,e.problems.length)}handleGroupPreviousPage(e,t){t.stopPropagation(),this.setGroupPage(e.key,this.groupCurrentPage(e.key,e.problems.length)-1,e.problems.length)}handleGroupNextPage(e,t){t.stopPropagation(),this.setGroupPage(e.key,this.groupCurrentPage(e.key,e.problems.length)+1,e.problems.length)}handleGroupLastPage(e,t){t.stopPropagation(),this.setGroupPage(e.key,this.totalPages(e.problems.length),e.problems.length)}location(e){return`${e.startLineNumber>0?e.startLineNumber:`-`}:${e.startColumn>0?e.startColumn:`-`}`}metadata(e){return this.payload?.metadata?.[e.id]||{}}problemHref(e,t=this.metadata(e)){return e.pageHref||t.pageHref||``}componentLabel(e){return Sd[e]?Sd[e]:e.replace(/([a-z0-9])([A-Z])/g,`$1 $2`).replace(/[-_]+/g,` `).replace(/\b\w/g,e=>e.toUpperCase())}groupKey(e){let t=this.metadata(e),n=e.pageKind||t.pageKind||``,r=e.pageComponent||t.pageComponent||``;return n===`operation`?{key:`operations`,title:Sd.operations,icon:`operations`,order:Cd.operations}:n===`model`&&r?{key:r,title:this.componentLabel(r),icon:r,order:Cd[r]||500}:n===`overview`?{key:`overview`,title:`API Overview`,icon:`document`,order:Cd.overview}:{key:`unlinked`,title:`Unlinked`,icon:`document`,order:Cd.unlinked}}renderTarget(e){let t=this.metadata(e),n=this.problemHref(e,t),r=e.pageTitle||t.pageTitle||``,i=e.pageKind||t.pageKind||``,a=e.pageMethod||t.pageMethod||``,o=e.pagePath||t.pagePath||``,s=e.pageOperationId||t.pageOperationId||``,c=e.pageComponent||t.pageComponent||``,l=r||n;return n?i===`operation`&&a&&(s||o)?C`
        <a class="page page-operation" href=${Fs(n)}>
          ${s?C`<span class="operation-label">${s}</span>`:C`<pb33f-render-operation-path path=${o} nowrap></pb33f-render-operation-path>`}
          <pb33f-http-method mode="nav-naked" method=${a}></pb33f-http-method>
        </a>
      `:i===`model`&&c?C`
        <a class="page page-model" href=${Fs(n)}>
          <pb33f-model-icon icon=${c} size="small"></pb33f-model-icon>
          <span>${l}</span>
        </a>
      `:C`<a class="page" href=${Fs(n)}>${l}</a>`:C`<span class="page empty-page">${l}</span>`}renderProblemMessage(e){let t=X(e.message,{className:`message pp-markdown-inline`,inline:!0}),n=this.problemHref(e);return n?C`<a class="message-link" href=${Fs(n)}>${t}</a>`:t}renderSummaryStat(e,t,n,r,i){let a=e||0;return a<=0?w:C`
      <div class="stat ${t}">
        <sl-icon name=${n} aria-hidden="true"></sl-icon>
        <span>${a}</span>
        <small>${uc(a,r,i)}</small>
      </div>
    `}lineCompare(e,t){return e.startLineNumber-t.startLineNumber||e.startColumn-t.startColumn||e.id.localeCompare(t.id)}compareProblems(e,t,n){switch(n){case bd.LineNumber:return this.lineCompare(e,t);case bd.Severity:return t.severity-e.severity||this.lineCompare(e,t);default:return this.lineCompare(e,t)}}sortProblems(e,t){return[...e].sort((e,n)=>this.compareProblems(e,n,t))}memoizedSortProblems(e,t,n){let r=this.sortCache.get(e);if(r&&r.problems===t&&r.sort===n)return r.value;let i=this.sortProblems(t,n);return this.sortCache.set(e,{problems:t,sort:n,value:i}),i}groupedProblems(e){if(this.groupCache?.problems===e)return this.groupCache.value;let t=new Map;for(let n of e){let e=this.groupKey(n),r=t.get(e.key);r||(r={...e,problems:[]},t.set(e.key,r)),r.problems.push(n)}let n=[...t.values()].sort((e,t)=>e.order-t.order||e.title.localeCompare(t.title));return this.groupCache={problems:e,value:n},n}renderSortControl(e,t){return C`
    ...
    `}renderProblemRow(e){return C`
      <div class="row ${dc(e.severity)}">
        <span class="severity">
          <sl-icon
            class="severity-icon"
            name=${fc(e.severity)}
    ...
    `}renderListView(e){let t=this.totalPages(e.length),n=Math.min(this.currentPage,t),r=(n-1)*this.itemsPerPage,i=e.slice(r,r+this.itemsPerPage);return C`
      ...
      <div class="list">
        ${e.length?C`
          ...
          `:C`<div class="empty">No diagnostics found</div>`}
      </div>
    `}renderGroupedView(e){let t=this.groupedProblems(e);return C`
      <div class="grouped-list">
        ${t.length?t.map(e=>this.renderProblemGroup(e)):C`<div class="empty">No diagnostics found</div>`}
      </div>
    `}renderProblemGroup(e){let t=this.memoizedSortProblems(`group:${e.key}`,e.problems,this.groupSort(e.key)),n=this.totalPages(t.length),r=this.groupCurrentPage(e.key,t.length),i=(r-1)*this.itemsPerPage,a=t.slice(i,i+this.itemsPerPage);return C`
      <section class="problem-group">
        <div class="group-header">
          ...
          <div class="group-actions">
            ...
            <span class="group-count">${e.problems.length} ${uc(e.problems.length,`problem`)}</span>
          </div>
        </div>
    ...
    `}render(){if(!this.payload)return w;let e=this.payload.siteCounts||this.payload.counts,t=this.payload.problems||[];return C`
      <div class="summary" role="group" aria-label="Sitewide diagnostics">
        ...
        ${this.payload.orphanCount?C`<div class="stat orphan"><span>${this.payload.orphanCount}</span><small>${uc(this.payload.orphanCount,`orphan`)}</small></div>`:w}
      </div>
