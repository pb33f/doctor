...
`,au=class extends D{constructor(...e){super(...e),this.icon=``,this.heading=``,this.level=1,this.size=`huge`}static{this.styles=[iu]}render(){if(!this.heading)return E;let e=Yn(`h${Math.min(Math.max(this.level,1),6)}`);return Qn`
        ...
        `}};J([M()],au.prototype,`icon`,void 0),J([M()],au.prototype,`heading`,void 0),J([M({type:Number})],au.prototype,`level`,void 0),J([M()],au.prototype,`size`,void 0),au=J([j(`pp-icon-title`)],au);var ou,su=class extends D{static{ou=this}constructor(...e){super(...e),this.registryKey=``,this.schemaRef=``,this.active=!1,this.entry=null,this.model=null,this.parsedData=null,this.triggerTargets=new Set,this.pointerWithinTrigger=!1,this.pointerWithinPopup=!1,this.focusWithinPopup=!1,this.onTriggerEnter=()=>{this.pointerWithinTrigger=!0,this.show()},this.onTriggerLeave=e=>{this.pointerWithinTrigger=!1;let t=e.relatedTarget;this.containsInteractiveNode(t)||this.scheduleHide()},this.onSlotChange=()=>{this.syncTriggerTargets()},this.onPopupEnter=()=>{this.pointerWithinPopup=!0,this.cancelHide()},this.onPopupLeave=e=>{this.pointerWithinPopup=!1;let t=e.relatedTarget;this.containsInteractiveNode(t)||this.scheduleHide()},this.onPopupFocusIn=()=>{this.focusWithinPopup=!0,this.cancelHide()},this.onPopupFocusOut=e=>{let t=e.relatedTarget;this.containsInteractiveNode(t)||(this.focusWithinPopup=!1,this.scheduleHide())},this.onPopupInteraction=()=>{this.pointerWithinPopup=!0,this.cancelHide()}}static{this.styles=Vl}static{this.showDelayMs=300}static{this.hideDelayMs=400}firstUpdated(){this.syncTriggerTargets(),this.triggerSlot?.addEventListener(`slotchange`,this.onSlotChange)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.showTimeout),clearTimeout(this.hideTimeout),this.triggerSlot?.removeEventListener(`slotchange`,this.onSlotChange),this.clearTriggerTargets(),this.pointerWithinTrigger=!1,this.pointerWithinPopup=!1,this.focusWithinPopup=!1,this.active=!1}containsInteractiveNode(e){return e?this.contains(e)||this.renderRoot.contains(e):!1}isInteractivelyActive(){return this.pointerWithinTrigger||this.pointerWithinPopup||this.focusWithinPopup}clearTriggerTargets(){for(let e of this.triggerTargets)e.removeEventListener(`mouseenter`,this.onTriggerEnter),e.removeEventListener(`mouseleave`,this.onTriggerLeave),e.removeEventListener(`focusin`,this.onTriggerEnter),e.removeEventListener(`focusout`,this.onTriggerLeave);this.triggerTargets.clear()}syncTriggerTargets(){this.clearTriggerTargets();let e=new Set;this.trigger&&e.add(this.trigger);for(let t of this.triggerSlot?.assignedElements({flatten:!0})??[])t instanceof HTMLElement&&e.add(t);for(let t of e)t.addEventListener(`mouseenter`,this.onTriggerEnter),t.addEventListener(`mouseleave`,this.onTriggerLeave),t.addEventListener(`focusin`,this.onTriggerEnter),t.addEventListener(`focusout`,this.onTriggerLeave),this.triggerTargets.add(t)}show(){clearTimeout(this.hideTimeout),this.showTimeout=window.setTimeout(async()=>{if(this.entry=(this.registryKey?_(this.registryKey):ne(this.schemaRef))??null,this.entry&&(this.model=(this.registryKey?await y(this.registryKey):await b(this.schemaRef))??null,this.model)){try{this.parsedData=JSON.parse(this.model.schemaJson)}catch{this.parsedData=null}this.active=!0}},ou.showDelayMs)}scheduleHide(){clearTimeout(this.showTimeout),this.hideTimeout=window.setTimeout(()=>{this.isInteractivelyActive()||(this.active=!1)},ou.hideDelayMs)}cancelHide(){clearTimeout(this.hideTimeout)}resolveExample(){if(this.model?.mockJson)return this.model.mockJson;let e=this.parsedData;return e?e.schema?.example===void 0?e.example===void 0?Array.isArray(e.examples)&&e.examples.length>0?JSON.stringify(e.examples[0]):null:JSON.stringify(e.example):JSON.stringify(e.schema.example):null}getSchemaJson(){if(!this.model)return``;let e=this.parsedData;return e&&e.schema?JSON.stringify(e.schema):this.model.schemaJson}formatJson(e){try{return JSON.stringify(JSON.parse(e),null,2)}catch{return e}}render(){let e=this.resolveExample(),t=this.getSchemaJson();return T`
            ...
            `:E}
        `}};J([M({attribute:`registry-key`})],su.prototype,`registryKey`,void 0),J([M({attribute:`schema-ref`})],su.prototype,`schemaRef`,void 0),J([N()],su.prototype,`active`,void 0),J([N()],su.prototype,`entry`,void 0),J([N()],su.prototype,`model`,void 0),J([N()],su.prototype,`parsedData`,void 0),J([P(`.trigger`)],su.prototype,`trigger`,void 0),J([P(`slot`)],su.prototype,`triggerSlot`,void 0),su=ou=J([j(`pp-ref-popover`)],su);var cu=w`
    :host {
        display: block;
    }
...
`,lu=class extends D{constructor(...e){super(...e),this.extensionsJson=``,this.extensions=[]}static{this.styles=cu}willUpdate(e){if(e.has(`extensionsJson`))if(this.extensionsJson)try{this.extensions=JSON.parse(this.extensionsJson)}catch{this.extensions=[]}else this.extensions=[]}renderValue(e){return e==null?E:typeof e==`object`?T`<pp-code-viewer code=${JSON.stringify(e,null,2)} language="json"></pp-code-viewer>`:T`<span class="ext-scalar">${String(e)}</span>`}render(){return this.extensions.length?T`<div class="ext-grid">
      ${this.extensions.map(e=>T`
        <div class="ext-key">${e.key}</div>
        <div class="ext-value">${this.renderValue(e.value)}</div>
      `)}
    </div>`:E}};J([M({attribute:`extensions-json`})],lu.prototype,`extensionsJson`,void 0),J([N()],lu.prototype,`extensions`,void 0),lu=J([j(`pp-extensions`)],lu);var uu=class extends D{constructor(...e){super(...e),this.parametersJson=``,this.params=[]}static{this.styles=[Cs,dc,fc,pc,mc]}willUpdate(e){if(e.has(`parametersJson`)&&this.parametersJson)try{this.params=JSON.parse(this.parametersJson)}catch{this.params=[]}}inIcon(e){switch(e){case`cookie`:return`cookie`;case`header`:return`envelope`;case`path`:return`signpost`;case`query`:return`question-diamond`;default:return`question-diamond`}}parseSchema(e){if(!e)return null;try{return JSON.parse(e)}catch{return null}}render(){return this.params.length?T`
      ${this.params.map(e=>{let t=this.parseSchema(e.schemaJson),n=yc(t);return T`
        ...
        `})}
    `:E}};J([M({attribute:`parameters-json`})],uu.prototype,`parametersJson`,void 0),J([N()],uu.prototype,`params`,void 0),uu=J([j(`pp-operation-parameters`)],uu);var du=w`
    .status-ok {
        color: var(--primary-color);
        font-family: var(--font-stack-bold), monospace;
    }
...
`,yu=class extends D{constructor(...e){super(...e),this.examplesData=``,this.mockJson=``,this.examplesJson=``,this.descriptionsJson=``,this.mode=`drawer`,this.codeLanguage=`json`,this.hideLabel=!1,this.showExpand=!1,this.exampleTitle=`Example`,this.entries=[],this.descriptions={},this.selectedIndex=0}static{this.styles=[..._u,fc,vu]}willUpdate(e){(e.has(`examplesData`)||e.has(`mockJson`)||e.has(`examplesJson`)||e.has(`descriptionsJson`))&&this.buildEntries()}buildEntries(){let e=[],t=this.mockJson,n={};if(this.examplesData)try{let e=JSON.parse(this.examplesData);e.mockJson&&(t=e.mockJson),e.examples&&(n=e.examples)}catch{}if(this.examplesJson)try{n={...n,...JSON.parse(this.examplesJson)}}catch{}for(let[t,r]of Object.entries(n))r&&e.push({key:t,json:r});if(t&&e.push({key:``,json:t}),this.entries=e,this.selectedIndex=0,this.descriptionsJson)try{this.descriptions=JSON.parse(this.descriptionsJson)}catch{this.descriptions={}}else this.descriptions={}}showExample(e){let t=e.json;if(this.codeLanguage===`json`)try{t=JSON.stringify(JSON.parse(e.json),null,2)}catch{}let n=new CustomEvent(`pp-show-example`,{bubbles:!0,composed:!0,detail:{title:e.key,json:t,language:this.codeLanguage}});this.dispatchEvent(n)}handleSelect(e){let t=e.detail?.item?.value;if(t===void 0)return;let n=parseInt(t,10);n>=0&&n<this.entries.length&&this.showExample(this.entries[n])}render(){if(!this.entries.length)return E;if(this.mode===`inline`)return this.renderInline();if(this.entries.length===1){let e=this.entries[0];return T`
    ...
    `}handleInlineSelect(e){let t=e.detail?.item?.value;t!==void 0&&(this.selectedIndex=parseInt(t,10))}};J([M({attribute:`examples-data`})],yu.prototype,`examplesData`,void 0),J([M({attribute:`mock-json`})],yu.prototype,`mockJson`,void 0),J([M({attribute:`examples-json`})],yu.prototype,`examplesJson`,void 0),J([M({attribute:`descriptions-json`})],yu.prototype,`descriptionsJson`,void 0),J([M()],yu.prototype,`mode`,void 0),J([M({attribute:`code-language`})],yu.prototype,`codeLanguage`,void 0),J([M({type:Boolean,attribute:`hide-label`})],yu.prototype,`hideLabel`,void 0),J([M({type:Boolean,attribute:`show-expand`})],yu.prototype,`showExpand`,void 0),J([M({attribute:`example-title`})],yu.prototype,`exampleTitle`,void 0),J([N()],yu.prototype,`entries`,void 0),J([N()],yu.prototype,`descriptions`,void 0),J([N()],yu.prototype,`selectedIndex`,void 0),yu=J([j(`pp-example-selector`)],yu);var bu=[xs,w`
    :host {
        display: block;
    }
...
`],xu=class extends D{constructor(...e){super(...e),this.contentJson=``,this.mediaTypes=[],this.selectedIndex=0,this.schemasIdentical=!1,this.wide=!1,this.resizeObserver=null,this.paneResizeObserver=null,this._sizePending=!1,this._rafId=0,this.observedPropsPane=null,this.observedExamplePane=null,this.observedPropsContent=null,this.observedExampleContent=null}static{this.styles=[Cs,pc,bu]}connectedCallback(){super.connectedCallback(),setTimeout(()=>{this.wide=this.offsetWidth>=900,!(typeof ResizeObserver>`u`)&&(this.resizeObserver=new ResizeObserver(e=>{for(let t of e)this.wide=t.contentRect.width>=900}),this.resizeObserver.observe(this),this.paneResizeObserver=new ResizeObserver(()=>{this.sizeSplitPanel()}))},0)}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this._rafId),this.resizeObserver?.disconnect(),this.resizeObserver=null,this.paneResizeObserver?.disconnect(),this.paneResizeObserver=null,this.observedPropsPane=null,this.observedExamplePane=null,this.observedPropsContent=null,this.observedExampleContent=null}updated(e){(e.has(`wide`)||e.has(`selectedIndex`)||e.has(`mediaTypes`))&&this.sizeSplitPanel(),this.syncPaneObservers()}sizeSplitPanel(){!this.splitPanel||!this.propsPane||!this.examplePane||this._sizePending||(this._sizePending=!0,this._rafId=requestAnimationFrame(()=>{if(this._sizePending=!1,!this.splitPanel||!this.propsPane||!this.examplePane)return;let e=this.measurePaneContentHeight(this.propsPane),t=this.measurePaneContentHeight(this.examplePane),n=document.documentElement.clientHeight||800,r=this.mediaTypes[this.selectedIndex],i=this.getPropCount(r),a=Math.max(e,t),o=i>=6?300:220,s=n*.75,c=Math.max(o,Math.min(a,s)),l=getComputedStyle(this.splitPanel),u=parseFloat(l.paddingTop)+parseFloat(l.paddingBottom);this.splitPanel.style.height=`${c+u}px`}))}measurePaneContentHeight(e){let t=Array.from(e.children).reduce((e,t)=>e+Math.max(t.offsetHeight,t.scrollHeight),0),n=getComputedStyle(e);return t+(parseFloat(n.paddingTop)+parseFloat(n.paddingBottom))}syncPaneObservers(){if(!this.paneResizeObserver||typeof ResizeObserver>`u`)return;let e=this.propsPane??null,t=this.examplePane??null,n=e?.firstElementChild??null,r=t?.firstElementChild??null;this.observedPropsPane!==e&&(this.observedPropsPane&&this.paneResizeObserver.unobserve(this.observedPropsPane),e&&this.paneResizeObserver.observe(e),this.observedPropsPane=e),this.observedExamplePane!==t&&(this.observedExamplePane&&this.paneResizeObserver.unobserve(this.observedExamplePane),t&&this.paneResizeObserver.observe(t),this.observedExamplePane=t),this.observedPropsContent!==n&&(this.observedPropsContent&&this.paneResizeObserver.unobserve(this.observedPropsContent),n instanceof Element&&this.paneResizeObserver.observe(n),this.observedPropsContent=n),this.observedExampleContent!==r&&(this.observedExampleContent&&this.paneResizeObserver.unobserve(this.observedExampleContent),r instanceof Element&&this.paneResizeObserver.observe(r),this.observedExampleContent=r)}getPropCount(e){let t=e?.isArray&&e?.itemsSchemaJson?e.itemsSchemaJson:e?.schemaJson;if(!t)return 0;try{let e=JSON.parse(t);return e.properties?Object.keys(e.properties).length:0}catch{return 0}}isComplexWithExample(e){if(!e.schemaJson&&!(e.isArray&&e.itemsSchemaJson))return!1;let t=e.isArray&&e.itemsSchemaJson?e.itemsSchemaJson:e.schemaJson;if(!t)return!1;try{let n=JSON.parse(t),r=n.properties||n.allOf||n.oneOf||n.anyOf,i=!!(e.mockJson||e.mockYaml||e.mockXml||e.examples&&Object.keys(e.examples).length);return!!r&&i}catch{return!1}}willUpdate(e){if(e.has(`contentJson`)&&this.contentJson){try{this.mediaTypes=JSON.parse(this.contentJson)}catch{this.mediaTypes=[]}let e=this.mediaTypes.findIndex(e=>e.mediaType.toLowerCase()===`application/json`);this.selectedIndex=e>=0?e:0,this.schemasIdentical=this.mediaTypes.length>1&&new Set(this.mediaTypes.map(e=>this.schemaFingerprint(e))).size===1}}schemaFingerprint(e){return e.isArray&&e.itemsRef?`array:${e.itemsRef.slug}:${e.itemsSchemaJson||e.schemaJson}`:e.schemaRef?`ref:${e.schemaRef.componentType}/${e.schemaRef.slug}`:`inline:${e.schemaJson}`}getMockAndLanguage(e){let t=e.mediaType.toLowerCase();return(t.includes(`yaml`)||t.includes(`x-yaml`))&&e.mockYaml?{mock:e.mockYaml,language:`yaml`}:t.includes(`xml`)&&e.mockXml?{mock:e.mockXml,language:`xml`}:{mock:e.mockJson||``,language:`json`}}renderSchemaHeader(e){return e.isArray&&e.itemsRef?T`
        ...
        `}render(){if(!this.mediaTypes.length)return E;if(this.mediaTypes.length===1){let e=this.mediaTypes[0];if(this.wide&&this.isComplexWithExample(e))return T`
            ...
            ${this.renderSchemaProperties(e)}
            ${this.renderExtensions(e)}
        `}};J([M({attribute:`content-json`})],xu.prototype,`contentJson`,void 0),J([N()],xu.prototype,`mediaTypes`,void 0),J([N()],xu.prototype,`selectedIndex`,void 0),J([N()],xu.prototype,`schemasIdentical`,void 0),J([N()],xu.prototype,`wide`,void 0),J([P(`.schema-split`)],xu.prototype,`splitPanel`,void 0),J([P(`.schema-props-pane`)],xu.prototype,`propsPane`,void 0),J([P(`.schema-example-pane`)],xu.prototype,`examplePane`,void 0),xu=J([j(`pp-media-type-selector`)],xu);var Su=class extends D{constructor(...e){super(...e),this.responsesJson=``,this.commonHeadersJson=``,this.responses=[],this.commonResponseHeaders=[],this.commonHeaderNames=new Set,this.commonErrorKeys=new Set,this.commonErrorResponses=new Map,this.successResponses=[],this.redirectResponses=[],this.errorResponses=[]}static{this.styles=[Cs,dc,fc,pc,du,fu,pu]}willUpdate(e){if(e.has(`responsesJson`)&&this.responsesJson){try{this.responses=JSON.parse(this.responsesJson)}catch{this.responses=[]}let e=[...this.responses].sort((e,t)=>parseInt(e.statusCode,10)-parseInt(t.statusCode,10)),t=[],n=[],r=[];for(let i of e){let e=parseInt(i.statusCode,10);e>=400?r.push(i):e>=300?n.push(i):t.push(i)}this.successResponses=t,this.redirectResponses=n,this.errorResponses=r;let{commonKeys:i,commonResponses:a}=this.computeCommonErrors(r);this.commonErrorKeys=i,this.commonErrorResponses=a}if(e.has(`commonHeadersJson`)&&this.commonHeadersJson){try{this.commonResponseHeaders=JSON.parse(this.commonHeadersJson)}catch{this.commonResponseHeaders=[]}this.commonHeaderNames=new Set(this.commonResponseHeaders.map(e=>e.name))}}getResponseNavItems(){let e=[];for(let t of[...this.successResponses,...this.redirectResponses,...this.errorResponses])e.push({label:`${t.statusCode} ${hu[t.statusCode]||``}`.trim(),id:`response-${t.statusCode}`});return e}scrollToHeader(e){let t=this.shadowRoot?.getElementById(`header-`+e);if(!t)return;let n=t.closest(`sl-details`);n&&!n.open?(n.open=!0,n.updateComplete?.then(()=>{t.scrollIntoView({behavior:`auto`,block:`center`})})):t.scrollIntoView({behavior:`auto`,block:`center`})}renderHeaderEntry(e){return T`
        ...
        `:E}render(){if(!this.responses.length)return E;let e=this.commonHeaderNames,t=this.commonErrorKeys,n=this.commonErrorResponses;return T`
            ...
            `:E}
        `}};J([M({attribute:`responses-json`})],Su.prototype,`responsesJson`,void 0),J([M({attribute:`common-headers-json`})],Su.prototype,`commonHeadersJson`,void 0),J([N()],Su.prototype,`responses`,void 0),J([N()],Su.prototype,`commonResponseHeaders`,void 0),J([N()],Su.prototype,`commonHeaderNames`,void 0),J([N()],Su.prototype,`commonErrorKeys`,void 0),J([N()],Su.prototype,`commonErrorResponses`,void 0),J([N()],Su.prototype,`successResponses`,void 0),J([N()],Su.prototype,`redirectResponses`,void 0),J([N()],Su.prototype,`errorResponses`,void 0),Su=J([j(`pp-operation-responses`)],Su);var Cu=w`
    :host {
        display: block;
    }
...
`,wu=class extends D{constructor(...e){super(...e),this.callbacksJson=``,this.callbacks=[]}static{this.styles=[Cs,fc,pc,du,Cu]}willUpdate(e){if(e.has(`callbacksJson`)&&this.callbacksJson)try{this.callbacks=JSON.parse(this.callbacksJson)}catch{this.callbacks=[]}}renderRequestBody(e){return e.ref?T`<div class="callback-section-label">Request Body</div>${Rl(e.ref,!0)}`:e.content?.length?T`
        ...
        `}render(){return this.callbacks.length?T`
            ...
            `)}
        `:E}};J([M({attribute:`callbacks-json`})],wu.prototype,`callbacksJson`,void 0),J([N()],wu.prototype,`callbacks`,void 0),wu=J([j(`pp-operation-callbacks`)],wu);var Tu=w`
    :host {
        display: block;
        margin-top: var(--global-padding-double);
    }
...
`)!==-1)}
    ...
    `}renderHeader(e){let t=e.schema||{},n=[];return e.required&&n.push({label:`required`,value:`true`}),e.deprecated&&n.push({label:`deprecated`,value:`true`}),n.push(...this.collectSchemaEntries(t)),T`
      ...
      ${this.renderPropertyGrid(n)}
    `}renderContent(e){return!Array.isArray(e.content)||!e.content.length?E:T`<pp-media-type-selector content-json=${JSON.stringify(e.content)}></pp-media-type-selector>`}renderSchema(e){if(!(e.properties||e.allOf||e.oneOf||e.anyOf)){let t=this.collectSchemaEntries(e);return T`
    ...
    `}render(){if(!this.parsed)return this.renderSkeleton();let e=this.parsed;return e.in?this.renderParameter(e):e.schema&&!e.properties&&!e.in?this.renderHeader(e):e.content?.length?this.renderContent(e):this.renderSchema(e)}};J([M({attribute:`model-json`})],Q.prototype,`modelJson`,void 0),J([M()],Q.prototype,`name`,void 0),J([M({attribute:`layout-mode`})],Q.prototype,`layoutMode`,void 0),J([M({attribute:`estimated-body-height`,type:Number})],Q.prototype,`estimatedBodyHeight`,void 0),J([M({attribute:`estimated-split-height`,type:Number})],Q.prototype,`estimatedSplitHeight`,void 0),J([M({attribute:`property-count`,type:Number})],Q.prototype,`propertyCount`,void 0),J([M({attribute:`required-count`,type:Number})],Q.prototype,`requiredCount`,void 0),J([M({attribute:`has-example`,type:Boolean})],Q.prototype,`hasExample`,void 0),J([M({attribute:`raw-yaml`})],Q.prototype,`rawYaml`,void 0),J([M({attribute:`schema-raw-yaml`})],Q.prototype,`schemaRawYaml`,void 0),J([M({attribute:`schema-raw-json`})],Q.prototype,`schemaRawJson`,void 0),J([M({attribute:`schema-start-line`,type:Number})],Q.prototype,`schemaStartLine`,void 0),J([M({attribute:`start-line`,type:Number})],Q.prototype,`startLine`,void 0),J([M()],Q.prototype,`location`,void 0),J([M({attribute:`mock-json`})],Q.prototype,`mockJson`,void 0),J([N()],Q.prototype,`parsed`,void 0),J([N()],Q.prototype,`wide`,void 0),J([N()],Q.prototype,`exampleJson`,void 0),J([P(`.schema-split`)],Q.prototype,`splitPanel`,void 0),J([P(`.schema-props-pane`)],Q.prototype,`propsPane`,void 0),J([P(`.schema-example-pane`)],Q.prototype,`examplePane`,void 0),Q=J([j(`pp-model-page`)],Q);var Ou=w`
  :host {
    display: block;
  }
  a {
...
`,ku=class extends D{constructor(...e){super(...e),this.name=``,this.href=``,this.description=``}static{this.styles=[fc,Ou]}render(){return T`
      <a href=${this.href}>
        <strong>${this.name}</strong>
        ${Ll(this.description)}
      </a>
    `}};J([M()],ku.prototype,`name`,void 0),J([M()],ku.prototype,`href`,void 0),J([M()],ku.prototype,`description`,void 0),ku=J([j(`pp-model-card`)],ku);var Au=w`
    :host {
        display: block;
        margin-top: var(--global-padding);
        padding-top: var(--global-padding);
...
`,Nu=(e=`value`)=>(t,n)=>{let r=t.constructor,i=r.prototype.attributeChangedCallback;r.prototype.attributeChangedCallback=function(t,a,o){let s=r.getPropertyOptions(e);if(t===(typeof s.attribute==`string`?s.attribute:e)){let t=s.converter||at,r=(typeof t==`function`?t:t?.fromAttribute??at.fromAttribute)(o,s.type);this[e]!==r&&(this[n]=r)}i.call(this,t,a,o)}},Pu=w`
...
`,Fu=Gn(class extends Kn{constructor(e){if(super(e),e.type!==Wn.PROPERTY&&e.type!==Wn.ATTRIBUTE&&e.type!==Wn.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!In(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===At||t===E)return t;let n=e.element,r=e.name;if(e.type===Wn.PROPERTY){if(t===n[r])return At}else if(e.type===Wn.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return At}else if(e.type===Wn.ATTRIBUTE&&n.getAttribute(r)===t+``)return At;return Rn(e),t}}),$=class extends F{constructor(){super(...arguments),this.formControlController=new ao(this,{assumeInteractionOn:[`sl-blur`,`sl-input`]}),this.hasSlotController=new Ha(this,`help-text`,`label`),this.localize=new z(this),this.hasFocus=!1,this.title=``,this.__numberInput=Object.assign(document.createElement(`input`),{type:`number`}),this.__dateInput=Object.assign(document.createElement(`input`),{type:`date`}),this.type=`text`,this.name=``,this.value=``,this.defaultValue=``,this.size=`medium`,this.filled=!1,this.pill=!1,this.label=``,this.helpText=``,this.clearable=!1,this.disabled=!1,this.placeholder=``,this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form=``,this.required=!1,this.spellcheck=!0}get valueAsDate(){return this.__dateInput.type=this.type,this.__dateInput.value=this.value,this.input?.valueAsDate||this.__dateInput.valueAsDate}set valueAsDate(e){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=e,this.value=this.__dateInput.value}get valueAsNumber(){return this.__numberInput.value=this.value,this.input?.valueAsNumber||this.__numberInput.valueAsNumber}set valueAsNumber(e){this.__numberInput.valueAsNumber=e,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`sl-blur`)}handleChange(){this.value=this.input.value,this.emit(`sl-change`)}handleClearClick(e){e.preventDefault(),this.value!==``&&(this.value=``,this.emit(`sl-clear`),this.emit(`sl-input`),this.emit(`sl-change`)),this.input.focus()}handleFocus(){this.hasFocus=!0,this.emit(`sl-focus`)}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit(`sl-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleKeyDown(e){let t=e.metaKey||e.ctrlKey||e.shiftKey||e.altKey;e.key===`Enter`&&!t&&setTimeout(()=>{!e.defaultPrevented&&!e.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){this.input.step=String(this.step),this.formControlController.updateValidity()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){`showPicker`in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t,i=this.clearable&&!this.disabled&&!this.readonly&&(typeof this.value==`number`||this.value.length>0);return T`
    ...
    `}};$.styles=[A,Pu,Mu],$.dependencies={"sl-icon":Un},O([P(`.input__control`)],$.prototype,`input`,2),O([N()],$.prototype,`hasFocus`,2),O([M()],$.prototype,`title`,2),O([M({reflect:!0})],$.prototype,`type`,2),O([M()],$.prototype,`name`,2),O([M()],$.prototype,`value`,2),O([Nu()],$.prototype,`defaultValue`,2),O([M({reflect:!0})],$.prototype,`size`,2),O([M({type:Boolean,reflect:!0})],$.prototype,`filled`,2),O([M({type:Boolean,reflect:!0})],$.prototype,`pill`,2),O([M()],$.prototype,`label`,2),O([M({attribute:`help-text`})],$.prototype,`helpText`,2),O([M({type:Boolean})],$.prototype,`clearable`,2),O([M({type:Boolean,reflect:!0})],$.prototype,`disabled`,2),O([M()],$.prototype,`placeholder`,2),O([M({type:Boolean,reflect:!0})],$.prototype,`readonly`,2),O([M({attribute:`password-toggle`,type:Boolean})],$.prototype,`passwordToggle`,2),O([M({attribute:`password-visible`,type:Boolean})],$.prototype,`passwordVisible`,2),O([M({attribute:`no-spin-buttons`,type:Boolean})],$.prototype,`noSpinButtons`,2),O([M({reflect:!0})],$.prototype,`form`,2),O([M({type:Boolean,reflect:!0})],$.prototype,`required`,2),O([M()],$.prototype,`pattern`,2),O([M({type:Number})],$.prototype,`minlength`,2),O([M({type:Number})],$.prototype,`maxlength`,2),O([M()],$.prototype,`min`,2),O([M()],$.prototype,`max`,2),O([M()],$.prototype,`step`,2),O([M()],$.prototype,`autocapitalize`,2),O([M()],$.prototype,`autocorrect`,2),O([M()],$.prototype,`autocomplete`,2),O([M({type:Boolean})],$.prototype,`autofocus`,2),O([M()],$.prototype,`enterkeyhint`,2),O([M({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],$.prototype,`spellcheck`,2),O([M()],$.prototype,`inputmode`,2),O([k(`disabled`,{waitUntilFirstUpdate:!0})],$.prototype,`handleDisabledChange`,1),O([k(`step`,{waitUntilFirstUpdate:!0})],$.prototype,`handleStepChange`,1),O([k(`value`,{waitUntilFirstUpdate:!0})],$.prototype,`handleValueChange`,1),$.define(`sl-input`);var Iu={schemas:`Schemas`,responses:`Responses`,parameters:`Parameters`,requestBodies:`Request Bodies`,headers:`Headers`,securitySchemes:`Security Schemes`,examples:`Examples`,links:`Links`,callbacks:`Callbacks`},Lu=[`GET`,`POST`,`PUT`,`DELETE`,`PATCH`,`OPTIONS`,`HEAD`,`QUERY`],Ru=class extends D{constructor(...e){super(...e),this.type=`operations`,this.heading=``,this.items=[],this.filterValue=``,this.searchTerm=``,this.filteredItems=[],this.filterOptions=[],this.handleClear=()=>{clearTimeout(this.searchTimeout),this.searchTerm=``}}static{this.styles=ju}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.searchTimeout)}willUpdate(e){e.has(`items`)&&this.type===`components`&&(this.filterOptions=[...new Set(this.items.map(e=>e.componentType))].sort()),(e.has(`items`)||e.has(`filterValue`)||e.has(`searchTerm`))&&(this.filteredItems=this.computeFiltered())}computeFiltered(){let e=this.searchTerm.toLowerCase();if(this.type===`operations`){let t=this.items;return this.filterValue&&(t=t.filter(e=>e.method.toUpperCase()===this.filterValue)),e&&(t=t.filter(t=>t.path.toLowerCase().includes(e))),t}else{let t=this.items;return this.filterValue&&(t=t.filter(e=>e.componentType===this.filterValue)),e&&(t=t.filter(t=>t.name.toLowerCase().includes(e))),t}}handleSearch(e){clearTimeout(this.searchTimeout);let t=e.target.value;this.searchTimeout=window.setTimeout(()=>{this.searchTerm=t},150)}handleFilter(e){this.filterValue=e.detail?.item?.value??``}renderToolbar(){let e=this.type===`operations`?this.filterValue||`ALL METHODS`:Iu[this.filterValue]?.toUpperCase()||this.filterValue?.toUpperCase()||`ALL TYPES`;return T`
            <div class="toolbar">
                <sl-dropdown>
                    ...
                    <sl-menu @sl-select=${this.handleFilter}>
                        ...
                        ${this.type===`operations`?Lu.map(e=>T`
        ...
        `}};J([M()],Ru.prototype,`type`,void 0),J([M()],Ru.prototype,`heading`,void 0),J([M({type:Array})],Ru.prototype,`items`,void 0),J([N()],Ru.prototype,`filterValue`,void 0),J([N()],Ru.prototype,`searchTerm`,void 0),J([N()],Ru.prototype,`filteredItems`,void 0),J([N()],Ru.prototype,`filterOptions`,void 0),Ru=J([j(`pp-ref-list`)],Ru);var zu=class extends D{constructor(...e){super(...e),this.refsJson=``,this.refs={}}static{this.styles=Au}willUpdate(e){if(e.has(`refsJson`)&&this.refsJson)try{this.refs=JSON.parse(this.refsJson)}catch{this.refs={}}}render(){let{refs:e}=this,t=(e.usedByOperations?.length??0)>0,n=(e.usedByModels?.length??0)>0,r=(e.usesModels?.length??0)>0;return!t&&!n&&!r?E:T`
            ${t?T`
                <pp-ref-list
                    type="operations"
                    heading="Consumed By"
        ...
        `}};J([M({attribute:`refs-json`})],zu.prototype,`refsJson`,void 0),J([N()],zu.prototype,`refs`,void 0),zu=J([j(`pp-cross-refs`)],zu);var Bu=[gu,w`
    :host {
        display: block;
    }
...
`],Vu=class extends D{constructor(...e){super(...e),this.title=``,this.json=``,this.yaml=``,this.format=`json`,this.rawMode=!1,this.highlightLines=``,this.startLine=1,this.location=``,this.method=``,this.path=``,this.componentType=``,this.handleShowExample=e=>{let t=e.detail;if(this.title=t.title,this.json=t.json,this.yaml=t.yaml||``,this.rawMode=t.rawMode??!1,this.highlightLines=t.highlightLines||``,this.startLine=t.startLine??1,this.location=t.location||``,this.method=t.method||``,this.path=t.path||``,this.componentType=t.componentType||``,t.language)this.format=t.language;else{let e=document.body.getAttribute(`data-spec-format`);e===`yaml`&&t.yaml?this.format=`yaml`:e===`json`&&t.json?this.format=`json`:this.format=t.yaml?`yaml`:`json`}this.updateComplete.then(()=>{let e=this.drawer;e&&typeof e.show==`function`&&(e.updateComplete?e.updateComplete.then(()=>e.show()):e.show())})}}static{this.styles=[Bu,vu]}connectedCallback(){super.connectedCallback(),document.addEventListener(`pp-show-example`,this.handleShowExample)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`pp-show-example`,this.handleShowExample)}get copyText(){let e=this.shadowRoot?.querySelector(`pp-code-viewer`);return e?e.displayCode:this.format===`yaml`&&this.yaml?this.yaml:this.json}async copyCurrentCode(){let e=this.copyText;e&&await navigator.clipboard.writeText(e)}renderHeader(){return this.method&&this.path?T`
    ...
    `}};J([N()],Vu.prototype,`title`,void 0),J([N()],Vu.prototype,`json`,void 0),J([N()],Vu.prototype,`yaml`,void 0),J([N()],Vu.prototype,`format`,void 0),J([N()],Vu.prototype,`rawMode`,void 0),J([N()],Vu.prototype,`highlightLines`,void 0),J([N()],Vu.prototype,`startLine`,void 0),J([N()],Vu.prototype,`location`,void 0),J([N()],Vu.prototype,`method`,void 0),J([N()],Vu.prototype,`path`,void 0),J([N()],Vu.prototype,`componentType`,void 0),J([P(`sl-drawer`)],Vu.prototype,`drawer`,void 0),Vu=J([j(`pp-example-drawer`)],Vu);var Hu=w`
    :host {
        display: inline-block;
    }
...
`,Uu=class extends D{constructor(...e){super(...e),this.btnTitle=``,this.rawJson=``,this.rawYaml=``,this.highlightLines=``,this.startLine=1,this.location=``,this.method=``,this.path=``,this.componentType=``,this.showTextLabel=!1}static{this.styles=[Hu,vu]}showRaw(){let e=new CustomEvent(`pp-show-example`,{bubbles:!0,composed:!0,detail:{title:this.btnTitle||`Raw Object`,json:this.rawJson,yaml:this.rawYaml,rawMode:!0,highlightLines:this.highlightLines||void 0,startLine:this.startLine>1?this.startLine:void 0,location:this.location||void 0,method:this.method||void 0,path:this.path||void 0,componentType:this.componentType||void 0}});this.dispatchEvent(e)}render(){return!this.rawJson&&!this.rawYaml?E:T`
            ...
            </sl-tooltip>`}};J([M({attribute:`title`})],Uu.prototype,`btnTitle`,void 0),J([M({attribute:`raw-json`})],Uu.prototype,`rawJson`,void 0),J([M({attribute:`raw-yaml`})],Uu.prototype,`rawYaml`,void 0),J([M({attribute:`highlight-lines`})],Uu.prototype,`highlightLines`,void 0),J([M({attribute:`start-line`,type:Number})],Uu.prototype,`startLine`,void 0),J([M()],Uu.prototype,`location`,void 0),J([M()],Uu.prototype,`method`,void 0),J([M()],Uu.prototype,`path`,void 0),J([M({attribute:`component-type`})],Uu.prototype,`componentType`,void 0),J([M({type:Boolean})],Uu.prototype,`showTextLabel`,void 0),Uu=J([j(`pp-raw-viewer-btn`)],Uu);var Wu=w`
    :host {
        display: block;
        margin-top: var(--global-padding);
    }
...
`,Gu={implicit:`IMPLICIT`,authorizationCode:`AUTHORIZATION CODE`,clientCredentials:`CLIENT CREDENTIALS`,password:`PASSWORD`};function Ku(e,t,n){switch(e){case`apiKey`:switch(t){case`cookie`:return`cookie`;case`header`:return`envelope`;case`query`:return`signpost`;default:return`key`}case`http`:switch(n){case`bearer`:return`shield-lock`;case`basic`:return`person-lock`;default:return`lock`}case`oauth2`:return`key`;case`openIdConnect`:return`fingerprint`;default:return`lock`}}var qu=class extends D{constructor(...e){super(...e),this.schemeJson=``,this.scheme=null}static{this.styles=[Cs,Wu]}willUpdate(e){if(e.has(`schemeJson`)&&this.schemeJson)try{this.scheme=JSON.parse(this.schemeJson)}catch{this.scheme=null}}renderProperty(e,t){return T`
            <div class="property">
        ...
        `}renderFlow(e,t){return t?T`
            <div class="flow-section">
                <div class="flow-heading">${Gu[e]||e.toUpperCase()}</div>
        ...
        `:E}renderFlows(e){if(!e||typeof e!=`object`)return E;let t=Object.keys(e);return t.length===0?E:t.map(t=>this.renderFlow(t,e[t]))}render(){if(!this.scheme)return E;let{type:e,name:t,scheme:n,bearerFormat:r,openIdConnectUrl:i,flows:a}=this.scheme,o=Ku(e,this.scheme.in,n);return T`
        ...
        `}};J([M({attribute:`scheme-json`})],qu.prototype,`schemeJson`,void 0),J([N()],qu.prototype,`scheme`,void 0),qu=J([j(`pp-security-scheme`)],qu);var Ju=w`
    :host {
        display: block;
        position: fixed;
