...
func TestPrintingPress_WriteHTMLSite(t *testing.T) {
	...
	assert.Contains(t, string(operationHTML), `const sharedBase = "static/printing-press-shared";`)
	assert.Contains(t, string(operationHTML), `const pageBase = "static/page-data/operations/`+opSlug+`";`)
...
func TestPrintingPress_WriteHTMLSite_UsesConfigOutputDirAndBaseURL(t *testing.T) {
	...
	assert.Contains(t, string(indexHTML), `const sharedBase = "/docs/static/printing-press-shared";`)
	...
	assert.Contains(t, string(operationHTML), `const sharedBase = "/docs/static/printing-press-shared";`)
	assert.Contains(t, string(operationHTML), `const pageBase = "/docs/static/page-data/operations/`+opSlug+`";`)
